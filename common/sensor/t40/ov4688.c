...
static int sensor_attr_check(struct tx_isp_subdev *sd) {
	...
	case 0:
		...
		sensor_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI, sensor_attr.max_integration_time_native = 1550,
		sensor_attr.integration_time_limit = 1550, sensor_attr.total_width = 2584,
		sensor_attr.total_height = 1554, sensor_attr.max_integration_time = 1550,
	...
	case 1:
		...
		sensor_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sensor_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI, sensor_attr.max_integration_time_native = 1158,
		sensor_attr.integration_time_limit = 1158, sensor_attr.total_width = 3920,
		sensor_attr.total_height = 1162, sensor_attr.max_integration_time = 1158,
		sensor_attr.one_line_expr_in_us = 30;
		sensor_attr.again = 0x80;
		sensor_attr.integration_time = 0x400;
		break;
