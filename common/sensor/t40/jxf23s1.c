...
static int sensor_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	sensor_attr.again = -1;
	sensor_attr.integration_time = -1;
	sensor_attr.again = 0;
	sensor_attr.integration_time = 0x00ff;
...
static const struct i2c_device_id jxf23s1_id[] = {{SENSOR_NAME, 0}, {}};
