...
/* VGA@120fps: insmod sensor_jxf32_t40.ko data_interface=1 sensor_resolution=30 sensor_max_fps=120  */
/* 1080p@25fps: insmod sensor_jxf32_t40.ko data_interface=1 sensor_max_fps=30 sensor_resolution=200 */
/* 1080p@60fps: insmod sensor_jxf32_t40.ko data_interface=1 sensor_max_fps=60 sensor_resolution=200 */
/* 1728x972@15fps: insmod sensor_jxf32_t40.ko data_interface=1 sensor_max_fps=15 sensor_resolution=180 */
/* 1728x972@55fps: insmod sensor_jxf32_t40.ko data_interface=1 sensor_max_fps=55 sensor_resolution=180 */
...
static int sensor_s_stream(struct tx_isp_subdev *sd, struct tx_isp_initarg *init) {
	...
	if (init->enable) {
		...
		if (sensor->video.state == TX_ISP_MODULE_DEINIT) {
			...
			ret += sensor_read(sd, 0x2f, &r2f_val);
			ret += sensor_read(sd, 0x0c, &r0c_val);
			ret += sensor_read(sd, 0x82, &r80_val);
