...
#define SENSOR_CHIP_ID 0x530243
...
static struct regval_list sensor_init_regs_1920_1080_50fps[] = {
	{0x302a, 0x00},
	{0x0103, 0x01},
	{0x0109, 0x01},
	{0x0104, 0x02},
...
static struct regval_list sensor_init_regs_1920_1080_45fps[] = {
	{0x302a, 0x00},
	{0x0103, 0x01},
	{0x0109, 0x01},
	{0x0104, 0x02},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	/*[3] 2M@55fps*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1920_1080_55fps,
	},
	/*[4] 2M@50fps*/
	{
		.width = 1920,
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1920_1080_50fps,
	},
	/*[5] 2M@45fps*/
	{
		.width = 1920,
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1920_1080_45fps,
	},
};
...
static int sensor_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	case SENSOR_OUTPUT_MAX_FPS_120:
		...
		sensor_attr.total_height = 625;
		sensor_attr.max_integration_time = 625 - 8;
		...
		sensor_attr.mipi.mipi_sc.data_type_value = RAW12;
		break;
	case SENSOR_OUTPUT_MAX_FPS_60:
		...
		sensor_attr.total_width = 0x5a0;
		sensor_attr.total_height = 0x4e2;
		sensor_attr.max_integration_time = 0x4e2 - 8;
		break;
	case SENSOR_OUTPUT_MAX_FPS_55:
		...
		sensor_attr.total_width = 0x6d1;  // 1745
	...
	case SENSOR_OUTPUT_MAX_FPS_50:
		...
		sensor_attr.total_width = 0x6d1;  // 1745
		sensor_attr.total_height = 0x4d4; // 1236
		sensor_attr.max_integration_time = 0x4d4 - 8;
		break;
	case SENSOR_OUTPUT_MAX_FPS_45:
		...
		sensor_attr.total_width = 0x6d1;  // 1745
		sensor_attr.total_height = 0x55f; // 1375
		sensor_attr.max_integration_time = 0x55f - 8;
		break;
	default:
		ISP_ERROR("Now we do not support this framerate!!!\n");
	}
