...
/* VGA@70fps: insmod sensor_jxf37_t23.ko data_type=0 data_interface=1 sensor_resolution=30 */
/* 480x270@110fps: insmod sensor_jxf37_t23.ko data_type=0 data_interface=1 sensor_resolution=13 */
/* 1080p@25fps: insmod sensor_jxf37_t23.ko data_type=0 data_interface=1 sensor_resolution=200  */
/* DOL 1080p@15fps: insmod sensor_jxf37_t23.ko data_interface=1 data_type=2  */
...
static int sensor_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	if (data_type == TX_SENSOR_DATA_TYPE_LINEAR) {
		if (data_interface == TX_SENSOR_DATA_INTERFACE_DVP) {
			...
			(sensor_resolution == TX_SENSOR_RES_200)) {
			memcpy((void *)(&(sensor_attr.mipi)), (void *)(&sensor_mipi), sizeof(sensor_mipi));
			wsize = &sensor_win_sizes[1];
			sensor_info.max_fps = 25;
			sensor_attr.max_integration_time_native = 1500 - 4;
			...
			(sensor_resolution == TX_SENSOR_RES_30)) {
			memcpy((void *)(&(sensor_attr.mipi)), (void *)(&sensor_mipi), sizeof(sensor_mipi));
