...
#define SENSOR_SUPPORT_30FPS_SCLK (74925000)
...
struct again_lut sensor_again_lut[] = {
	{0x00, 0x00, 0x00, 0x01, 0x00, 0x04, 0},
	{0x01, 0x00, 0x10, 0x01, 0x0c, 0x04, 13706},
	{0x02, 0x00, 0x20, 0x01, 0x1b, 0x04, 31134},
	{0x03, 0x00, 0x30, 0x01, 0x2c, 0x04, 45903},
	{0x04, 0x00, 0x40, 0x01, 0x3f, 0x2c, 64010},
	{0x05, 0x00, 0x50, 0x02, 0x16, 0x2c, 77964},
	{0x06, 0x00, 0x60, 0x02, 0x35, 0x2c, 97246},
	{0x07, 0x00, 0x70, 0x03, 0x16, 0x2c, 111902},
	{0x08, 0x00, 0x80, 0x04, 0x02, 0x28, 130334},
	{0x09, 0x00, 0x90, 0x04, 0x31, 0x28, 144468},
	{0x0a, 0x00, 0xa0, 0x05, 0x32, 0x28, 157623},
	{0x0b, 0x00, 0xb0, 0x06, 0x35, 0x28, 171832},
	{0x0c, 0x00, 0xc0, 0x08, 0x04, 0x24, 190301},
	{0x0d, 0x00, 0x5a, 0x09, 0x19, 0x24, 206077},
	{0x0e, 0x00, 0x83, 0x0b, 0x0f, 0x24, 223709},
	{0x0f, 0x00, 0x93, 0x0d, 0x12, 0x24, 237972},
...
static int sensor_set_integration_time(struct tx_isp_subdev *sd, int value) {
	int ret = 0;
	ret += sensor_write(sd, 0x03, value & 0xff);
	ret += sensor_write(sd, 0x04, value >> 8);
	if (ret < 0) {
...
static int sensor_set_analog_gain(struct tx_isp_subdev *sd, int value) {
	...
	ret += sensor_write(sd, 0x78, val_lut[value].regb4);
	if (ret < 0) {
