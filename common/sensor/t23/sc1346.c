...
struct tx_isp_mipi_bus sensor_mipi_15fps = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 225,
	.lans = 1,
	.settle_time_apative_en = 0,
...
static int sensor_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	case TX_SENSOR_MAX_FPS_15:
		...
		sensor_attr.total_width = 0x7d0, sensor_attr.total_height = 0x2ee;
		sensor_attr.max_integration_time = 0x2ee - 6;
		sensor_attr.max_again = 391733;
		sensor_attr.max_dgain = 0;
		memcpy((void *)(&(sensor_attr.mipi)), (void *)(&sensor_mipi_15fps), sizeof(sensor_mipi_15fps));
		break;
	case TX_SENSOR_MAX_FPS_30:
		...
		sensor_attr.max_integration_time_native = 0x2ee - 6;
		sensor_attr.integration_time_limit = 0x2ee - 6;
		sensor_attr.total_width = 0x708, sensor_attr.total_height = 0x2ee;
		sensor_attr.max_integration_time = 0x2ee - 6;
		sensor_attr.max_again = 391733;
		sensor_attr.max_dgain = 0;
