...
static int sensor_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	if (sensor_max_fps == 30) {
		...
		memcpy((void *)(&(sensor_attr.mipi)), (void *)(&sensor_mipi_1lane), sizeof(sensor_mipi_1lane));
		sensor_attr.min_integration_time = 1, sensor_attr.min_integration_time_native = 1,
		sensor_attr.max_integration_time_native = 1125 - 6;
		sensor_attr.integration_time_limit = 1125 - 6;
