...
static int sensor_attr_check(struct tx_isp_subdev *sd) {
	...
	case 0:
		...
		sensor_attr.mipi.clk = 620;
		sensor_attr.min_integration_time = 2;
		sensor_attr.total_width = 0xbb8, sensor_attr.total_height = 0x5dc,
		sensor_attr.max_integration_time_native = 0x5dc - 4, sensor_attr.max_integration_time = 0x5dc - 4,
		sensor_attr.integration_time_limit = 0x5dc - 4, sensor_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR,
		sensor_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI, ISP_INFO("==========> linear is ok");
		break;
	default:
