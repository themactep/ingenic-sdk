...
struct tx_isp_mipi_bus sensor_mipi_512_linear = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 900,
	.lans = 2,
	.image_twidth = 512,
...
static struct regval_list sensor_init_regs_2048_2048_30fps_mipi[] = {
	{0x0103, 0x01},
	{0x0301, 0x44},
	{0x0303, 0x02},
	{0x0304, 0x00},
...
static struct regval_list sensor_init_regs_512_512_30fps_mipi[] = {
	{0x0103, 0x01},
	{0x0301, 0x44},
	{0x0303, 0x02},
	{0x0304, 0x00},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	/* 2048*2048 [0] */
	{
		...
		.regs = sensor_init_regs_2048_2048_30fps_mipi,
	},
	/* 512*512 [1] */
	{
		.width = 512,
		...
		.mbus_code = TISP_VI_FMT_SBGGR10_1X10,
		.colorspace = TISP_COLORSPACE_SRGB,
		.regs = sensor_init_regs_512_512_30fps_mipi,
	},
};
...
static int sensor_setting_select(struct tx_isp_subdev *sd, int deboot) {
	...
	case 0:
		...
		sensor_attr.max_integration_time = 2164 - 8;
		sensor_attr.total_width = 1616;
		sensor_attr.total_height = 2164;
	...
	case 1:
		...
		sensor_attr.max_again = 259142;
		sensor_attr.min_integration_time = 2;
		sensor_attr.max_integration_time = 2486 - 8;
		sensor_attr.total_width = 1408;
		sensor_attr.total_height = 2486;
		sensor_attr.integration_time_apply_delay = 2;
		sensor_attr.again_apply_delay = 2;
		sensor_attr.dgain_apply_delay = 0;
		sensor_attr.integration_time_limit = sensor_attr.max_integration_time;
		...
		sensor_attr.wdr_cache = wdr_line * sensor_attr.total_width;
#endif /* SENSOR_WDR_2_FRAME */
		memcpy((void *)(&(sensor_attr.mipi)), (void *)(&sensor_mipi_512_linear), sizeof(sensor_attr.mipi));
		break;
	default:
...
static int sensor_s_stream(struct tx_isp_subdev *sd, struct tx_isp_initarg *init) {
	...
	if (init->enable) {
		...
		if (sensor->video.state == TX_ISP_MODULE_INIT) {
			...
			ISP_INFO("os04e10 stream on\n");
		}

	} else {
		ret = sensor_write_array(sd, sensor_stream_off_mipi);
		sensor->video.state = TX_ISP_MODULE_INIT;
		ISP_INFO("os04e10 stream off\n");
	}
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps) {
	...
	sensor_write(sd, 0x380f, (unsigned char)(vts & 0xff));
	sensor_write(sd, 0x380e, (unsigned char)(vts >> 8));
...
static int sensor_set_vflip(struct tx_isp_subdev *sd, int enable) {
	...
	sensor_read(sd, 0x3716, &val_3716);
	sensor_read(sd, 0x3820, &val_3820);
	switch (enable) {
	case 0:
		val_3716 = 0x24;
		val_3820 = 0x88;
	...
	sensor_write(sd, 0x3716, val_3716);
	sensor_write(sd, 0x3820, val_3820);
