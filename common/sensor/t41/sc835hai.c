...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code = TISP_VI_FMT_SBGGR10_1X10,
		.colorspace = TISP_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1920_2160_25fps_mipi,
	},
	{
		.width = 3840,
		.height = 2160,
...
static int sensor_attr_check(struct tx_isp_subdev *sd) {
	...
	case 0:
		...
		sensor_attr.max_integration_time_native = 2400 - 7;
		sensor_attr.integration_time_limit = 2400 - 7;
		sensor_attr.max_integration_time = 2400 - 7;
	...
	case 1:
		...
		sensor_attr.max_integration_time_native = 1350 - 7;
		sensor_attr.integration_time_limit = 1350 - 7;
		sensor_attr.max_integration_time = 1350 - 7;
		sensor_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sensor_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		break;
	case 2:
		...
		sensor_attr.min_integration_time_native = 2;
		sensor_attr.total_width = 2100;
		sensor_attr.total_height = 2700;
		sensor_attr.max_integration_time_native = 2700 - 7;
		sensor_attr.integration_time_limit = 2700 - 7;
		sensor_attr.max_integration_time = 2700 - 7;
		sensor_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sensor_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		break;
	case 3:
		...
		sensor_attr.max_integration_time_native = 2250 - 7;
		sensor_attr.integration_time_limit = 2250 - 7;
		sensor_attr.max_integration_time = 2250 - 7;
		sensor_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sensor_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		break;
	default:
...
static int sensor_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	...
	ISP_INFO("sc835hai chip found @ 0x%02x (%s)\n sensor drv version %s",
		client->addr,
		client->adapter->name,
		SENSOR_VERSION);
	if (chip) {
