...
static int sensor_setting_select(struct tx_isp_subdev *sd, int deboot) {
	...
	case 0:
		...
		sensor_attr.max_integration_time = 1574 - 8;
		sensor_attr.total_width = 4280; /* 2140 * 2 */
		sensor_attr.total_height = 1574;
...
static int sensor_set_vflip(struct tx_isp_subdev *sd, int enable) {
	...
	/* sensor_read(sd, 0x3820, &val_foramt); */
	/* sensor_read(sd, 0x3716, &val_reg16); */
	switch (enable) {
	case 0:
		val_foramt = 0x88;
		val_reg16 = 0x24;
	...
	sensor_write(sd, 0x3820, val_foramt);
	sensor_write(sd, 0x3716, val_reg16);
