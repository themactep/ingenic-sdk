...
/*
 * T31 runs the AVPU at 440 MHz on the 4.4.94 kernel, 550 MHz on 3.10.14 and
 * 550 MHz on all other SoCs (T40/T41/C100).
 */
#if defined(CONFIG_SOC_T31) && defined(CONFIG_KERNEL_4_4_94)
