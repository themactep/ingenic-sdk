...
int sensor_read(struct tx_isp_subdev *sd, uint16_t reg, uint8_t *value) {
...
int sensor_write_8(struct tx_isp_subdev *sd, uint16_t reg, uint8_t value) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
