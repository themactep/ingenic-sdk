...
struct tx_isp_sensor_attribute sensor_attr = {.name = "sc2336p",
	.chip_id = SENSOR_CHIP_ID,
...
static int sensor_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	...
	ISP_INFO("sc2336p chip found @ 0x%02x (%s)\n", client->addr, client->adapter->name);
...
static const struct i2c_device_id sensor_id[] = {{"sc2336p", 0}, {}};
