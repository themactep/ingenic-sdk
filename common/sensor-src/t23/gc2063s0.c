...
struct tx_isp_sensor_attribute gc2063_attr = {.name = "gc2063",
	.chip_id = 0x2053,
...
static struct tx_isp_sensor_win_setting gc2063_win_sizes[] = {
	...
	/* 1920*1080 @ max 15fps dvp*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SRGGB10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = gc2063_init_regs_1920_1080_15fps_dvp,
	},
	...
	/* 1920*1080 @ max 25fps mipi*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SRGGB10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = gc2063_init_regs_1920_1080_25fps_mipi,
	},
	...
	/* 1920*1080 @ max 40fps mipi*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SRGGB10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = gc2063_init_regs_1920_1080_40fps_mipi,
	},
};
...
static int gc2063_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	gc2063_attr.dbus_type = data_interface;
	if ((data_interface == TX_SENSOR_DATA_INTERFACE_DVP) && (sensor_max_fps == TX_SENSOR_MAX_FPS_30)) {
		...
		memcpy((void *)(&(gc2063_attr.dvp)), (void *)(&gc2063_dvp), sizeof(gc2063_dvp));
		...
		memcpy((void *)(&(gc2063_attr.dvp)), (void *)(&gc2063_dvp), sizeof(gc2063_dvp));
		gc2063_attr.max_integration_time_native = 0x465 - 8;
		gc2063_attr.integration_time_limit = 0x465 - 8;
		gc2063_attr.total_width = 0x44c * 2;
		gc2063_attr.total_height = 0x465;
		gc2063_attr.max_integration_time = 0x465 - 8;
		gc2063_attr.one_line_expr_in_us = 59;
		vts0 = 0x04;
		vts1 = 0x65;
		vtsn0 = 0x04;
		vtsn1 = 0x65;
		...
		memcpy((void *)(&(gc2063_attr.mipi)), (void *)(&gc2063_mipi), sizeof(gc2063_mipi));
		gc2063_attr.max_integration_time_native = 0x58a - 8;
		gc2063_attr.integration_time_limit = 0x58a - 8;
		gc2063_attr.total_width = 0x44c * 2;
		gc2063_attr.total_height = 0x58a;
		gc2063_attr.max_integration_time = 0x58a - 8;
		...
		wsize = &gc2063_win_sizes[3];
		memcpy((void *)(&(gc2063_attr.mipi)), (void *)(&gc2063_mipi), sizeof(gc2063_mipi));
		gc2063_attr.max_integration_time_native = 0x51c - 8;
		gc2063_attr.integration_time_limit = 0x51c - 8;
		gc2063_attr.total_width = 0x44c * 2;
		gc2063_attr.total_height = 0x51c;
		gc2063_attr.max_integration_time = 0x51c - 8;
		gc2063_attr.one_line_expr_in_us = 31;
		vts0 = 0x05;
		vts1 = 0x1c;
		vtsn0 = 0x05;
		vtsn1 = 0x1c;
	} else if ((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == TX_SENSOR_MAX_FPS_15)) {
		wsize = &gc2063_win_sizes[4];
		memcpy((void *)(&(gc2063_attr.mipi)), (void *)(&gc2063_mipi), sizeof(gc2063_mipi));
		...
		gc2063_attr.total_height = 0x465;
		gc2063_attr.max_integration_time = 0x465 - 8;
		gc2063_attr.one_line_expr_in_us = 11;
		vts0 = 0x04;
		vts1 = 0x65;
		vtsn0 = 0x04;
		vtsn1 = 0x65;
	...
	gc2063_attr.fsync_attr.mode = fsync_mode;
	if (fsync_mode == TX_ISP_SENSOR_FSYNC_MODE_MS_REALTIME_MISPLACE) {
		theight_tmp = gc2063_attr.total_height;
		fps_tmp = wsize->fps;
		gc2063_attr.total_height = gc2063_attr.total_height * 8 / 3;
		wsize->fps = ((wsize->fps & 0xffff0000) * 3) | ((wsize->fps & 0xffff) * 8);
	}
	gc2063_attr.max_integration_time_native = gc2063_attr.total_height - 8;
	gc2063_attr.integration_time_limit = gc2063_attr.total_height - 8;
	gc2063_attr.max_integration_time = gc2063_attr.total_height - 8;

	/*
	  convert sensor-gain into isp-gain,
	*/
	gc2063_attr.max_again = 444864;
	gc2063_attr.max_dgain = 0;
	gc2063_attr.expo_fs = 0;
	sd = &sensor->sd;
	video = &sensor->video;
...
static int gc2063_remove(struct i2c_client *client) {
	...
	gc2063_attr.total_height = theight_tmp;
	wsize->fps = fps_tmp;
...
static const struct i2c_device_id gc2063_id[] = {{"gc2063", 0}, {}};
...
static __init int init_gc2063(void) {
	...
	if (ret) {
		ISP_ERROR("Failed to init gc2063 dirver.\n");
		return -1;
	}
...
MODULE_DESCRIPTION("A low-level driver for galaxycore gc2063 sensors");
MODULE_LICENSE("GPL");
