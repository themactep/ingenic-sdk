...
struct tx_isp_sensor_attribute cv2003s1_attr = {.name = "cv2003s1",
	.chip_id = 0x2003,
...
static int cv2003s1_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static const struct i2c_device_id cv2003s1_id[] = {{"cv2003s1", 0}, {}};
