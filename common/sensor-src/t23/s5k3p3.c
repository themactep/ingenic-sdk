...
#ifdef SENSOR_I2C_REG_8BIT
int s5k3p3_read(struct tx_isp_subdev *sd, unsigned char reg, unsigned char *value) {
...
int s5k3p3_write(struct tx_isp_subdev *sd, unsigned char reg, unsigned char value) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
int s5k3p3_read(struct tx_isp_subdev *sd, uint16_t reg, unsigned char *value) {
	int ret;
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
int s5k3p3_write(struct tx_isp_subdev *sd, uint16_t reg, uint16_t value) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int s5k3p3_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int s5k3p3_probe(struct i2c_client *client, const struct i2c_device_id *id) {
...
static const struct i2c_device_id s5k3p3_id[] = {{"s5k3p3", 0}, {}};
