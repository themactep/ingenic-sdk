...
int jxk306p_read(struct tx_isp_subdev *sd, unsigned char reg, unsigned char *value) {
...
int jxk306p_write(struct tx_isp_subdev *sd, unsigned char reg, unsigned char value) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int jxk306p_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static const struct i2c_device_id jxk306p_id[] = {{"jxk306p", 0}, {}};
