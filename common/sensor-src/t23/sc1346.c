...
struct tx_isp_mipi_bus sc1346_mipi_15fps = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 225,
	.lans = 1,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus sc1346_mipi_30fps = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 405,
	.lans = 1,
	.settle_time_apative_en = 0,
...
static struct tx_isp_sensor_win_setting sc1346_win_sizes[] = {{
							      ...
							      },
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sc1346_init_regs_1280_720_30fps_mipi,
	}};
...
static int sc1346_set_vflip(struct tx_isp_subdev *sd, int enable) {
	...
	switch (enable) {
	case 0:
		sc1346_write(sd, 0x3221, val & 0x99);
		break;
	case 1:
		sc1346_write(sd, 0x3221, val | 0x06);
		break;
	case 2:
		sc1346_write(sd, 0x3221, val | 0x60);
		break;
	case 3:
...
static int sc1346_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	case TX_SENSOR_MAX_FPS_30:
		...
		sc1346_attr.max_integration_time_native = 0x2ee - 6;
		sc1346_attr.integration_time_limit = 0x2ee - 6;
		sc1346_attr.total_width = 0x708, sc1346_attr.total_height = 0x2ee;
		sc1346_attr.max_integration_time = 0x2ee - 6;
		sc1346_attr.max_again = 391733;
		sc1346_attr.max_dgain = 0;
		memcpy((void *)(&(sc1346_attr.mipi)), (void *)(&sc1346_mipi_30fps), sizeof(sc1346_mipi_30fps));
		break;
	}
