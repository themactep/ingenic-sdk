...
struct tx_isp_sensor_attribute jxf38p_attr = {.name = "jxf38p",
	.chip_id = 0x844,
...
static int jxf38p_fsync(struct tx_isp_subdev *sd, struct tx_isp_sensor_fsync *fsync) {
...
static int jxf38p_probe(struct i2c_client *client, const struct i2c_device_id *id) {
	...
	jxf38p_attr.fsync_attr.mode = fsync_mode;
