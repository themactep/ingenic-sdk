...
int os04j10_read(struct tx_isp_subdev *sd, uint16_t reg, unsigned char *value) {
...
int os04j10_write(struct tx_isp_subdev *sd, uint16_t reg, unsigned char value) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int os04j10_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int os04j10_probe(struct i2c_client *client, const struct i2c_device_id *id) {
...
static const struct i2c_device_id os04j10_id[] = {{"os04j10", 0}, {}};
