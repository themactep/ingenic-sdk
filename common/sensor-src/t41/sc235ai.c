...
struct tx_isp_mipi_bus sensor_mipi_1920_1056_30fps_linear = {
...
struct tx_isp_mipi_bus sensor_mipi_1920_1080_30fps_linear = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 396,
	.lans = 2,
	.image_twidth = 1920,
...
static struct regval_list sensor_init_regs_1920_1056_30fps_mipi[] = {
	{0x0103, 0x01},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
	{0x301f, 0x14},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	{
		...
		.regs = sensor_init_regs_1920_1056_30fps_mipi,
	},
	{
		.width = 1920,
		.height = 1080,
...
static int sensor_setting_select(struct tx_isp_subdev *sd, int deboot) {
	...
	case 0:
		...
		sensor_attr.max_again = 449885;
		sensor_attr.min_integration_time = 2;
		sensor_attr.max_integration_time = 1200 - 5;
		...
		memcpy((void *)(&(sensor_attr.mipi)),
			(void *)(&sensor_mipi_1920_1056_30fps_linear),
			sizeof(sensor_attr.mipi));
		break;
	case 1:
...
#endif /* SENSOR_WDR_2_FRAME */
		memcpy((void *)(&(sensor_attr.mipi)),
			(void *)(&sensor_mipi_1920_1080_30fps_linear),
			sizeof(sensor_attr.mipi));
		break;
	default:
