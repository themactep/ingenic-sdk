...
static struct regval_list sensor_init_regs_2448_1520_30fps[] = {
	{0x0100, 0x00},
	{0x0103, 0x01},
	{0x0301, 0x84},
	{0x0303, 0x01},
...
static struct regval_list sensor_init_regs_1224_760_110fps[] = {
	{0x0100, 0x00},
	{0x0103, 0x01},
	{0x0301, 0x84},
	{0x0303, 0x01},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	/* [5] 3.7M @30fps*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_2448_1520_30fps,
	},
	/* [6] 1M @110fps*/
	{
		.width = 1224,
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1224_760_110fps,
	},
};
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps) {
	...
	if (data_type == TX_SENSOR_DATA_TYPE_LINEAR) {
		if (sensor_resolution == SENSOR_RES_400) {
			...
			switch (sensor_max_fps) {
			case TX_SENSOR_MAX_FPS_60:
				sclk = SENSOR_SUPPORT_SCLK_1M;
				max_fps = TX_SENSOR_MAX_FPS_60;
				break;
			case TX_SENSOR_MAX_FPS_110:
				sclk = SENSOR_SUPPORT_SCLK_110FPS;
	...
	if (data_type == TX_SENSOR_DATA_TYPE_LINEAR) {
		if (sensor_resolution == SENSOR_RES_400) {
			...
			case TX_SENSOR_MAX_FPS_30:
				...
				sensor_info.max_fps = 30;
				sensor_attr.mipi.image_twidth = 2448;
				sensor_attr.mipi.image_theight = 1520;
				sensor_attr.max_integration_time_native = 0x626 - 8;
				sensor_attr.integration_time_limit = 0x626 - 8;
				sensor_attr.total_width = 0x85e * 2;
				sensor_attr.total_height = 0x626;
				sensor_attr.max_integration_time = 0x626 - 8;
				sensor_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
				break;
			...
			case TX_SENSOR_MAX_FPS_60:
				...
				sensor_attr.max_integration_time_native = 0x626 - 8;
				sensor_attr.integration_time_limit = 0x626 - 8;
				sensor_attr.total_width = 0x42e * 2;
				sensor_attr.total_height = 0x626;
				sensor_attr.max_integration_time = 0x626 - 8;
				sensor_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
				break;
			case TX_SENSOR_MAX_FPS_110:
				...
				sensor_attr.mipi.image_twidth = 1224;
				sensor_attr.mipi.image_theight = 760;
				sensor_attr.max_integration_time_native = 0x391 - 8;
				sensor_attr.integration_time_limit = 0x391 - 8;
				sensor_attr.total_width = 0x3ef * 2;
				sensor_attr.total_height = 0x391;
				sensor_attr.max_integration_time = 0x391 - 8;
				sensor_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
				break;
			default:
				ISP_ERROR("Now we do not support this framerate @ 1MP!!!\n");
