...
MODULE_PARM_DESC(sensor_resolution,
	"Sensor Resolution setting interface: 1080=1920x1080@30fps (default, cropped), 1232=1632x1232@30fps (2x2 "
	"binned, full FOV), 2464=3280x2464@15fps (full sensor), 480=640x480@30fps");
