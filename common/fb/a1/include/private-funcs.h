...
#define FB_INFO_LEVEL		(0x0)
#define FB_WARNING_LEVEL	(0x1)
#define FB_ERROR_LEVEL		(0x2)

#define FB_PRINT(level, format, ...) 		\
	fb_printk(level, format, ##__VA_ARGS__)
#define FB_INFO(...) 		FB_PRINT(FB_INFO_LEVEL, __VA_ARGS__)
#define FB_WARNING(...) 	FB_PRINT(FB_WARNING_LEVEL, __VA_ARGS__)
#define FB_ERROR(...) 		FB_PRINT(FB_ERROR_LEVEL, __VA_ARGS__)
...
void * private_get_jzfb_parameters(void);
