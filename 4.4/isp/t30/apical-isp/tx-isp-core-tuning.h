 ...
 */
typedef enum {
	ISP_CORE_ANTIFOG_DISABLE = 0,	/**< 关闭 */
	ISP_CORE_ANTIFOG_STRONG,		/**< 强 */
	ISP_CORE_ANTIFOG_MEDIUM,		/**< 中 */
	ISP_CORE_ANTIFOG_WEAK,			/**< 弱 */
}ISP_CORE_ANTIFOG;
...
struct image_tuning_ctrls {
	...
	struct {
		...
		unsigned int manual_exp;
		unsigned int exp_gain;
		unsigned int exp_compensation;
