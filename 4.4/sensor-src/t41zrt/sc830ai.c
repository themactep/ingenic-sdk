...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sensor_attr.max_integration_time_native = 2250*2 -17;
		sensor_attr.integration_time_limit = 2250*2 -17;
		sensor_attr.total_width = 4200;
		sensor_attr.total_height = 2250;
		sensor_attr.max_integration_time = 2250*2 -17;
		sensor_attr.again =0;
