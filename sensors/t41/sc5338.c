...
static struct regval_list sc5338_init_regs_2880_1620_30fps_mipi_2lane[] = {
	...
	{0x320d,0x40},//
	{0x320e,0x07},//vts 20fps -> 2700   30fps -> 1800
	{0x320f,0x08},//
	{0x3213,0x04},
	{0x3241,0x00},
	{0x3243,0x01},
...
static int sc5338_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case 0:
		sclk = 172800000; /* 1600 * 1800 * 30 * 2 */
		max_fps = 30;
		break;
	case 1:
		sclk = 172800000; /* 1600 * 3600 * 15 * 2 */
		max_fps = 15;
		break;
	default:
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sc5338_attr.max_integration_time_native = 1800 -8;
		sc5338_attr.integration_time_limit = 1800 -8;
		sc5338_attr.total_width = 3200;
		sc5338_attr.total_height = 1800;
		sc5338_attr.max_integration_time = 1800 -8;
