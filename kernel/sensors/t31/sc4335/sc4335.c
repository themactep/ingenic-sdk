...
static struct regval_list sc4335_init_regs_1920_1080_25fps_mipi[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0xd4}, //1113
	{0x36f9, 0xd4},
...
static struct tx_isp_sensor_win_setting sc4335_win_sizes[] = {
	{
		...
		.regs 		= sc4335_init_regs_1920_1080_25fps_mipi,
	},
};
...
static int sc4335_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_EXPO:
		if(arg)
			ret = sc4335_set_expo(sd, *(int*)arg);
		break;
...
static __init int init_sc4335(void)
{
	...
	if(ret){
		ISP_ERROR("Failed to init sc4335 dirver.\n");
		return -1;
	}
