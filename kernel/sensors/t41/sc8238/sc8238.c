...
struct tx_isp_mipi_bus sc8238_mipi_1080P={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 371,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sc8238_attr.total_width = 4400;//4460
	...
	case 1:
		...
		sc8238_attr.max_integration_time_native = 2250*2 -10;
		sc8238_attr.integration_time_limit = 2250*2 -10;
		sc8238_attr.total_width = 4200;//4200
		sc8238_attr.total_height = 2250;//2250
		sc8238_attr.max_integration_time = 2250*2 -10;
		sc8238_attr.again =0;
		sc8238_attr.integration_time = 0x118a;
	...
	case 2:
		...
		sc8238_attr.max_integration_time_native = 2250*2 -10;
		sc8238_attr.integration_time_limit = 2250*2 -10;
		sc8238_attr.total_width = 4266;//4200
		sc8238_attr.total_height = 2250;//2250
		sc8238_attr.max_integration_time = 2250*2 -10;
	...
	case 3:
		...
		memcpy(&(sc8238_attr.mipi), &sc8238_mipi_1080P, sizeof(sc8238_mipi_1080P));
		sc8238_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc8238_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		sc8238_attr.max_integration_time_native = 2240; /* 2*vts-10 */
		sc8238_attr.integration_time_limit = 2240;
		sc8238_attr.total_width = 4400;
		sc8238_attr.total_height = 1125;
		sc8238_attr.max_integration_time = 2240;
		sc8238_attr.again =0;
		sc8238_attr.integration_time = 0x8c0;
		break;
	default:
