...
static struct regval_list sensor_init_regs_2880_1620_20fps_mipi_2lane[] = {
	{0x0103, 0x01},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
	{0x301f, 0x01},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	{
		...
		.regs = sensor_init_regs_2880_1620_20fps_mipi_2lane,
	}
};
...
static int sensor_attr_check(struct tx_isp_subdev *sd) {
	...
	switch (info->default_boot) {
		case 0:
			...
			sensor_attr.max_integration_time_native = 2700 - 8;
			sensor_attr.integration_time_limit = 2700 - 8;
			sensor_attr.total_width = 3200;
			sensor_attr.total_height = 2700;
			sensor_attr.max_integration_time = 2700 - 8;
			sensor_attr.again = 0;
