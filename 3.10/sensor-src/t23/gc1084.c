...
// ============================================================================
#define SENSOR_SUPPORT_30FPS_SCLK (2222 * 750 * 30)
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	/* 1280*720 */
	{
		...
		.height = 720,
		.fps = 30 << 16 | 1,
		.mbus_code = MBUS_FMT(SGRBG10_1X10),
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	ret += sensor_write(sd, 0x0d41, (unsigned char)(vts >> 8));
...
static int sensor_set_vflip(struct tx_isp_subdev *sd, int enable)
{
	...
	switch (enable)
	{
		case 0:
			...
			break;
		case 1:
			sensor_write(sd, 0x0015, 0x02); /*mirror*/
			sensor_write(sd, 0x0d15, 0x02);
			break;
		case 2:
			sensor_write(sd, 0x0015, 0x01); /*flip*/
