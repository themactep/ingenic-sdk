...
static struct regval_list sensor_init_regs_1728_972_15fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x8A},
	{0x48, 0x0A},
	{0x0E, 0x11},
...
static struct regval_list sensor_init_regs_1728_972_55fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x96},
	{0x48, 0x16},
	{0x0E, 0x11},
...
static struct regval_list sensor_init_regs_1728_1080_15fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x8A},
	{0x48, 0x0A},
	{0x0E, 0x11},
...
static struct regval_list sensor_init_regs_1728_1080_55fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x96},
	{0x48, 0x16},
	{0x0E, 0x11},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1728_972_55fps_mipi,
	},
	{
		.width = 1728,
		.height = 972,
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1728_972_15fps_mipi,
	},
	{
		.width = 1728,
		.height = 1080,
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1728_1080_15fps_mipi,
	},
	{
		.width = 1728,
		.height = 1080,
