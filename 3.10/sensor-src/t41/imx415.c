...
struct tx_isp_mipi_bus sensor_mipi_allpixl_linear = {
	.mode = SENSOR_MIPI_SONY_MODE,
	.clk = 1485,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus sensor_mipi_allpixl_30fps_linear = {
	.mode = SENSOR_MIPI_SONY_MODE,
	.clk = 1485,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static struct regval_list sensor_init_regs_3840_2160_15fps_mipi_dol[] = {
...
static struct regval_list sensor_init_regs_3840_2160_allpixl_30fps_mipi[] = {
	{0x3008, 0x7F},  // BCWAIT_TIME[9:0]
	{0x300A, 0x5B},  // CPWAIT_TIME[9:0]
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code = TISP_VI_FMT_SGBRG10_1X10,
		.colorspace = TISP_COLORSPACE_SRGB,
		.regs = sensor_init_regs_3840_2160_15fps_mipi_dol,
	},
	{
		.width = 3840,
		.height = 2160,
	...
	},
	{
		...
		.mbus_code = TISP_VI_FMT_SRGGB10_1X10,
		.colorspace = TISP_COLORSPACE_SRGB,
		.regs = sensor_init_regs_3840_2160_allpixl_30fps_mipi,
	},
};
...
static int sensor_set_wdr_stop(struct tx_isp_subdev *sd, int wdr_en) {
	...
	if (wdr_en == 1) {
		...
		sensor_attr.min_integration_time = 4;
		sensor_attr.min_integration_time_native = 4;
		sensor_attr.max_integration_time_native = 2421 - 8;
		sensor_attr.integration_time_limit = 2421 - 8;
		sensor_attr.total_width = 1022;
		sensor_attr.total_height = 2421;
		sensor_attr.max_integration_time = 2421 - 8;
		sensor_attr.integration_time_apply_delay = 2;
		sensor_attr.again_apply_delay = 2;
		sensor_attr.dgain_apply_delay = 0;
...
static int sensor_attr_check(struct tx_isp_subdev *sd) {
	...
	case 2:
		...
		sensor_attr.min_integration_time = 4;
		sensor_attr.min_integration_time_native = 4;
		sensor_attr.max_integration_time_native = 2652 - 8;
		sensor_attr.integration_time_limit = 2652 - 8;
		sensor_attr.total_width = 1400;
		sensor_attr.total_height = 2652;
		sensor_attr.max_integration_time = 2652 - 8;
		sensor_attr.integration_time_apply_delay = 2;
		sensor_attr.again_apply_delay = 2;
		sensor_attr.dgain_apply_delay = 0;
		memcpy((void *) (&(sensor_attr.mipi)), (void *) (&sensor_mipi_allpixl_linear), sizeof(sensor_mipi_allpixl_linear));
		break;
	case 3:
		...
		sensor_attr.min_integration_time = 4;
		sensor_attr.min_integration_time_native = 4;
		sensor_attr.max_integration_time_native = 2422 - 8;
		sensor_attr.integration_time_limit = 2422 - 8;
		sensor_attr.total_width = 1022;
		sensor_attr.total_height = 2422;
		sensor_attr.max_integration_time = 2422 - 8;
		sensor_attr.integration_time_apply_delay = 2;
		sensor_attr.again_apply_delay = 2;
		sensor_attr.dgain_apply_delay = 0;
		memcpy((void *) (&(sensor_attr.mipi)), (void *) (&sensor_mipi_allpixl_30fps_linear), sizeof(sensor_mipi_allpixl_30fps_linear));
		break;
	default:
