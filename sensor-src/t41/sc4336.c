...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sensor_attr.max_integration_time_native = 1500 - 10;
		sensor_attr.integration_time_limit = 1500 - 10;
		sensor_attr.total_width = 2500;
		sensor_attr.total_height = 1500;
		sensor_attr.max_integration_time = 1500 - 10;
		sensor_attr.again = 0;
		sensor_attr.integration_time = 1500 - 10;
		break;
	default:
