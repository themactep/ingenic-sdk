...
struct tx_isp_mipi_bus os04a10_2560_1440_mipi_RAW12={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1296,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus os04a10_1280_720_mipi_RAW12={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1296,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static struct regval_list os04a10_init_regs_2560_1440_30fps_mipi_RAW12[] = {
	{0x0102,0x00},
	{0x0305,0x6c},
	{0x0306,0x00},
	{0x0307,0x00},
...
static struct regval_list os04a10_init_regs_1280_720_30fps_mipi_RAW12[] = {
        {0x0103,0x01},
        {0x0109,0x01},
        {0x0104,0x02},
        {0x0102,0x00},
...
static struct tx_isp_sensor_win_setting os04a10_win_sizes[] = {
	...
	},
	{
		...
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= os04a10_init_regs_2560_1440_30fps_mipi_RAW12,
	},
	{
		.width		= 1280,
		.height		= 720,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR12_1X12,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= os04a10_init_regs_1280_720_30fps_mipi_RAW12,
	},
};
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 1:
		...
		break;
	case 2:
		wsize = &os04a10_win_sizes[2];
		memcpy(&(os04a10_attr.mipi), &os04a10_2560_1440_mipi_RAW12, sizeof(os04a10_2560_1440_mipi_RAW12));
		os04a10_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		os04a10_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		os04a10_attr.max_integration_time_native = 1624 - 8;
		os04a10_attr.integration_time_limit = 1624 - 8;
		os04a10_attr.total_width = 1476;
		os04a10_attr.total_height = 1624;
		os04a10_attr.max_integration_time = 1624 - 8;
		os04a10_attr.again = 0x80;
		os04a10_attr.integration_time = 0x640;
		break;
	case 3:
		wsize = &os04a10_win_sizes[3];
		memcpy(&(os04a10_attr.mipi), &os04a10_1280_720_mipi_RAW12, sizeof(os04a10_1280_720_mipi_RAW12));
		os04a10_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		os04a10_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		os04a10_attr.max_integration_time_native = 2436 - 8;
		os04a10_attr.integration_time_limit = 2436 - 8;
		os04a10_attr.total_width = 1476;
		os04a10_attr.total_height = 2436;
		os04a10_attr.max_integration_time = 2436 - 8;
		os04a10_attr.again = 0x80;
		os04a10_attr.integration_time = 0x640;
		break;
	default:
