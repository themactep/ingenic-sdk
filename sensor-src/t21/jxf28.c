...
#define SENSOR_CHIP_ID 0xf28
#define SENSOR_CHIP_ID_H (0x0f)
#define SENSOR_CHIP_ID_L (0x28)
#define SENSOR_REG_END 0xff
#define SENSOR_REG_DELAY 0xfe
#define SENSOR_SUPPORT_30FPS_PCLK (84000000)
#define SENSOR_SUPPORT_15FPS_PCLK (41985000)
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
	int ret = 0;
	unsigned int pclk = SENSOR_SUPPORT_30FPS_PCLK;
	unsigned int hts = 0;
	unsigned int vts = 0;
	unsigned char val = 0;
	...
	switch (sensor_max_fps) {
	case TX_SENSOR_MAX_FPS_30:
		pclk = SENSOR_SUPPORT_30FPS_PCLK;
