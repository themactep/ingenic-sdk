...
#define SENSOR_SUPPORT_SCLK (121500000)
...
static int sensor_set_analog_gain(struct tx_isp_subdev *sd, int value)
{
	...
	if (value < 0x720) {
		...
		ret += sensor_write(sd,0x3631,0x88);
		ret += sensor_write(sd,0x3632,0x18);
		ret += sensor_write(sd,0x3636,0x25);
		ret += sensor_write(sd,0x3812,0x30);
	} else if (value < 0xf20) {
		ret += sensor_write(sd,0x3812,0x00);
		ret += sensor_write(sd,0x3631,0x8e);
		ret += sensor_write(sd,0x3632,0x18);
		ret += sensor_write(sd,0x3636,0x25);
		ret += sensor_write(sd,0x3812,0x30);
	} else if (value < 0x1f20) {
		ret += sensor_write(sd,0x3812,0x00);
		ret += sensor_write(sd,0x3631,0x80);
		ret += sensor_write(sd,0x3632,0x18);
		ret += sensor_write(sd,0x3636,0x65);
		ret += sensor_write(sd,0x3812,0x30);
		...
		ret += sensor_write(sd,0x3812,0x00);
		ret += sensor_write(sd,0x3631,0x80);
		ret += sensor_write(sd,0x3632,0xd8);
		ret += sensor_write(sd,0x3636,0x65);
		ret += sensor_write(sd,0x3812,0x30);
	}
	if (ret < 0)
...
static __init int init_sensor(void)
{
	...
	if (ret) {
		printk("Failed to init sc4335 driver.\n");
		return -1;
	}
