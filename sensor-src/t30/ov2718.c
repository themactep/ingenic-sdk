...
#define SENSOR_SUPPORT_SCLK (83879040)
#define SENSOR_SUPPORT_SCLK_MIPI (119919000)
...
struct tx_isp_sensor_attribute sensor_attr_mipi={
	.name = "ov2718",
	.chip_id = 0x2770,
	.cbus_type = TX_SENSOR_CONTROL_INTERFACE_I2C,
	.cbus_mask = V4L2_SBUS_MASK_SAMPLE_8BITS | V4L2_SBUS_MASK_ADDR_16BITS,
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	val = 0;
	ret += sensor_read(sd, 0x30b0, &val);
	hts = val<<8;
	val = 0;
	ret += sensor_read(sd, 0x30b1, &val);
	hts = val;
	if (0 != ret) {
