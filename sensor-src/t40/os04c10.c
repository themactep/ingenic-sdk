...
#define OS04C10_REG_DELAY	0x0000
#define OS04C10_SUPPORT_20FPS_SCLK_HDR (1070 * 20 * 2523)
#define OS04C10_SUPPORT_30FPS_SCLK_HDR (1070 * 30 * 1682)
#define OS04C10_SUPPORT_30FPS_SCLK_LINEAR (1070 * 30 * 3151)
...
static int os04c10_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case 0:
		wpclk = OS04C10_SUPPORT_20FPS_SCLK_HDR;
		sensor_max_fps = TX_SENSOR_MAX_FPS_20;
		break;
	case 1:
		wpclk = OS04C10_SUPPORT_30FPS_SCLK_HDR;
		sensor_max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	case 2:
		wpclk = OS04C10_SUPPORT_30FPS_SCLK_LINEAR;
		sensor_max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	default:
