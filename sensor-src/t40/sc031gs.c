...
#define SC031GS_SUPPORT_120FPS_SCLK (71960880)
...
static int sc031gs_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	sclk = SC031GS_SUPPORT_120FPS_SCLK;
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 1:
		...
		memcpy((void*)(&(sc031gs_attr.mipi)),(void*)(&sc031gs_mipi_1),sizeof(sc031gs_mipi_1));
	...
	case 2:
		...
		sc031gs_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		memcpy((void*)(&(sc031gs_attr.mipi)),(void*)(&sc031gs_mipi_2),sizeof(sc031gs_mipi_2));
		sc031gs_attr.mipi.clk = 720;
