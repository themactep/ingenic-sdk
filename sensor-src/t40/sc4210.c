...
#define SC4210_SUPPORT_15FPS_SCLK (67392000)
...
static int sc4210_s_stream(struct tx_isp_subdev *sd, int enable)
{
	int ret = 0;
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
    ...
    switch(info->default_boot){
		...
		sc4210_attr.again = 0;
		sc4210_attr.integration_time = 0xc2a;
            break;
        case 1:
		...
		sc4210_attr.again = 0;
		sc4210_attr.integration_time = 0xbb4;
            break;
        default:
