...
static int pwdn_gpio = GPIO_PA(0);
...
static struct regval_list sc2336ps1_init_regs_1920_1080_20fps_mipi[] = {
	{0x0103,0x01},
	{0x0100,0x00},
	{0x36e9,0x80},
	{0x37f9,0x80},
...
static struct tx_isp_sensor_win_setting sc2336ps1_win_sizes[] = {
	{
		...
		.regs 		= sc2336ps1_init_regs_1920_1080_20fps_mipi,
	},
};
...
static int sc2336ps1_reset(struct tx_isp_subdev *sd, struct tx_isp_initarg *init)
{
	return 0;
}
...
static int sc2336ps1_set_analog_gain(struct tx_isp_subdev *sd, int value)
{
	...
	ret += sc2336ps1_write(sd, 0x3e07, (unsigned char)(value & 0xff));
	ret += sc2336ps1_write(sd, 0x3e09, (unsigned char)(((value >> 8) & 0xff)));
	if (ret < 0)
		return ret;
...
static int sc2336ps1_init(struct tx_isp_subdev *sd, struct tx_isp_initarg *init)
{
...
static int sc2336ps1_s_stream(struct tx_isp_subdev *sd, struct tx_isp_initarg *init)
{
	int ret = 0;
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
    ...
    switch (info->video_interface) {
        case TISP_SENSOR_VI_MIPI_CSI0:
            sc2336ps1_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
            sc2336ps1_attr.mipi.index = 0;
            break;
        case TISP_SENSOR_VI_MIPI_CSI1:
            sc2336ps1_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
            sc2336ps1_attr.mipi.index = 1;
            break;
        case TISP_SENSOR_VI_DVP:
            sc2336ps1_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_DVP;
            break;
        default:
            ISP_ERROR("Have no this MCLK Source!!!\n");
    }
...
static int sc2336ps1_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_EXPO:
		if(arg)
	     	ret = sc2336ps1_set_expo(sd, sensor_val->value);
		break;
//	case TX_ISP_EVENT_SENSOR_INT_TIME:
//		if(arg)
//			ret = sc2336ps1_set_integration_time(sd, sensor_val->value);
//		break;
//	case TX_ISP_EVENT_SENSOR_AGAIN:
//		if(arg)
//			ret = sc2336ps1_set_analog_gain(sd, sensor_val->value);
//		break;
	case TX_ISP_EVENT_SENSOR_DGAIN:
		if(arg)
			ret = sc2336ps1_set_digital_gain(sd, sensor_val->value);
		break;
	case TX_ISP_EVENT_SENSOR_BLACK_LEVEL:
		if(arg)
			ret = sc2336ps1_get_black_pedestal(sd, sensor_val->value);
		break;
	case TX_ISP_EVENT_SENSOR_RESIZE:
		if(arg)
			ret = sc2336ps1_set_mode(sd, sensor_val->value);
		break;
	...
	case TX_ISP_EVENT_SENSOR_FPS:
		if(arg)
			ret = sc2336ps1_set_fps(sd, sensor_val->value);
		break;
	case TX_ISP_EVENT_SENSOR_VFLIP:
		if(arg)
			ret = sc2336ps1_set_vflip(sd, sensor_val->value);
		break;
	default:
		break;
	}
