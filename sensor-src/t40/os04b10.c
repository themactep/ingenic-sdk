...
static int os04b10_reset(struct tx_isp_subdev *sd, struct tx_isp_initarg *init)
{
	return 0;
}
...
static int os04b10_init(struct tx_isp_subdev *sd, struct tx_isp_initarg *init)
{
...
static int os04b10_s_stream(struct tx_isp_subdev *sd, struct tx_isp_initarg *init)
{
	int ret = 0;
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
    ...
    switch(info->video_interface){
        case TISP_SENSOR_VI_MIPI_CSI0:
            os04b10_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
            os04b10_attr.mipi.index = 0;
            break;
        case TISP_SENSOR_VI_MIPI_CSI1:
            os04b10_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
            os04b10_attr.mipi.index = 1;
            break;
        case TISP_SENSOR_VI_DVP:
            os04b10_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_DVP;
            break;
        default:
