...
static struct regval_list sensor_init_regs_2880_1620_30fps_mipi_4lane[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x37f9, 0x80},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code = TISP_VI_FMT_SBGGR10_1X10,
		.colorspace = TISP_COLORSPACE_SRGB,
		.regs = sensor_init_regs_2880_1620_30fps_mipi_4lane,
	},
};
...
static int sensor_set_analog_gain(struct tx_isp_subdev *sd, int value)
{
	...
	again = sensor_again_lut[again].reg_value;
	ret += sensor_write(sd, 0x3e09, (unsigned char)(again >> 16 & 0xff));
	ret += sensor_write(sd, 0x3e06, (unsigned char)((again >> 8 & 0xff)));
	ret += sensor_write(sd, 0x3e07, (unsigned char)((again & 0xff)));
	if (ret < 0)
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	switch(info->default_boot) {
		case 0:
			...
			sensor_attr.again = 0;
			sensor_attr.integration_time = 0x00cda0;
			break;
		case 1:
			wsize = &sensor_win_sizes[1];
			sensor_attr.mipi.clk = 396;
			sensor_attr.mipi.lans = 4;
			sensor_attr.again = 0;
			sensor_attr.integration_time = 0x00cda0;
			break;
		default:
