...
struct again_lut sensor_again_lut[] = {
  /*index 0x00d1  0x00d0 0x00b8 0x00b9 0x0155  0x0080 ispgain */
	{0x00, 0x00,  0x00,  0x01,  0x00,  0x04,  0x09, 0},   // 1.000000
	{0x01, 0x0A,  0x00,  0x01,  0x0c,  0x04,  0x0b, 16247},   // 1.187500
	{0x02, 0x00,  0x01,  0x01,  0x1a,  0x04,  0x0d, 32233},   // 1.406250
	{0x03, 0x0A,  0x01,  0x01,  0x2a,  0x04,  0x0e, 47704},   // 1.656250
	{0x04, 0x20,  0x00,  0x02,  0x00,  0x04,  0x10, 65536},   // 2.000000
	{0x05, 0x25,  0x00,  0x02,  0x18,  0x04,  0x11, 81783},   // 2.375000
	{0x06, 0x20,  0x01,  0x02,  0x33,  0x04,  0x12, 97243},   // 2.796875
	{0x07, 0x25,  0x01,  0x03,  0x14,  0x04,  0x14, 113240},   // 3.312500
	{0x08, 0x30,  0x00,  0x04,  0x00,  0x04,  0x15, 131072},   // 4.000000
	{0x09, 0x32,  0x80,  0x04,  0x2f,  0x04,  0x16, 147007},   // 4.734375
	{0x0a, 0x30,  0x01,  0x05,  0x26,  0x04,  0x18, 162779},   // 5.593750
	{0x0b, 0x32,  0x81,  0x06,  0x29,  0x04,  0x19, 178999},   // 6.640625
	{0x0c, 0x38,  0x00,  0x08,  0x00,  0x04,  0x1a, 196608},   // 8.000000
	{0x0d, 0x39,  0x40,  0x09,  0x1f,  0x06,  0x1c, 212700},   // 9.484375
	{0x0e, 0x38,  0x01,  0x0b,  0x0d,  0x06,  0x1e, 228315},   // 11.187500
	{0x0f, 0x39,  0x41,  0x0d,  0x12,  0x06,  0x20, 244312},   // 13.250000
	{0x10, 0x30,  0x08,  0x10,  0x00,  0x06,  0x24, 262144},   // 16.000000
	{0x11, 0x32,  0x88,  0x12,  0x3e,  0x06,  0x26, 278236},   // 18.968750
	{0x12, 0x30,  0x09,  0x16,  0x1a,  0x06,  0x2a, 293982},   // 22.406250
	{0x13, 0x32,  0x89,  0x1a,  0x23,  0x06,  0x2d, 310015},   // 26.546875
	{0x14, 0x38,  0x08,  0x20,  0x00,  0x06,  0x31, 327680},   // 32.000000
	{0x15, 0x39,  0x48,  0x25,  0x3b,  0x09,  0x36, 343732},   // 37.921875
	{0x16, 0x38,  0x09,  0x2c,  0x33,  0x0b,  0x3a, 359419},   // 44.765625
	{0x17, 0x39,  0x49,  0x35,  0x06,  0x0d,  0x3c, 375411},   // 53.015625
	{0x18, 0x38,  0x0A,  0x3f,  0x3f,  0x0f,  0x3f, 393216},   // 64.000000
};
...
static int sensor_set_expo(struct tx_isp_subdev *sd, int value)
{
	...
	ret += sensor_write(sd, 0x00b8, val_lut[again].again_reg_val_2);
	ret += sensor_write(sd, 0x00b9, val_lut[again].again_reg_val_3);
	ret += sensor_write(sd, 0x0155, val_lut[again].again_reg_val_4);
	ret += sensor_write(sd, 0x0080, val_lut[again].again_reg_val_5);
	/*integration time*/
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	switch(info->default_boot) {
		case 0:
			...
			sensor_attr.total_width = 2688;
			sensor_attr.total_height = 1340;
			sensor_attr.one_line_expr_in_us = 30;
			sensor_attr.min_integration_time = 2;
			sensor_attr.max_integration_time_native = 1332;
			sensor_attr.integration_time_limit = 1332;
			sensor_attr.max_integration_time =1332;
