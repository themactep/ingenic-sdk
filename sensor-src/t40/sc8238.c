...
#define SC8238_SUPPORT_SCLK_8M_FPS_15 (70200000)
#define SC8238_SUPPORT_SCLK_8M_FPS_30 (140400000)
#define SC8238_SUPPORT_SCLK_2M_FPS_30 (120000000)
#define SC8238_SUPPORT_SCLK_2M_FPS_60 (120000000)
#define SC8238_SUPPORT_SCLK_8M_FPS_15_2 (74250000)
#define SC8238_SUPPORT_SCLK_8M_FPS_30_2 (140400000)
...
struct tx_isp_mipi_bus sc8238_mipi_2={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 600,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static struct regval_list sc8238_init_regs_1920_1080_30fps_mipi[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
static struct regval_list sc8238_init_regs_1920_1080_60fps_mipi[] = {
	{0x0103, 0x01},
	{0x0100, 0x00},
	{0x36e9, 0x80},
	{0x36f9, 0x80},
...
static struct tx_isp_sensor_win_setting sc8238_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc8238_init_regs_1920_1080_30fps_mipi,
	},
	{
		.width		= 1920,
		.height		= 1080,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc8238_init_regs_1920_1080_60fps_mipi,
	},
	{
		.width		= 3840,
		.height		= 2160,
...
static int sc8238_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case 0:
		...
		break;
	case 1:
		sclk = SC8238_SUPPORT_SCLK_8M_FPS_30;
		max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	case 2:
		sclk = SC8238_SUPPORT_SCLK_2M_FPS_30;
		max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	case 3:
		sclk = SC8238_SUPPORT_SCLK_2M_FPS_60;
		max_fps = TX_SENSOR_MAX_FPS_60;
		break;
	case 4:
		sclk = SC8238_SUPPORT_SCLK_8M_FPS_15_2;
		max_fps = TX_SENSOR_MAX_FPS_15;
		break;
	case 5:
		sclk = SC8238_SUPPORT_SCLK_8M_FPS_30_2;
		max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	default:
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sc8238_attr.mipi.image_twidth = 3840,
		sc8238_attr.mipi.image_theight = 2160,
	...
	case 2:
		...
		memcpy(&(sc8238_attr.mipi), &sc8238_mipi, sizeof(sc8238_mipi));
		sc8238_attr.mipi.image_twidth = 1920,
		sc8238_attr.mipi.image_theight = 1080,
		sc8238_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
	        sc8238_attr.again = 0;
                sc8238_attr.integration_time = 0x08c0;
		break;
	case 3:
		wsize = &sc8238_win_sizes[3];
		memcpy(&(sc8238_attr.mipi), &sc8238_mipi, sizeof(sc8238_mipi));
		sc8238_attr.mipi.image_twidth = 1920,
		sc8238_attr.mipi.image_theight = 1080,
		sc8238_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc8238_attr.max_integration_time_native = 0x4e2 - 4;
		sc8238_attr.integration_time_limit = 0x4e2 - 4;
		sc8238_attr.total_width = 0x460*2;//992
		sc8238_attr.total_height = 0x4e2;//518
		sc8238_attr.max_integration_time = 0x4e2 - 4;
	        sc8238_attr.again = 0;
                sc8238_attr.integration_time = 0x08c0;
		break;
	case 4:
		wsize = &sc8238_win_sizes[4];
		memcpy(&(sc8238_attr.mipi), &sc8238_mipi_2, sizeof(sc8238_mipi_2));
		sc8238_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc8238_attr.max_integration_time_native = 2245;
		sc8238_attr.integration_time_limit = 2245;
		sc8238_attr.total_width = 2080 * 2;//4160
		sc8238_attr.total_height = 2250;//2250
		sc8238_attr.max_integration_time = 2245;
	        sc8238_attr.again = 0;
                sc8238_attr.integration_time = 0x118a;
		printk("\n===============> 4k@ mipi_2lan@15fps \n");
		break;
	case 5:
		wsize = &sc8238_win_sizes[5];
		memcpy(&(sc8238_attr.mipi), &sc8238_mipi_2, sizeof(sc8238_mipi_2));
		sc8238_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc8238_attr.max_integration_time_native = 2245;
		sc8238_attr.integration_time_limit = 2245;
