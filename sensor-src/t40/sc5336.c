...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sc5336_attr.max_integration_time_native = 1800 -8;
		sc5336_attr.integration_time_limit = 1800 -8;
		sc5336_attr.total_width = 0x640;
		sc5336_attr.total_height = 1800;
		sc5336_attr.max_integration_time = 1800 -8;
		sc5336_attr.again =0;
