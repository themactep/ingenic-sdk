...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 1:
		...
		gc5603_attr.total_width = 1192 * 2;
		gc5603_attr.total_height = 1750;
		gc5603_attr.max_integration_time_native = 1750 - 16 - 102;
		gc5603_attr.integration_time_limit = 1750 - 16 - 102;
		gc5603_attr.max_integration_time = 1750 - 16 - 102;
