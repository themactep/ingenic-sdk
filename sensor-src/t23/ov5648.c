...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	/* 1280*720 @60fps*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1280_720_60fps,
	}
};
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
	int ret = 0;
	unsigned int sclk = SENSOR_SUPPORT_SCLK;
	unsigned int hts = 0;
	unsigned int vts = 0;
	unsigned char val = 0;
			...
			const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_RES_200:
		...
		sensor_attr.integration_time_limit = 0x460 - 4;
		sensor_attr.total_width = 0x9c4;
		sensor_attr.total_height = 0x460;
		sensor_attr.max_integration_time = 0x460 - 4;
	...
	case TX_SENSOR_RES_100:
		...
		sensor_attr.max_integration_time_native = 0x5de - 4;
		sensor_attr.integration_time_limit = 0x5de - 4;
		sensor_attr.total_width = 0x748;
		sensor_attr.total_height = 0x5de;
		sensor_attr.max_integration_time = 0x5de - 4;
