...
#define SENSOR_CHIP_ID 0x0505
#define SENSOR_CHIP_ID_H (0x05)
#define SENSOR_CHIP_ID_L (0x05)
#define SENSOR_REG_END 0xff
#define SENSOR_REG_DELAY 0xfe
#define SENSOR_SUPPORT_SCLK_5M (86400000)
...
static struct regval_list sensor_init_regs_2560_1920_15fps_mipi_5m[] = {
	{0x12, 0x40},
	{0x0E, 0x11},
	{0x0F, 0x14},
	{0x10, 0x24},
...
static struct regval_list sensor_init_regs_2560_1920_25fps_mipi_5m[] = {
	{0x12, 0x40},
	{0x0E, 0x11},
	{0x0F, 0x14},
	{0x10, 0x48},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	/* 2560*1920 @15fps*/
	{
		...
		.regs = sensor_init_regs_2560_1920_15fps_mipi_5m,
	},
	/* 2560*1920 @25fps*/
	{
		.width = 2560,
		...
		.mbus_code = V4L2_MBUS_FMT_SRGGB10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_2560_1920_25fps_mipi_5m,
	},
};
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
	int ret = 0;
	unsigned int sclk = SENSOR_SUPPORT_SCLK_5M;
	unsigned int hts = 0;
	unsigned int vts = 0;
	...
	case TX_SENSOR_MAX_FPS_15:
		...
		sclk = SENSOR_SUPPORT_SCLK_5M;
		break;
	case TX_SENSOR_MAX_FPS_25:
		max_fps = SENSOR_OUTPUT_MAX_FPS;
		sclk = SENSOR_SUPPORT_SCLK_5M << 1;
		break;
	default:
		ISP_WARNING("jxk05 Do not support this max fps now.\n");
	}
...
static __init int init_sensor(void)
{
	...
	if (ret) {
		ISP_ERROR("Failed to init jxk05 driver.\n");
		return -1;
	}
