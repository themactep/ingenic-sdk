...
#define SENSOR_SUPPORT_PCLK_MIPI (43200000)
...
static struct regval_list sensor_init_regs_1280_720_25fps_dvp[] = {
	{0x12,0x40},
	{0x0E,0x11},
	{0x0F,0x00},
	{0x10,0x18},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	/* 1280*720 */
	{
		...
		.regs = sensor_init_regs_1280_720_25fps_dvp,
	},
	{
		.width = 1280,
		.height = 720,
...
static int sensor_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	for(i = 0; i < ARRAY_SIZE(sensor_win_sizes); i++)
		sensor_win_sizes[i].mbus_code = mbus;
            ...
            wsize = &sensor_win_sizes[1];
            sensor_attr.max_integration_time_native = 749,
            sensor_attr.integration_time_limit = 749,
            sensor_attr.total_width = 2304,
            sensor_attr.total_height = 750,
            sensor_attr.max_integration_time = 749,
