...
static struct regval_list sensor_init_regs_vga_linear_110fps_mipi[] = {
	{0xEF, 0x05},
	{0x0F, 0x00},
	{0x42, 0x00},
	{0x43, 0x06},
...
static struct regval_list sensor_init_regs_1440x1080_linear_45fps_mipi[] = {
	{0xEF, 0x05},
	{0x0F, 0x00},
	{0x42, 0x00},
	{0x43, 0x06},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	/* 1536*1536 @25fps linear*/
	{
		...
		.regs = sensor_init_regs_1536_1536_linear_25fps_mipi,
	},
	/* vga@110fps linear*/
	{
		.width = 640,
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_vga_linear_110fps_mipi,
	},
	/* 1440x1080@25fps linear*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1440x1080_linear_45fps_mipi,
	}
...
static int sensor_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case TX_SENSOR_MAX_FPS_30:
		pclk = SENSOR_SUPPORT_30FPS_MIPI_SCLK;
		max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	case TX_SENSOR_MAX_FPS_110:
		pclk = SENSOR_SUPPORT_VGA_SCLK;
		max_fps = TX_SENSOR_MAX_FPS_110;
		break;
	case TX_SENSOR_MAX_FPS_45:
		pclk = SENSOR_SUPPORT_45FPS_MIPI_SCLK;
			...
			const struct i2c_device_id *id)
{
	...
	if (sensor_resolution == TX_SENSOR_RES_200) {
		...
		sensor_attr.total_width = 0xe00 / 2;
		sensor_attr.total_height = 0x77f + 1;
		sensor_attr.max_integration_time_native = 0x77f - 2;
		sensor_attr.integration_time_limit = 0x77f - 2;
		sensor_attr.max_integration_time = 0x77f - 2;
		sensor_attr.one_line_expr_in_us = 21;
		sensor_attr.mipi.clk = 600;
		sensor_attr.mipi.image_twidth= 1536;
		sensor_attr.mipi.image_theight= 1536;
	} else if (sensor_resolution == TX_SENSOR_RES_30) {
		wsize = &sensor_win_sizes[1];
		sensor_attr.total_width = 0xc4e / 2;
		sensor_attr.total_height = 0x1ef + 1;
		sensor_attr.max_integration_time_native = 0x1ef - 2;
		sensor_attr.integration_time_limit = 0x1ef - 2;
		sensor_attr.max_integration_time = 0x1ef - 2;
		...
		sensor_attr.total_width = 0xc4e / 2;
		sensor_attr.total_height = 0x4bd + 1;
		sensor_attr.max_integration_time_native = 0x4bd - 2;
		sensor_attr.integration_time_limit = 0x4bd - 2;
		sensor_attr.max_integration_time = 0x4bd - 2;
