...
#define SENSOR_SUPPORT_SCLK_960P (83904000)
...
static struct regval_list sensor_init_regs_1280_960_30fps[] = {
	{0x0103, 0x01},
	{0x3001, 0x00},
	{0x3002, 0x00},
	{0x3011, 0x02},
...
static struct tx_isp_sensor_win_setting sensor_win_sizes[] = {
	...
	/* 1280*960 @30fps*/
	{
		...
		.mbus_code = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs = sensor_init_regs_1280_960_30fps,
	}
};
			...
			const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_RES_130:
		...
		sensor_attr.mipi.clk = 420;
		sensor_attr.mipi.image_twidth = 1280;
		sensor_attr.mipi.image_theight = 960;
		sensor_attr.max_integration_time_native = 0x47e - 4;
		sensor_attr.integration_time_limit = 0x47e - 4;
		sensor_attr.total_width = 0x980;
		sensor_attr.total_height = 0x47e;
		sensor_attr.max_integration_time = 0x47e - 4;
		sensor_attr.one_line_expr_in_us = 22;
		break;
	default:
		ISP_ERROR("Now we do not support this framerate!!!\n");
