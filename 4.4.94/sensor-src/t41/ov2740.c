...
struct tx_isp_mipi_bus ov2740_mipi_linear_60fps = {
	.clk = 720,
	.lans = 2,
	.settle_time_apative_en = 0,
	.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10,
...
static struct tx_isp_sensor_win_setting ov2740_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code = TISP_VI_FMT_SBGGR10_1X10,
		.colorspace = TISP_COLORSPACE_SRGB,
		.regs = ov2740_init_regs_1920_1080_60fps_mipi,
	}};
...
static int sensor_attr_check(struct tx_isp_subdev *sd) {
	...
	case 0:
		...
		ov2740_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI, ov2740_attr.max_integration_time_native = 1340,
		ov2740_attr.integration_time_limit = 1340, ov2740_attr.total_width = 2160,
		ov2740_attr.total_height = 1344, ov2740_attr.max_integration_time = 1340,
		ov2740_attr.one_line_expr_in_us = 30;
		ov2740_attr.again = 0x80;
		ov2740_attr.integration_time = 0x4440;
		break;
	case 1:
		wsize = &ov2740_win_sizes[1];
		memcpy(&ov2740_attr.mipi, &ov2740_mipi_linear_60fps, sizeof(ov2740_mipi_linear_60fps));
		ov2740_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		ov2740_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI, ov2740_attr.max_integration_time_native = 1340,
		ov2740_attr.integration_time_limit = 1340, ov2740_attr.total_width = 0x538,
		ov2740_attr.total_height = 1344, ov2740_attr.max_integration_time = 1340,
		ov2740_attr.one_line_expr_in_us = 30;
		ov2740_attr.again = 0x80;
		ov2740_attr.integration_time = 0x4440;
...
static int ov2740_g_chip_ident(struct tx_isp_subdev *sd, struct tx_isp_chip_ident *chip) {
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int ov2740_set_hvflip(struct tx_isp_subdev *sd, int enable) {
	int ret = 0;
	uint8_t val;
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);

	/* 2'b01:mirror,2'b10:filp */
	ov2740_read(sd, 0x3820, &val);
...
static int ov2740_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg) {
	...
	case TX_ISP_EVENT_SENSOR_VFLIP:
		if (arg)
			ret = ov2740_set_hvflip(sd, sensor_val->value);
		break;
	default:
		break;
	}
...
static const struct i2c_device_id ov2740_id[] = {{"ov2740", 0}, {}};
