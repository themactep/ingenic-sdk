...
#define IOCTL_AES_GET_OUTPUT		_IOW(JZAES_IOC_MAGIC, 113, unsigned char)
#define IOCTL_AES_GET_ADDR			_IOW(JZAES_IOC_MAGIC, 114, unsigned int)
#define IOCTL_AES_LOCK			    _IOW(JZAES_IOC_MAGIC, 115, unsigned int)
#define IOCTL_AES_UNLOCK			_IOW(JZAES_IOC_MAGIC, 116, unsigned int)
// #define IOCTL_AES_FLUSH_CACHE		_IOW(JZAES_IOC_MAGIC, 117, struct aes_flush_cache)
