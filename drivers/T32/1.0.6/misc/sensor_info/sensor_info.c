...
static int reset_gpio = GPIO_PA(20);
...
SENSOR_INFO_T g_sinfo[] =
{
    ...
    {"ov02b10",  0x3c,  "div_cim", 24000000, {0x00, 0x00}, 1, {0xf0, 0xf1}, 1, 2, NULL},
    {"ov02b10s1",  0x3d,  "div_cim", 24000000, {0x00, 0x00}, 1, {0xf0, 0xf1}, 1, 2, NULL},
    ...
    {"gc5613",  0x31,  "div_cim", 24000000, {0x56, 0x03}, 1, {0x3f0, 0x3f1}, 2, 2, NULL},
    {"gc5613s1",  0x31,  "div_cim", 24000000, {0x56, 0x03}, 1, {0x3f0, 0x3f1}, 2, 2, NULL},
    {"gc5613s2",  0x31,  "div_cim", 24000000, {0x56, 0x03}, 1, {0x3f0, 0x3f1}, 2, 2, NULL},
    {"gc5613s3",  0x31,  "div_cim", 24000000, {0x56, 0x03}, 1, {0x3f0, 0x3f1}, 2, 2, NULL},
    ...
    {"sc200ais1",  0x32,  "div_cim", 24000000, {0xcb, 0x1c}, 1, {0x3107, 0x3108}, 2, 2, NULL},
    {"gc4023",  0x29,  "div_cim", 27000000, {0x40, 0x23}, 1, {0x03f0, 0x03f1}, 2, 2, NULL},
    {"imx179",  0x10,  "div_cim", 24000000, {0x09, 0x87}, 1, {0x0008, 0x0009}, 2, 2, NULL},
    ...
    {"os02n10",  0x3c,  "div_cim", 27000000, {0x53, 0x02, 0x4e}, 1, {0x02, 0x03, 0x04}, 1, 3, NULL},
    ...
    {"sc235hais1",  0x32,  "div_cim", 24000000, {0xcb, 0x6a}, 1, {0x3107, 0x3108}, 2, 2, NULL},
    ...
    {"cv4006",  0x35,  "div_cim", 24000000, {0x40, 0x38}, 1, {0x3003, 0x3002}, 2, 2, NULL},
    {"gc1084",  0x37,  "div_cim", 27000000, {0x10, 0x84}, 1, {0x03f0, 0x03f1}, 2, 2, NULL},
...
static int32_t process_one_adapter(struct device *dev, void *data)
{
	...
	if(cim_gpio != -1){
		...
		if(!ret){
			jzgpio_set_func((cim_gpio / 32), GPIO_FUNC_0, 1 << (cim_gpio % 32));
		}
	}
