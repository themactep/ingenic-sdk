 ...
 *  0           3840*2160       30        mipi_2lane    linear  10        30         无
 * @I2C addr:0x31, 0x10
 *
 * @FSync:none
 *
...
static struct regval_list gc8613a_init_regs_3840_2160_25fps_mipi[] = {
    //version 2.2
    //<MODE_3type="MODE_3_GC8613_3840*2160_30fps_raw10_2lane_1000_YA001">
...
static struct tx_isp_sensor_win_setting gc8613a_win_sizes[] = {
    /* 3840*2160 [0] */
    {
        ...
        .regs			= gc8613a_init_regs_3840_2160_25fps_mipi,
    },
};
...
static int gc8613a_setting_select(struct tx_isp_subdev *sd, int deboot)
{
    ...
    case 0:
        ...
        gc8613a_attr.again.value = 65536;
