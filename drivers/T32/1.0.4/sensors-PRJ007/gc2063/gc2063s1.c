 ...
 *  0           1920*1080       15        mipi_2lane    linear  10        15         null
 *
 * @I2C addr:0x37
 *
 * @FSync:none
...
#define SENSOR_VERSION  "H20241115a"
...
static struct regval_list gc2063s1_init_regs_1920_1080_15fps_mipi[] = {
	...
	{0xf5,0xc0},
	{0xf6,0x44},
	{0xf7,0x03},//0x1->0x3 down mipidata
	{0xf8,0x63},
	{0xf9,0x40},
	{0xfc,0x8e},
	{0xfe,0x00},
...
static int gc2063s1_setting_select(struct tx_isp_subdev *sd, int deboot)
{
	...
	case 0:
		...
		gc2063s1_attr.integration_time.value = 0x460;
		gc2063s1_attr.integration_time.max = 1125 - 1;
		gc2063s1_attr.integration_time.min = 1;
		gc2063s1_attr.integration_time.apply_delay = 2;

		gc2063s1_attr.total_width = 1100;
		gc2063s1_attr.total_height = 1125;
...
static int gc2063s1_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case 0:
		sclk = 1100 * 1125 * 30;  /**< HTS * VTS * FPS */
		max_fps = 30;
		break;
	case 1:
		sclk = 1100 * 1125 * 15;  /**< HTS * VTS * FPS */
		max_fps = 15;
		break;
	default:
		ret = -1;
...
MODULE_DESCRIPTION("A low-level driver for gc2063s1 sensor");
MODULE_LICENSE("GPL");
