...
#undef CONFIG_TEST_PDMA_PRJ008
#define CONFIG_TEST_DMA_PRJ008
#undef DEBUG
...
#define IOCTL_HASH_PDMA						_IOW(JZHASH_IOC_MAGIC, 117, unsigned int)
...
#define HASH_HSSA       0x0C    //hash DMA source address
#define HASH_HSTC       0x10    //hash transfer count
#define HASH_HSBNUM     0x14    //hash transfer count
#define HASH_HSDI       0x18    //hash data input register
#define HASH_HSDO       0x1C    //hash data output register
#define HASH_HSCG       0x20    //hash clock gate register
#endif
...
#define JZ_HASH_DMA_DATALEN (32 * 1024 + 64)
#define miscdev_to_hashops(mdev) (container_of(mdev, struct hash_operation, hash_dev))

#define PDMA_BASE_ADDR 0x13420000
#define PDMA_ADDR_LEN 0x10000
#define PDMA_DST_ADDR 0x1348000c
#define PDMA_MODE 0x22

struct hash_pdma_para {
