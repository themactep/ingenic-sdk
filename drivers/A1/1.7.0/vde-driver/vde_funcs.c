...
static int half_frame_int = 0;
module_param(half_frame_int, int, S_IRUGO);
MODULE_PARM_DESC(half_frame_int, "half frame interrupt interrupt status");
...
int get_half_frame_interrupt_status(void)
{
	return half_frame_int;
}
