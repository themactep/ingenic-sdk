...
//static int reset_gpio = GPIO_PC(28); // index 1 mipi lane 2/3
//static int reset_gpio = GPIO_PC(17); //dvp
static int reset_gpio = GPIO_PC(27);// index 0 mipi lane 0/1
...
//	sensor->mclk = private_devm_clk_get(&client->dev, "div_cim2");
