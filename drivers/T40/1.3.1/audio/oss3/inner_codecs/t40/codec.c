...
//	msleep(10);
	...
	codec_reg_set(TS_CODEC_CAVR_08, 0, 7, 0);     //ADC left volume set 0
	codec_reg_set(TS_CODEC_CGAINLR_09, 0, 7, 0);  //ADC right volume set 0
	return 0;
}
...
static int codec_enable_left_record(void)
{
	...
	codec_reg_set(TS_CODEC_CGAINLR_0a, 2, 2, 0);
	...
	msleep(10);
	codec_reg_set(TS_CODEC_CAVR_08, 0, 7, 0xc3);     //ADC left volume restore
	return 0;
}
...
static int codec_enable_right_record(void)
{
	...
	msleep(10);
	codec_reg_set(TS_CODEC_CGAINLR_09, 0, 7, 0xc3);  //ADC right volume restore
	/* now begin recording... */
#endif
	return 0;
}
...
{
	codec_reg_set(TS_CODEC_CGAINLR_0a, 2, 2, 1);
