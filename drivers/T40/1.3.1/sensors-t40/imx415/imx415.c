...
#define SENSOR_VERSION	"H20240429a"
...
struct tx_isp_mipi_bus imx415_1080P_mipi={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1485,
	.lans = 4,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus imx415_mipi_2lane={
...
struct tx_isp_sensor_attribute imx415_attr={
	...
	.max_integration_time_native = 2251 - 8,
	.integration_time_limit = 2251 - 8,
	.total_width = 1066,
	.total_height = 2251,
	.max_integration_time = 2251 - 8,
...
static struct regval_list imx415_init_regs_3840_2160_30fps_mipi_2lane[] = {
	{0x3008,0x7f},
	{0x300a,0x5b},
	{0x301c,0x04},
	{0x3024,0x75},//vmax = 0x975 = 2421
	{0x3025,0x09},//
	{0x3028,0xfe},//hmax = 0x3fe = 1022
	{0x3029,0x03},//
	{0x3031,0x00},
	{0x3032,0x00},
	{0x3033,0x08},
...
static struct tx_isp_sensor_win_setting imx415_win_sizes[] = {
	...
	},
	{
		...
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs		= imx415_init_regs_3840_2160_30fps_mipi_2lane,
	},
};
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		imx415_attr.max_integration_time_native = 2251 - 8;
		imx415_attr.integration_time_limit = 2251 - 8;
		imx415_attr.total_width = 1066;
		imx415_attr.total_height = 2251;
		imx415_attr.max_integration_time = 2251 - 8;
		imx415_attr.again = 0;
		imx415_attr.integration_time = 0xef4;
		memcpy(&(imx415_attr.mipi), &imx415_mipi, sizeof(imx415_mipi));
		break;
	case 1:
		wsize = &imx415_win_sizes[1];
		imx415_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		imx415_attr.max_integration_time_native = 4503 - 8;
		imx415_attr.integration_time_limit = 4503 - 8;
		imx415_attr.total_width = 1066;
		imx415_attr.total_height = 4503;
		imx415_attr.max_integration_time = 4503 - 8;
		imx415_attr.again = 0;
		imx415_attr.integration_time = 0xef4;
		memcpy(&(imx415_attr.mipi), &imx415_mipi, sizeof(imx415_mipi));
		break;
	case 2:
		...
		imx415_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		imx415_attr.max_integration_time_native = 2892 - 8;
		imx415_attr.integration_time_limit = 2892 - 8;
		imx415_attr.total_width = 365;
		imx415_attr.total_height = 2892;
		imx415_attr.max_integration_time = 2892 - 8;
		imx415_attr.again = 0;
		imx415_attr.integration_time = 0x2000;
		memcpy(&(imx415_attr.mipi), &imx415_1080P_mipi, sizeof(imx415_1080P_mipi));
		break;
	case 3:
		wsize = &imx415_win_sizes[3];
		memcpy(&(imx415_attr.mipi), &imx415_mipi_2lane, sizeof(imx415_mipi_2lane));
		imx415_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
