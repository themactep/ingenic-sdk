...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		gc2083_attr.one_line_expr_in_us = 26;
		gc2083_attr.total_width = 0x540*2;
		gc2083_attr.total_height = 0X58A;
		gc2083_attr.max_integration_time_native = 0X58A - 8;
		gc2083_attr.integration_time_limit = 0X58A - 8;
		gc2083_attr.max_integration_time = 0X58A - 8;
                gc2083_attr.again = 0;
