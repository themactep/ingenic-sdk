...
#define sc3338_SUPPORT_SCLK_RES_300 (0x4e2 * 2 * 0x550 * 30)
#define sc3338_SUPPORT_SCLK_RES_200 (0x4e2 * 2 * 0x528 * 30)
#define sc3338_SUPPORT_SCLK_RES_30 (1250 * 0x198 * 100)
#define SENSOR_OUTPUT_MAX_FPS 100
#define SENSOR_OUTPUT_MIN_FPS 5
#define SENSOR_VERSION	"H20220307a"
...
struct sensor_gain_lut sc3338_gain_lut[] = {
...
{
	struct sensor_gain_lut *lut = sc3338_gain_lut;
...
struct tx_isp_mipi_bus sc3338_mipi0={
...
struct tx_isp_mipi_bus sc3338_mipi1={
    .mode = SENSOR_MIPI_OTHER_MODE,
    .clk = 495,
    .lans = 2,
    .settle_time_apative_en = 1,
...
struct tx_isp_mipi_bus sc3338_mipi2={
    .mode = SENSOR_MIPI_OTHER_MODE,
    .clk = 255,
    .lans = 2,
...
static struct regval_list sc3338_init_regs_2304_1296_30fps_mipi[] = {
	/* cleaned_0x02_sc3338_MIPI_24Minput_2Lane_10bit_510Mbps_2304x1296_30fps*/
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x301f,0x02},
...
static struct regval_list sc3338_init_regs_2096_1296_30fps_mipi[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x301f,0x02},
...
static struct regval_list sc3338_init_regs_640_360_100fps_mipi[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x301f,0x0c},
...
static struct tx_isp_sensor_win_setting sc3338_win_sizes[] = {
	...
	/* [1] 2096*1296 @max 30fps */
	{
		...
		.mbus_code  = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs       = sc3338_init_regs_2096_1296_30fps_mipi,
	},
	/* [1] 640*360 @max 100fps */
	{
		...
		.mbus_code  = V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace = V4L2_COLORSPACE_SRGB,
		.regs       = sc3338_init_regs_640_360_100fps_mipi,
	}
};
...
static int sc3338_set_expo(struct tx_isp_subdev *sd, int value)
{
	...
	struct sensor_gain_lut *gain_lut = sc3338_gain_lut;
	...
	/*set analog gain*/
	ret = sc3338_write(sd, 0x3e09, gain_lut[index].again);
	/*set coarse dgain*/
	ret = sc3338_write(sd, 0x3e06, gain_lut[index].coarse_dgain);
	/*set fine dgain*/
	ret = sc3338_write(sd, 0x3e07, gain_lut[index].fine_dgain);
	if (ret < 0)
		return ret;
...
static int sc3338_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case TX_SENSOR_RES_300:
		sclk = sc3338_SUPPORT_SCLK_RES_300;
		break;
	case TX_SENSOR_RES_200:
		sclk = sc3338_SUPPORT_SCLK_RES_200;
		break;
	case TX_SENSOR_RES_30:
		sclk = sc3338_SUPPORT_SCLK_RES_30;
		break;
	default:
		break;
	}
...
static int sc3338_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(sensor_resolution == TX_SENSOR_RES_300){
		...
		memcpy((void*)(&(sc3338_attr.mipi)),(void*)(&sc3338_mipi0),sizeof(sc3338_mipi0));
		sc3338_attr.max_integration_time_native = 1632 - 8;
		sc3338_attr.integration_time_limit = 1632 - 8;
		sc3338_attr.total_width = 0x4e2 * 2;
		sc3338_attr.total_height = 1632;
		sc3338_attr.max_integration_time = 1632 - 8;
	}else if(sensor_resolution == TX_SENSOR_RES_200){
		wsize = &sc3338_win_sizes[1];
		memcpy((void*)(&(sc3338_attr.mipi)),(void*)(&sc3338_mipi1),sizeof(sc3338_mipi1));
		sc3338_attr.max_integration_time_native = 1320 - 8;
		sc3338_attr.integration_time_limit = 1320 - 8;
		sc3338_attr.total_width = 0x4e2 * 2;
		sc3338_attr.total_height = 1320;
		sc3338_attr.max_integration_time = 1320 - 8;
	}else if(sensor_resolution == TX_SENSOR_RES_30){
		wsize = &sc3338_win_sizes[2];
		memcpy((void*)(&(sc3338_attr.mipi)),(void*)(&sc3338_mipi2),sizeof(sc3338_mipi2));
		sc3338_attr.max_integration_time_native = 408;
		sc3338_attr.integration_time_limit = 408;
		sc3338_attr.total_width = 1250;
		sc3338_attr.total_height = 408;
		sc3338_attr.max_integration_time = 408;
	}
	else{
