...
#define OV5648_SUPPORT_SCLK_960P (83904000)
...
static struct regval_list ov5648_init_regs_1280_960_30fps[] = {
	{0x0103, 0x01},
	{0x3001, 0x00},
	{0x3002, 0x00},
	{0x3011, 0x02},
...
static struct tx_isp_sensor_win_setting ov5648_win_sizes[] = {
	...
	/* 1280*960 @30fps*/
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= ov5648_init_regs_1280_960_30fps,
	}
};
...
static int ov5648_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case TX_SENSOR_RES_100:
		...
		break;
	case TX_SENSOR_RES_130:
		sclk = OV5648_SUPPORT_SCLK_960P;
		max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	default:
		ret = -1;
			...
			const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_RES_100:
		...
		break;
	case TX_SENSOR_RES_130:
		wsize = &ov5648_win_sizes[3];
		ov5648_attr.mipi.clk = 420;
		ov5648_attr.mipi.image_twidth = 1280;
		ov5648_attr.mipi.image_theight = 960;
		ov5648_attr.max_integration_time_native = 0x47e - 4;
		ov5648_attr.integration_time_limit = 0x47e - 4;
		ov5648_attr.total_width = 0x980;
		ov5648_attr.total_height = 0x47e;
		ov5648_attr.max_integration_time = 0x47e - 4;
		ov5648_attr.one_line_expr_in_us = 22;
		break;
	default:
		ISP_ERROR("Now we do not support this framerate!!!\n");
