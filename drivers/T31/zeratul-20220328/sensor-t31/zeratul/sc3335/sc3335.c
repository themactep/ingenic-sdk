...
#define sc3335_SUPPORT_50FPS_SCLK (102000000)
...
struct tx_isp_sensor_attribute sc3335_attr={
	...
	.max_integration_time_native = 1360 - 5,
	.integration_time_limit = 1360 - 5,
	.total_width = 2500,
	.total_height = 1360,
	.max_integration_time = 1360 - 5,
...
static struct regval_list sc3335_init_regs_1152_648_50fps[] = {
{0x0103,0x01},
{0x0100,0x00},
{0x36e9,0x80},
{0x36f9,0x80},
...
static struct tx_isp_sensor_win_setting sc3335_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= sc3335_init_regs_1152_648_50fps,
	}
};
...
static int sc3335_init(struct tx_isp_subdev *sd, int enable)
{
	...
	char tmpa, tmpb, tmpc, tmpx, tmpy;
	char tmp363c, tmp330e, tmp5799;
	sc3335_read(sd, 0x3e00, &tmpa);
	sc3335_read(sd, 0x3e01, &tmpb);
	sc3335_read(sd, 0x3e02, &tmpc);
	sc3335_read(sd, 0x3e08, &tmpx);
	sc3335_read(sd, 0x3e09, &tmpy);
	sc3335_read(sd, 0x363c, &tmp363c);
	sc3335_read(sd, 0x330e, &tmp330e);
	sc3335_read(sd, 0x5799, &tmp5799);
	printk("3e00=0x%x 3e01=0x%x 3e02=0x%x\n", tmpa, tmpb, tmpc);
	printk("3e09=0x%x 3e08=0x%x\n", tmpy, tmpx);
	printk("363c=0x%x 330e=0x%x 330e=0x%x\n", tmp363c, tmp330e, tmp5799);
...
static int sc3335_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	int ret = 0;
        ...
        case TX_SENSOR_MAX_FPS_30:
            ...
            break;
        case TX_SENSOR_MAX_FPS_50:
            sclk = sc3335_SUPPORT_50FPS_SCLK;
...
static int sc3335_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
		...
		/* sc3335_attr.max_integration_time = 1498; */
		    ...
		    memcpy((void*)(&(sc3335_attr.mipi)),(void*)(&sc3335_mipi),sizeof(sc3335_mipi));
                ...
                case TX_SENSOR_MAX_FPS_50:
                    ...
                    sc3335_attr.max_integration_time_native=0x2a8-5;
                    sc3335_attr.integration_time_limit=0x2a8-5;
                    sc3335_attr.total_width=0x4e2;
                    sc3335_attr.total_height=0x2a8;
                    sc3335_attr.max_integration_time=0x2a8-5;
		    memcpy((void*)(&(sc3335_attr.mipi)),(void*)(&sc3335_mipi),sizeof(sc3335_mipi));
                    break;
                }
	...
	*/
	...
	printk("probe ok ------->sc3335 build:%s %s\n", __DATE__, __TIME__);
