...
/* VGA@120fps: insmod sensor_os02k10_t31.ko sensor_resolution=30 sensor_max_fps=120 */
/* 1080p@15fps: insmod sensor_os02k10_t31.ko sensor_resolution=200 sensor_max_fps=15 */
/* 1080p@45fps: insmod sensor_os02k10_t31.ko sensor_resolution=200 sensor_max_fps=45 */
/* 1080p@50fps: insmod sensor_os02k10_t31.ko sensor_resolution=200 sensor_max_fps=50 */
/* 1080p@55fps: insmod sensor_os02k10_t31.ko sensor_resolution=200 sensor_max_fps=55 */
/* 1080p@60fps: insmod sensor_os02k10_t31.ko sensor_resolution=200 sensor_max_fps=60 */
...
#define OS02K10_SUPPORT_SCLK_55 (107971875)
...
typedef enum {
	...
	SENSOR_OUTPUT_MAX_FPS_50 = 50,
	SENSOR_OUTPUT_MAX_FPS_55 = 55,
	SENSOR_OUTPUT_MAX_FPS_60 = 60,
	SENSOR_OUTPUT_MAX_FPS_120 = 120,
} Sensor_RES;
...
static int sensor_max_fps = SENSOR_OUTPUT_MAX_FPS_60;
...
static struct regval_list os02k10_init_regs_1920_1080_55fps[] = {
	{0x302a, 0x00},
	{0x0103, 0x01},
	{0x0109, 0x01},
	{0x0104, 0x02},
...
static struct regval_list os02k10_init_regs_1920_1080_50fps[] = {
	{0x302a, 0x00},
	{0x0103, 0x01},
	{0x0109, 0x01},
	{0x0104, 0x02},
...
static struct regval_list os02k10_init_regs_1920_1080_45fps[] = {
	{0x302a, 0x00},
	{0x0103, 0x01},
	{0x0109, 0x01},
	{0x0104, 0x02},
...
static struct tx_isp_sensor_win_setting os02k10_win_sizes[] = {
	...
	/*[3] 2M@55fps*/
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os02k10_init_regs_1920_1080_55fps,
	},
	/*[4] 2M@50fps*/
	{
		.width		= 1920,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os02k10_init_regs_1920_1080_50fps,
	},
	/*[5] 2M@45fps*/
	{
		.width		= 1920,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os02k10_init_regs_1920_1080_45fps,
	},
};
...
static int os02k10_set_expo(struct tx_isp_subdev *sd, int value)
{
	...
	//printk("%s integration time:%d again:%d\n", __func__, it, again);
...
static int os02k10_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case SENSOR_OUTPUT_MAX_FPS_120:
		max_fps = SENSOR_OUTPUT_MAX_FPS_120;
		sclk = OS02K10_SUPPORT_SCLK;
		break;
	case SENSOR_OUTPUT_MAX_FPS_15:
		max_fps = SENSOR_OUTPUT_MAX_FPS_15;
		sclk = OS02K10_SUPPORT_SCLK;
		break;
	case SENSOR_OUTPUT_MAX_FPS_60:
		max_fps = SENSOR_OUTPUT_MAX_FPS_60;
		sclk = OS02K10_SUPPORT_SCLK;
		break;
	case SENSOR_OUTPUT_MAX_FPS_55:
		max_fps = SENSOR_OUTPUT_MAX_FPS_55;
		sclk = OS02K10_SUPPORT_SCLK_55;
		break;
	case SENSOR_OUTPUT_MAX_FPS_50:
		max_fps = SENSOR_OUTPUT_MAX_FPS_50;
		sclk = OS02K10_SUPPORT_SCLK_55;
		break;
	case SENSOR_OUTPUT_MAX_FPS_45:
		max_fps = SENSOR_OUTPUT_MAX_FPS_45;
		sclk = OS02K10_SUPPORT_SCLK_55;
		break;
	default:
		ret = -1;
...
static int os02k10_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_EXPO:
		if(arg)
			ret = os02k10_set_expo(sd, *(int*)arg);
		break;
...
extern uint32_t tx_isp_alloc_sensor_analog_gain(uint32_t value);
static int os02k10_init(struct tx_isp_subdev *sd, int enable)
{
	...
	// 将帧率切到 15 fps，移到ISP中操作
	//os02k10_set_fps(sd, fps_num << 16 | fps_den);
	//os02k10_set_expo(sd, ((tx_isp_alloc_sensor_analog_gain(g_riscv_sensor_again) << 16) | g_riscv_sensor_inttime));
			 ...
			 const struct i2c_device_id *id)
{
	...
	case SENSOR_OUTPUT_MAX_FPS_60:
		...
		break;
	case SENSOR_OUTPUT_MAX_FPS_55:
		wsize = &os02k10_win_sizes[3];
		os02k10_attr.one_line_expr_in_us = 16;
		os02k10_attr.max_integration_time_native = 0x465 - 8;
		os02k10_attr.integration_time_limit = 0x465 - 8;
		os02k10_attr.total_width = 0x6d1; //1745
		os02k10_attr.total_height = 0x465; //1125
		os02k10_attr.max_integration_time = 0x465 - 8;
		break;
	case SENSOR_OUTPUT_MAX_FPS_50:
		wsize = &os02k10_win_sizes[4];
		os02k10_attr.one_line_expr_in_us = 16;
		os02k10_attr.max_integration_time_native = 0x4d4 - 8;
		os02k10_attr.integration_time_limit = 0x4d4 - 8;
		os02k10_attr.total_width = 0x6d1; //1745
		os02k10_attr.total_height = 0x4d4; //1236
		os02k10_attr.max_integration_time = 0x4d4 - 8;
		break;
	case SENSOR_OUTPUT_MAX_FPS_45:
		wsize = &os02k10_win_sizes[5];
		os02k10_attr.one_line_expr_in_us = 16;
		os02k10_attr.max_integration_time_native = 0x55f - 8;
		os02k10_attr.integration_time_limit = 0x55f - 8;
		os02k10_attr.total_width = 0x6d1; //1745
		os02k10_attr.total_height = 0x55f; //1375
		os02k10_attr.max_integration_time = 0x55f - 8;
		break;
	default:
		ISP_ERROR("Now we do not support this framerate!!!\n");
	}
	...
	printk("probe ok ------->os02k10 build:%s %s\n", __DATE__, __TIME__);
...
{
	return os02k10_win_sizes->width;
}

int get_sensor_height()
{
	return os02k10_win_sizes->height;
}
