...
#define JXQ03P_SUPPORT_30FPS_SCLK (143910000)
...
static struct regval_list jxq03p_init_2304_1296_25fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x96},
	{0x48, 0x16},
	{0x0E, 0x11},
...
static struct tx_isp_sensor_win_setting jxq03p_win_sizes[] = {
	/* 2304*1296 */
	{
		...
		.regs 		= jxq03p_init_2304_1296_25fps_mipi,
	},
};
...
int jxq03p_write(struct tx_isp_subdev *sd, unsigned char reg,
		unsigned char value)
{
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int jxq03p_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	sclk = JXQ03P_SUPPORT_30FPS_SCLK;
...
static int jxq03p_g_chip_ident(struct tx_isp_subdev *sd,
...
static const struct i2c_device_id jxq03p_id[] = {
	{ "jxq03p", 0 },
	{ }
};
