...
#define JXK05_SUPPORT_SCLK_4M	(144000000)
#define SENSOR_OUTPUT_MAX_FPS 25
#define SENSOR_OUTPUT_MIN_FPS 5
#define SENSOR_VERSION	"H20200618a"
...
static int pwdn_gpio = GPIO_PA(14);//-1;
...
struct tx_isp_mipi_bus jxk05_mipi_1920_1920={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 360,
	.lans = 2,
	.settle_time_apative_en = 1,
...
static struct regval_list jxk05_init_regs_1920_1920_20fps_mipi_4m[] = {
	{0x12, 0x40},
	{0x0E, 0x11},
	{0x0F, 0x14},
	{0x10, 0x3C},
...
static struct tx_isp_sensor_win_setting jxk05_win_sizes[] = {
	...
	/* 1920*1920 @20fps*/
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SRGGB10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= jxk05_init_regs_1920_1920_20fps_mipi_4m,
	},
...
static int jxk05_init(struct tx_isp_subdev *sd, int enable)
{
	...
	if(sensor_resolution == SENSOR_RES_500){
	...
	}else if(sensor_resolution == SENSOR_RES_400){
		wsize = &jxk05_win_sizes[2];
	}
...
#else
	ret = jxk05_write(sd, 0x22, (unsigned char)(vts & 0xff));
	ret += jxk05_write(sd, 0x23, (unsigned char)(vts >> 8));
#endif
	if (0 != ret) {
...
static int jxk05_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if(sensor_resolution == SENSOR_RES_500){
		...
		wsize=&jxk05_win_sizes[2];
		memcpy(&jxk05_attr.mipi, &jxk05_mipi_1920_1920, sizeof(jxk05_mipi_1920_1920));
		jxk05_attr.max_integration_time_native = 2000 - 4;
		jxk05_attr.integration_time_limit = 2000 - 4;
		jxk05_attr.total_width = 3600;
		jxk05_attr.total_height = 2000;
		jxk05_attr.max_integration_time = 2000 - 4;
		jxk05_attr.one_line_expr_in_us = 25;
		jxk05_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
	}
...
int get_sensor_width()
{
	...
	if (sensor_resolution == SENSOR_RES_500)
	{
		width = jxk05_win_sizes[0].width;
	}
	else
	{
		width = jxk05_win_sizes[2].width;
	}
    return width;
}
...
int get_sensor_height()
{
	...
	if (sensor_resolution == SENSOR_RES_500)
	{
		height = jxk05_win_sizes[0].height;
	}
	else
	{
		height = jxk05_win_sizes[2].height;
	}
    return height;
}
