...
//ar1c 22020530 #define sc301IoT_SUPPORT_25FPS_SCLK (54000000)
...
static int sc301IoT_set_expo(struct tx_isp_subdev *sd, int value)
{
	...
	//ISP_WARNING("[xmi sensor] set expo null.\r\n");
	//return 0;
     //integration time
...
static int sc301IoT_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	int ret = 0;
	ISP_WARNING("[xmi sensor] set fps:0x%x.\r\n",fps);
			       ...
			       struct tx_isp_chip_ident *chip)
{
	...
	ISP_WARNING("[xmi sensor] sc301IoT_SUPPORT_25FPS_SCLK:%d.\r\n",sc301IoT_SUPPORT_25FPS_SCLK);
...
static int sc301IoT_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_MAX_FPS_25:
		...
		sc301IoT_attr.max_integration_time_native = 1920 - 5;
		sc301IoT_attr.integration_time_limit = 1920 - 5;
		sc301IoT_attr.total_width = 2250;
		sc301IoT_attr.total_height = 1920;
		sc301IoT_attr.max_integration_time = 1920 - 5;
