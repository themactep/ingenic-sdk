...
extern unsigned char sensor_setting[];
extern int sensor_setting_length;
extern char *sensor_setting_build_date;
extern char *sensor_setting_md5;
#endif
...
#define PS5260_SUPPORT_PCLK_MIPI (152000000)
...
static struct regval_list ps5260_init_regs_1920_1080_15fps_mipi[] = {
	{0xEF, 0x05},
	{0x0F, 0x00},
	{0x44, 0x00},
	{0x43, 0x02},
...
static struct tx_isp_sensor_win_setting ps5260_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= ps5260_init_regs_1920_1080_15fps_mipi,
	}
};
			...
			const struct i2c_device_id *id)
{
	...
	if(data_interface == TX_SENSOR_DATA_INTERFACE_DVP){
		...
		ps5260_attr.max_integration_time_native = 2248;
	    ps5260_attr.integration_time_limit = 2248;
	    ps5260_attr.total_width = 4504;
	    ps5260_attr.total_height = 2250;
	    ps5260_attr.max_integration_time = 2248;
	} else {
...
{
	return ps5260_win_sizes->width;
}

int get_sensor_height()
{
	return ps5260_win_sizes->height;
}
#if 0
#ifdef CONFIG_BUILT_IN_SENSOR_SETTING
