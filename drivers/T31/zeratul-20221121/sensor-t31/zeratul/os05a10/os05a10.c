...
#define OS05A10_SUPPORT_SCLK_FPS_100 (107913600)
#define OS05A10_SUPPORT_SCLK_WDR (54000000)
#define OS05A10_SUPPORT_SCLK_RES_400_FPS_15 (93600000)
#define OS05A10_SUPPORT_SCLK_RES_480_FPS_15 (107642800)
...
static int sensor_max_fps = TX_SENSOR_MAX_FPS_25;//TX_SENSOR_MAX_FPS_15;//
...
static struct regval_list os05a10_init_regs_1280_960_100fps[] = {
#if 1
...
static struct regval_list os05a10_init_regs_2544_1888_15fps[] = {
#if 0
    {0x0100, 0x00},
    {0x0103, 0x01},
    {0x0303, 0x01},
...
static struct tx_isp_sensor_win_setting os05a10_win_sizes[] = {
	...
	/* [5] 4.8M @15fps*/
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os05a10_init_regs_2544_1888_15fps,
	},
	/* [6] 1M @15fps*/
	{
		.width		= 1280,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= os05a10_init_regs_1280_960_100fps,
	},
};
...
static int os05a10_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	if(data_type == TX_SENSOR_DATA_TYPE_LINEAR){
		...
		case TX_SENSOR_MAX_FPS_100:
			sclk = OS05A10_SUPPORT_SCLK_FPS_100;
...
//	ret = os05a10_write(sd, 0x12, 0x40);
	if(wdr_en == 1){
		...
		sensor->video.mbus.colorspace = wsize->colorspace;
		sensor->video.fps = wsize->fps;
		sensor_max_fps = TX_SENSOR_MAX_FPS_25;		memcpy((void*)(&(os05a10_attr.mipi)),(void*)(&os05a10_mipi),sizeof(os05a10_mipi));
		data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		os05a10_attr.data_type = data_type;
...
static int os05a10_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_WDR:
		if(arg)
			ret = os05a10_set_wdr(sd, *(int*)arg);
		break;
	case TX_ISP_EVENT_SENSOR_WDR_STOP:
		if(arg)
			ret = os05a10_set_wdr_stop(sd, *(int*)arg);
		break;
	default:
		break;;
	}
			 ...
			 const struct i2c_device_id *id)
{
	...
	if(data_type == TX_SENSOR_DATA_TYPE_LINEAR){
		...
		case TX_SENSOR_MAX_FPS_100:
            ...
            os05a10_attr.mipi.image_twidth=1280;
            os05a10_attr.mipi.image_theight=960;
			os05a10_attr.max_integration_time_native = 0x4e1 - 8;
			os05a10_attr.integration_time_limit = 0x4e1 - 8;
			os05a10_attr.total_width = 0x360;
			os05a10_attr.total_height = 0x4e1;
			os05a10_attr.max_integration_time = 0x4e1 - 8;
			os05a10_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
			break;
		default:
			ISP_ERROR("Now we do not support this framerate!!!\n");
	...
	printk("probe ok ------->os05a10 build:%s %s\n", __DATE__, __TIME__);
	return 0;
err_get_mclk:
	kfree(sensor);
...
{
	return os05a10_win_sizes->width;
}

int get_sensor_height()
{
	return os05a10_win_sizes->height;
}
