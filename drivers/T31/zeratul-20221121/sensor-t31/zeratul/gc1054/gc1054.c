...
unsigned int gc1054_alloc_again(unsigned int isp_gain, unsigned char shift, unsigned int *sensor_again)
{
	...
	*sensor_again = regs;
	...
	// struct again_lut *lut = gc1054_again_lut;

	// while(lut->gain <= gc1054_attr.max_again) {
	// 	if(isp_gain == 0) {
	...
	// 	}
	// 	else{
	// 		if((lut->gain == gc1054_attr.max_again) && (isp_gain >= lut->gain)) {
	// 			*sensor_again = lut->value;
	// 			return lut->gain;
	// 		}
	// 	}
...
static struct regval_list gc1054_init_regs_1280_720[] = {
	/////////////////////////////////////////////////////
	//////////////////////   SYS   //////////////////////
	/////////////////////////////////////////////////////
	{0xf2,0x00},
...
static struct tx_isp_sensor_win_setting gc1054_win_sizes[] = {
	/* 1280*720 */
	{
		...
		.regs 		= gc1054_init_regs_1280_720,
	}
};
...
{
	return gc1054_win_sizes->width;
}

int get_sensor_height()
{
	return gc1054_win_sizes->height;
}
...
int init_sensor(void)
{
	...
	if(ret){
		printk("Failed to init gc1054 dirver.\n");
		return -1;
	}
