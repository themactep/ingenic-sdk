...
struct fs_vb2_queue {
	...
	struct fs_vb2_buffer	*vb_pre_dequeued;
	unsigned char			pre_dequeued;
};
...
int tx_isp_wdr_enabele(struct tx_isp_module *module, unsigned long arg);
int tx_isp_wdr_disable(struct tx_isp_module *module, unsigned long arg);
