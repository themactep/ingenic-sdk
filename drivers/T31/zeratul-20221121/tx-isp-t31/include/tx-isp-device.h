...
int tx_isp_get_buf(struct tx_isp_module *module, unsigned long arg, int kmode);
int tx_isp_video_s_stream(struct tx_isp_module *module, unsigned long enable);
int tx_isp_set_buf(struct tx_isp_module *module, unsigned long arg, int kmode);
...
int tx_isp_video_link_stream(struct tx_isp_module *module, unsigned long enable);

/**
 * @fn int isp_core_tuning_switch_day_or_night(int day);
 *
 * 设置ISP的白天夜视模式
 *
 ...
 */
int isp_core_tuning_switch_day_or_night(int day);

/**
 * @fn int tx_isp_get_ev_start(int *value);
 *
 ...
 */
int tx_isp_get_ev_start(int *value);

/**
 * @fn int tx_isp_set_ev_start(int value);
 *
 * 设置ISP的起始EV信息
 *
 * @param[in] value 起始ev
 ...
 */
int tx_isp_set_ev_start(int value);
...
/**
 * @fn int tx_isp_riscv_is_stop(void);
 *
 * 检查 riscv 是否真正停止
 *
 * @param 无
 ...
 * @attention 该函数建议在tx_isp_riscv_hf_prepare函数中调用
 */
int tx_isp_riscv_is_run(void);

/**
 * @fn int tx_isp_get_riscv_stable(uint32_t delta, uint32_t *stable);
 *
 * 获取 RISCV 收敛状态
 *
 * @param 
 ...
 * @attention 该函数建议在tx_isp_riscv_hf_prepare函数中调用
 */
int tx_isp_get_riscv_stable(uint32_t delta,uint32_t *stable);



/**
 * @fn int tx_isp_get_riscv_framecount(uint32_t *value);
 *
 * 获取 RISCV 统计帧数
 *
 * @param 无
 ...
 * @attention 该函数建议在tx_isp_riscv_hf_prepare函数中调用
 */
int tx_isp_get_riscv_framecount(uint32_t *value);

/**
 * @fn int tx_isp_enable_debug(int en, int count);
 *
 * 是否开启debug模式
 *
 ...
 */
int tx_isp_enable_debug(int en, int count);
