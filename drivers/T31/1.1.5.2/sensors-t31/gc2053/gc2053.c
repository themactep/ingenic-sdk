...
#define GC2053_SUPPORT_30FPS_SCLK (78000000)
#define GC2053_SUPPORT_25FPS_SCLK (72000000)
#define GC2053_SUPPORT_15FPS_SCLK (48000000)
#define SENSOR_OUTPUT_MAX_FPS 30
#define SENSOR_OUTPUT_MIN_FPS 5
#define SENSOR_VERSION	"H20210519a"
...
struct again_lut gc2053_again_lut[] = {
	...
	{0x05, 0x00, 0x20, 0x00, 0x01, 0x1b, 30570},
...
struct tx_isp_sensor_attribute gc2053_attr={
	...
	.max_integration_time_native = 1418 - 4,
	.integration_time_limit = 1418 - 4,
	.total_width = 2200,
	.total_height = 1418,
	.max_integration_time = 1418 - 4,
...
static int gc2053_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case TX_SENSOR_MAX_FPS_25:
		wpclk = GC2053_SUPPORT_25FPS_SCLK;
...
//	private_clk_enable(sensor->mclk);
	...
	if((data_interface == TX_SENSOR_DATA_INTERFACE_DVP) && (sensor_max_fps == TX_SENSOR_MAX_FPS_25)){
		...
		memcpy((void*)(&(gc2053_attr.mipi)),(void*)(&gc2053_mipi),sizeof(gc2053_mipi));
		gc2053_attr.max_integration_time_native = 1304;
		gc2053_attr.integration_time_limit = 1304;
		gc2053_attr.total_width = 2200;
		gc2053_attr.total_height = 1308;
		gc2053_attr.max_integration_time = 1304;
		gc2053_attr.one_line_expr_in_us = 30;
	} else {
