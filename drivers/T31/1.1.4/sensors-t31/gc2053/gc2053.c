...
static int gc2053_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	if((data_interface == TX_SENSOR_DATA_INTERFACE_DVP) && (sensor_max_fps == TX_SENSOR_MAX_FPS_25)){
		...
		memcpy((void*)(&(gc2053_attr.dvp)),(void*)(&gc2053_dvp),sizeof(gc2053_dvp));
		gc2053_attr.max_integration_time_native = 0x8ca - 8;
		gc2053_attr.integration_time_limit = 0x8ca - 8;
		gc2053_attr.total_width = 0x44c * 2;
		gc2053_attr.total_height = 0x8ca;
		gc2053_attr.max_integration_time = 0x8ca - 8;
		gc2053_attr.one_line_expr_in_us = 29;
		vts0 = 0x08;
		vts1 = 0xca;
		vtsn0 = 0x08;
