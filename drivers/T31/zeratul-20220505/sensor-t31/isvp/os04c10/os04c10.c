...
#define OS04C10_SUPPORT_SCLK_FPS_30 (74600400)
#define OS04C10_SUPPORT_SCLK_FPS_60 (101046360)
	...
	if(data_type == TX_SENSOR_DATA_TYPE_LINEAR){
		if(sensor_resolution == TX_SENSOR_RES_400){
			...
			case TX_SENSOR_MAX_FPS_30:
				sclk = OS04C10_SUPPORT_SCLK_FPS_30;
			...
			switch (sensor_max_fps) {
			case TX_SENSOR_MAX_FPS_30:
				sclk = OS04C10_SUPPORT_SCLK_FPS_60;
				max_fps = TX_SENSOR_MAX_FPS_30;
				break;
