...
#define SC3336_SUPPORT_25FPS_SCLK (0x4e2 * 0x660 * 25)
...
struct tx_isp_sensor_attribute sc3336_attr={
	...
	.max_integration_time_native = 1632 - 1,
	.integration_time_limit = 1632 - 1,
	.total_width = 2496,
	.total_height = 1632,
	.max_integration_time = 1632 - 1,
...
static struct regval_list sc3336_init_regs_2304_1296_25fps_mipi[] = {
...
static struct tx_isp_sensor_win_setting sc3336_win_sizes[] = {
	/* [0] 2304*1296 @25fps */
	{
		...
		.regs 		= sc3336_init_regs_2304_1296_25fps_mipi,
	},
};
...
static int sc3336_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	sclk = SC3336_SUPPORT_25FPS_SCLK;
...
static int sc3336_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	printk("probe ok ------->sc3336 build:%s %s\n", __DATE__, __TIME__);
...
{
	return sc3336_win_sizes->width;
}

int get_sensor_height()
{
	return sc3336_win_sizes->height;
}
