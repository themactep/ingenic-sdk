...
#define SC4238_SUPPORT_SCLK_FPS_100 (120000000)
#define SC4238_SUPPORT_SCLK_FPS_30  (65966400)
...
struct tx_isp_sensor_attribute sc4238_attr={
	...
	.max_integration_time_native = 0x5f7 - 5,
	.integration_time_limit = 0x5f7 - 5,
	.total_width = 0x5a0,
	.total_height = 0x5f7,
	.max_integration_time = 0x5f7 - 5,
...
static struct regval_list sc4238_init_regs_2560_1440_30fps_mipi[] = {
     {0x0103,0x01},
     {0x0100,0x00},
     {0x36e9,0x80},
     {0x36f9,0x80},
...
static struct regval_list sc4238_init_regs_1280_720_100fps_mipi[] = {
    {0x0103,0x01},
    {0x0100,0x00},
    {0x36e9,0x80},
    {0x36f9,0x80},
...
static struct tx_isp_sensor_win_setting sc4238_win_sizes[] = {
			/*2560*1440*/
	{
		...
		.regs 		= sc4238_init_regs_2560_1440_30fps_mipi,
	},
			/*1280*720*/
	{
		.width		= 1280,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= sc4238_init_regs_1280_720_100fps_mipi,
	},
};
struct tx_isp_sensor_win_setting *wsize = &sc4238_win_sizes[0];

static enum v4l2_mbus_pixelcode sc4238_mbus_code[] = {
...
static int sc4238_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case TX_SENSOR_MAX_FPS_30:
		sclk = SC4238_SUPPORT_SCLK_FPS_30;
		max_fps = TX_SENSOR_MAX_FPS_30;
		break;
	case TX_SENSOR_MAX_FPS_100:
		sclk = SC4238_SUPPORT_SCLK_FPS_100;
...
static int sc4238_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_MAX_FPS_100:
        ...
        sc4238_attr.mipi.image_twidth = 1280;
        sc4238_attr.mipi.image_theight = 720;
		sc4238_attr.max_integration_time_native = 0x2ee - 5;
		sc4238_attr.integration_time_limit = 0x2ee - 5;
		sc4238_attr.total_width = 0x640;
		sc4238_attr.total_height = 0x2ee;
		sc4238_attr.max_integration_time = 0x2ee - 5;
		sc4238_attr.mipi.mipi_sc.sensor_csi_fmt = TX_SENSOR_RAW10;
		break;
	default:
		ISP_ERROR("Now we do not support this framerate!!!\n");
	}
...
{
	return sc4238_win_sizes->width;
}

int get_sensor_height()
{
	return sc4238_win_sizes->height;
}
