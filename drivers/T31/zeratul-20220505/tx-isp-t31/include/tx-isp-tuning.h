...
/**
 * @fn int tx_isp_tuning_set_hldc_on_or_off(int on)
 *
 * 设置畸变矫正开关.
 *
 * @param[in] on  0:关闭 1:打开.
 *
 * @retval 0 成功
 * @retval 非0 失败，返回错误码
 *
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_tuning_set_hldc_on_or_off(int on);

/**
 * ISP抗闪频属性参数结构体。
 */
enum tx_isp_antiflicker_attr{
...
/**
 *@int tx_isp_tuning_set_flicker(int fliker_attr)
 *
 * Set power frequency to prevent flicker
 *
 *@param[int] flicker attr
 *
 *@retval 0 success
 *
