...
static int isp_ch0_pre_dequeue_interrupt_process = 0;
...
static int isp_ch0_pre_dequeue_valid_lines = 900;
...
int get_isp_ch0_pre_dequeue_time(void)
{
	return isp_ch0_pre_dequeue_time;
}
...
int get_isp_ch0_pre_dequeue_interrupt_process(void)
{
	return isp_ch0_pre_dequeue_interrupt_process;
}

int get_isp_ch0_pre_dequeue_valid_lines(void)
{
	return isp_ch0_pre_dequeue_valid_lines;
}
