...
#define JXF35_SUPPORT_55FPS_SCLK (39600000)
...
/* VGA@120fps: insmod sensor_jxf35_c100.ko data_interface=1 sensor_resolution=30 sensor_max_fps=120  */
/* 1080p@25fps: insmod sensor_jxf35_c100.ko data_interface=1 sensor_max_fps=30 sensor_resolution=200 */
/* 1080p@60fps: insmod sensor_jxf35_c100.ko data_interface=1 sensor_max_fps=60 sensor_resolution=200 */
/* 1728x972@15fps: insmod sensor_jxf35_c100.ko data_interface=1 sensor_max_fps=15 sensor_resolution=180 */
/* 1728x972@55fps: insmod sensor_jxf35_c100.ko data_interface=1 sensor_max_fps=55 sensor_resolution=180 */
...
static struct regval_list jxf35_init_regs_1728_972_15fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x8A},
	{0x48, 0x0A},
	{0x0E, 0x11},
...
static struct regval_list jxf35_init_regs_1728_972_55fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x96},
	{0x48, 0x16},
	{0x0E, 0x11},
...
static struct regval_list jxf35_init_regs_1728_1080_15fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x8A},
	{0x48, 0x0A},
	{0x0E, 0x11},
...
static struct regval_list jxf35_init_regs_1728_1080_55fps_mipi[] = {
	{0x12, 0x40},
	{0x48, 0x96},
	{0x48, 0x16},
	{0x0E, 0x11},
...
static struct tx_isp_sensor_win_setting jxf35_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= jxf35_init_regs_1728_972_55fps_mipi,
	},
	{
		.width		= 1728,
		.height		= 972,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= jxf35_init_regs_1728_972_15fps_mipi,
	},
	{
		.width		= 1728,
		.height		= 1080,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= jxf35_init_regs_1728_1080_15fps_mipi,
	},
	{
		.width		= 1728,
		.height		= 1080,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= jxf35_init_regs_1728_1080_55fps_mipi,
	}
};
...
//	private_clk_enable(sensor->mclk);
	...
	if(data_type == TX_SENSOR_DATA_TYPE_LINEAR) {
		if((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_30) && (sensor_resolution == SENSOR_RES_200)){
		...
		} else if((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_60) && (sensor_resolution == SENSOR_RES_200)){
			...
			jxf35_mipi.clk = 792;
			memcpy((void*)(&(jxf35_attr.mipi)),(void*)(&jxf35_mipi),sizeof(jxf35_mipi));
		} else if((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_15 && sensor_resolution == SENSOR_RES_180)){
			wsize = &jxf35_win_sizes[5];
			jxf35_attr.total_width = 0xA00;//2560
			jxf35_attr.total_height = 0x465; //1350
			jxf35_attr.max_integration_time_native = 0x465 - 4;
			jxf35_attr.integration_time_limit = 0x465 - 4;
			jxf35_attr.max_integration_time = 0x465 - 4;
			jxf35_mipi.clk = 430;
			...
			memcpy((void*)(&(jxf35_attr.mipi)),(void*)(&jxf35_mipi),sizeof(jxf35_mipi));
		} else if((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_55 && sensor_resolution == SENSOR_RES_180)){
			...
			jxf35_mipi.image_theight = 972;
			memcpy((void*)(&(jxf35_attr.mipi)),(void*)(&jxf35_mipi),sizeof(jxf35_mipi));
		} else if((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_15 && sensor_resolution == SENSOR_RES_186)){
			wsize = &jxf35_win_sizes[6];
			jxf35_attr.total_width = 0x280 * 4;
			jxf35_attr.total_height = 0x465;
			jxf35_attr.max_integration_time_native = 0x465 - 4;
			jxf35_attr.integration_time_limit = 0x465 - 4;
			jxf35_attr.max_integration_time = 0x465 - 4;
			jxf35_mipi.clk = 430;
			jxf35_mipi.image_twidth = 1728;
			jxf35_mipi.image_theight = 1080;
			memcpy((void*)(&(jxf35_attr.mipi)),(void*)(&jxf35_mipi),sizeof(jxf35_mipi));
		} else if((data_interface == TX_SENSOR_DATA_INTERFACE_MIPI) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_55 && sensor_resolution == SENSOR_RES_186)){
			wsize = &jxf35_win_sizes[7];
			jxf35_attr.total_width = 0x280 * 4;
			jxf35_attr.total_height = 0x465;
			jxf35_attr.max_integration_time_native = 0x465 - 4;
			jxf35_attr.integration_time_limit = 0x465 - 4;
		...
		} else if((data_interface == TX_SENSOR_DATA_INTERFACE_DVP) && (sensor_max_fps == PS5270_SENSOR_MAX_FPS_30)){
...
/*
	...
	if(ret){
		ISP_ERROR("Failed to init jxf35 dirver.\n");
		return -1;
	}
*/
