...
int init_codec(void)
{
	...
	/*msleep(10);*/
	codec_reg_set(TS_CODEC_CCR_21, 0, 6, 1);
#else	/* CONFIG_SOC_T10 */
...
static int codec_set_buildin_mic(void)
{
	...
	msleep(10);
	codec_reg_set(TS_CODEC_CMICCR_23, 5, 5, 0x1);
	msleep(10);
	...
	msleep(10);
	codec_reg_set(TS_CODEC_CMICGAINR_24, 6, 7, 0x0);
	msleep(10);
...
void codec_set_record_volume(int * vol)
{
	...
	if (alc_mode) {
		...
		codec_reg_set(TS_CODEC_CAFG_49, 3, 5, 5);
		msleep(10);
