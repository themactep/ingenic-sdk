 ...
 */
/*
*operating position：/sys/module/sample_timer/drivers/platform:tcu_chn2/ingenic,tcu_chn3.3/
* echo 0 > enable
* echo 174  > period_ms
* echo 1 > enable
* */
...
#define TIMER_SRC TCU_CLKSRC_EXT   //Clock source size
#define TIMER_SRC_FREQ (CONFIG_EXTAL_CLOCK * 1000000) //Clock size
#define TIMER_DIV (1 << (2 * TCU_PRESCALE_64)) //Frequency division ratio
#define TIMER_FREQ (TIMER_SRC_FREQ / TIMER_DIV) //frequency
#define TIMER_MAX_PERIOD_MS (0xffff * 1000 / TIMER_FREQ) //Under 64 frequency division，period_ms max is 174ms
