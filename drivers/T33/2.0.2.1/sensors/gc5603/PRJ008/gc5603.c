 ...
 *  1           2880*1620       25        mipi_2lane    linear  10        25        1.2V     mipi降频
 *
 * @I2C addr:0x31, 0x10
 *
 * @FSync:none
...
#define SENSOR_VERSION  "H20251114a"
...
static struct regval_list gc5603_init_regs_2880_1620_25fps_mipi[] = {
	//01_GC5603_MIPI2L_24M_2880x1620_25fps_raw10_linear
	//mclk 24Mhz
...
static int gc5603_setting_select(struct tx_isp_subdev *sd, int deboot)
{
	...
	case 1:
		...
		gc5603_attr.integration_time.value = 0x127;
		gc5603_attr.integration_time.max = 1867 - 8;
		gc5603_attr.integration_time.min = 2;
		gc5603_attr.integration_time.apply_delay = 2;

		gc5603_attr.total_width =1200;
		gc5603_attr.total_height = 1867;
