...
struct audio_aic_device {
	...
	//struct codec_attributes *livingincodec;
	//struct codec_attributes *livingexcodec;
...
#define DEFAULT_RECORD_CLK (16000*256)
#define DEFAULT_REPLAY_CLK (16000*256)
...
#define I2S_ICDC_R	 	       (5)
#define I2S_ICDC_R_MASK          (0x1 << I2S_ICDC_R)
#define I2S_LSMP_OFFSET        (6)
#define I2S_LSMP_MASK          (0x1 << I2S_LSMP_OFFSET)
#define I2S_ICDC_T        (7)
#define I2S_ICDC_T_MASK          (0x1 << I2S_ICDC_T)
...
/*只使用内部codec*/
#define __i2s_only_internal_codec(i2s_dev)              \
do {	\
	i2s_set_reg(i2s_dev, AICFR,1,I2S_ICDC_R_MASK,I2S_ICDC_R);	\
	i2s_set_reg(i2s_dev, AICFR,1,I2S_ICDC_T_MASK,I2S_ICDC_T);	\
} while (0)
/*只使用外部codec*/
#define __i2s_only_external_codec(i2s_dev)               \
do {	\
	i2s_set_reg(i2s_dev, AICFR,0,I2S_ICDC_R_MASK,I2S_ICDC_R);	\
	i2s_set_reg(i2s_dev, AICFR,0,I2S_ICDC_T_MASK,I2S_ICDC_T);	\
} while(0)

/*外部codec录音，内部codec放音*/
#define __i2s_external_adc_codec(i2s_dev)               \
do {	\
	i2s_set_reg(i2s_dev, AICFR,0,I2S_ICDC_R_MASK,I2S_ICDC_R);	\
	i2s_set_reg(i2s_dev, AICFR,1,I2S_ICDC_T_MASK,I2S_ICDC_T);	\
} while(0)
...
/*外部codec放音，内部codec录音*/
#define __i2s_external_dac_codec(i2s_dev)               \
do {	\
	i2s_set_reg(i2s_dev, AICFR,1,I2S_ICDC_R_MASK,I2S_ICDC_R);	\
	i2s_set_reg(i2s_dev, AICFR,0,I2S_ICDC_T_MASK,I2S_ICDC_T);	\
} while(0)
 ...
 * */
#if 1
#define __i2s_internal_slave_mic_clkset(i2s_dev)	\
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,0,I2S_RMASTER_MASK,I2S_RMASTER_OFFSET); \
	}while(0)
#define __i2s_internal_slave_spk_clkset(i2s_dev)	\
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,0,I2S_TMASTER_MASK,I2S_TMASTER_OFFSET); \
	}while(0)

#define __i2s_external_slave_mic_clkset(i2s_dev)	\
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,0,I2S_RMASTER_MASK,I2S_RMASTER_OFFSET); \
	}while(0)
#define __i2s_external_slave_spk_clkset(i2s_dev)	\
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,0,I2S_TMASTER_MASK,I2S_TMASTER_OFFSET); \
	}while(0)
#define __i2s_external_master_mic_clkset(i2s_dev)	\
	do {                                            \
		i2s_set_reg(i2s_dev, AICFR,1,I2S_RMASTER_MASK,I2S_RMASTER_OFFSET); \
	}while(0)
#define __i2s_external_master_spk_clkset(i2s_dev)	\
	do {                                            \
...
#define I2S_ETFLOR_OFFSET      (31)
#define I2S_ETFLOR_MASK        (0x1 << I2S_ETFLOR_OFFSET)

#define __i2s_enable_TFLOR(i2s_dev)          \
	i2s_set_reg(i2s_dev, AICCR,1,I2S_ETFLOR_MASK,I2S_ETFLOR_OFFSET)
#define __i2s_disable_TFLOR(i2s_dev)         \
	i2s_set_reg(i2s_dev, AICCR,0,I2S_ETFLOR_MASK,I2S_ETFLOR_OFFSET)
...
/* AICSR*/
#define I2S_TFLOR_OFFSET       (2)
#define I2S_TFLOR_MASK         (0x1 << I2S_TFLOR_OFFSET)
...
#define I2S_TFLL_OFFSET         (15)
#define I2S_TFLL_MASK           (0x1f << I2S_TFL_OFFSET)
#define I2S_RFL_OFFSET         (24)
#define I2S_RFL_MASK           (0x3f << I2S_RFL_OFFSET)

#define __i2s_test_tflor(i2s_dev)   \
    i2s_get_reg(i2s_dev, AICSR,I2S_TFLOR_MASK,I2S_TFLOR_OFFSET)
#define __i2s_clear_tflor(i2s_dev)  \
    i2s_set_reg(i2s_dev, AICSR,0,I2S_TFLOR_MASK,I2S_TFLOR_OFFSET)
...
#define __i2s_test_tfll(i2s_dev)                \
    i2s_get_reg(i2s_dev, AICSR,I2S_TFLL_MASK,I2S_TFLL_OFFSET)
