 ...
 *  0           2880*1620       25        mipi_2lane    linear  10        25
 *  1           2880*1620       30        mipi_2lane    linear  10        30
 *  2           2880*1620       15        mipi_2lane    wdr     10        15
 * @I2C addr:0x3c, 0x3d
 *
 * @FSync:none
 *
...
struct tx_isp_mipi_bus os05l10_mipi_linear_25 = {
...
static struct regval_list os05l10_init_regs_2880_1620_25fps_mipi[] = {
//OS05L10_mclk24M_2880x1620_MIPI_2LANE_780Mbpslane_linear_raw10_25fps_v18_Toby.Li_20251231
	{0xfd, 0x00},
	{0x20, 0x00},
	{0xfd, 0x00},
	{0x20, 0x2b},
...
static struct tx_isp_sensor_win_setting os05l10_win_sizes[] = {
    {
        ...
        .regs           = os05l10_init_regs_2880_1620_25fps_mipi,
    },
    {
        .width          = 2880,
        .height         = 1620,
...
static int os05l10_setting_select(struct tx_isp_subdev *sd, int deboot)
{
    ...
    case 0:
        ...
        memcpy((void *)(&(os05l10_attr.mipi)), (void *)(&os05l10_mipi_linear_25), sizeof(os05l10_attr.mipi));
        break;
    case 1:
