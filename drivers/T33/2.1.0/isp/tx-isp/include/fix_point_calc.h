...
uint8_t tisp_simple_intp_uint8(uint32_t x_int, uint32_t x_fra, uint8_t *y_array);
uint16_t tisp_simple_intp_uint16(uint32_t x_int, uint32_t x_fra, uint16_t *y_array);
uint32_t tisp_simple_intp_uint32(uint32_t x_int, uint32_t x_fra, uint32_t *y_array); // mike add

int64_t tisp_round_int64(int64_t val, int32_t p);
int64_t tisp_clip(int64_t value, int64_t min, int64_t max);
