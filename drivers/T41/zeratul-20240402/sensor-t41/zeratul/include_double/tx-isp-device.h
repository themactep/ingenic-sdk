...
extern char ncu1_buf_len[255];
extern char wdr_buf_len[255];
extern char wdr1_buf_len[255];
 ...
 * @attention 在使用这个函数之前，必须保证ISP效果调试功能已使能.
 */
int tx_isp_set_awb_start(int vinum, awb_start_t awb_start);
...
/**
 * @fn int tx_isp_discard_frame(char frame0,char frame1);
 *
 * 内核丢帧接口
 *
 ...
 */
int tx_isp_discard_frame(char frame0,char frame1);
