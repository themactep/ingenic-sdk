...
extern struct miscdevice *g_f3_mdev;
...
extern unsigned long frame_channel3_width;
extern unsigned long frame_channel3_height;
extern unsigned long frame_channel3_nrvbs;
...
int frame_channel3_open(struct inode *inode, struct file *file);
