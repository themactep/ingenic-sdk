...
char * get_sensor_name_third(void);
/*
char * get_sensor_name_four(void);
char * get_sensor_name_five(void);
char * get_sensor_name_six(void);
char * get_sensor_name_seven(void);
char * get_sensor_name_eight(void);
*/
int get_sensor_i2c_addr(void);
int get_sensor_i2c_addr_one(void);
int get_sensor_i2c_addr_two(void);
int get_sensor_i2c_addr_third(void);
/*
int get_sensor_i2c_addr_four(void);
int get_sensor_i2c_addr_five(void);
int get_sensor_i2c_addr_six(void);
int get_sensor_i2c_addr_seven(void);
int get_sensor_i2c_addr_eight(void);
*/
