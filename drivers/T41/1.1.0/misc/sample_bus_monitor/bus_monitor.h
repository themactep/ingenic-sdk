...
#define MONITOR_AWVAL_CLK_NUM(n)                        (n * 0x0400 + 0x220)   //R
#define MONITOR_AWVAL_VLD_NUM(n)                        (n * 0x0400 + 0x224)   //R
#define MONITOR_AWVAL_RDY_NUM(n)                        (n * 0x0400 + 0x228)   //R
#define MONITOR_AWVAL_HIT_NUM(n)                        (n * 0x0400 + 0x22C)   //R
#define MONITOR_ARVAL_CLK_NUM(n)                        (n * 0x0400 + 0x230)   //R
#define MONITOR_ARVAL_VLD_NUM(n)                        (n * 0x0400 + 0x234)   //R
...
#define MONITOR_WLAST_ID(n)                             (n * 0x0400 + 0x320)   //RW
