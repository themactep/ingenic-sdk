...
#define SENSOR_VERSION	"H202208017a"
...
static int imx415_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	sensor->video.attr->max_integration_time_native = 2*vts -4;
	sensor->video.attr->integration_time_limit = 2*vts -4;
	sensor->video.attr->total_height = vts*2;
	sensor->video.attr->max_integration_time = 2*vts -4;
	ret = tx_isp_call_subdev_notify(sd, TX_ISP_EVENT_SYNC_SENSOR_ATTR, &sensor->video);
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		imx415_attr.max_integration_time_native = 4842 -4;
		imx415_attr.integration_time_limit = 4842 -4;
		imx415_attr.total_width = 1022;
		imx415_attr.total_height = 2421 *2;
		imx415_attr.max_integration_time = 4842 -4;
		imx415_attr.again = 0x14;
	...
	case 1:
		...
		imx415_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		imx415_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		imx415_attr.max_integration_time_native = 4452 -4;
		imx415_attr.integration_time_limit = 4452 -4;
		imx415_attr.total_width = 1668;
		imx415_attr.total_height = 2226 *2;
		imx415_attr.max_integration_time = 4452 -4;
