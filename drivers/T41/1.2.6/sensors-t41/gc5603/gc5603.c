 ...
 *   3          2160*1080        60     mipi_2lane             linear
 *   4          2160*1080        30     mipi_2lane             wdr
 */
#define DEBUG
...
#define SENSOR_OUTPUT_MAX_WDR_FPS 20
...
unsigned int gc5603_alloc_integration_time_short(unsigned int it, unsigned char shift, unsigned int *sensor_it)
{
	unsigned int expo = it >> shift;
	unsigned int isp_it = it;
	*sensor_it = expo;
...
struct tx_isp_mipi_bus gc5603_mipi_2880_1620_linear = {
...
struct tx_isp_mipi_bus gc5603_mipi_2880_1620_dol = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1152,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus gc5603_mipi_2960_1666_linear = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 846,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus gc5603_mipi_2160_1080_linear = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1152,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus gc5603_mipi_2160_1080_dol = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1152,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_sensor_attribute gc5603_attr={
	...
	.sensor_ctrl.alloc_integration_time_short = gc5603_alloc_integration_time_short,
};
...
static struct regval_list gc5603_init_regs_2880_1620_15fps_mipi_dol[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x03fe,0x00},
...
static struct regval_list gc5603_init_regs_2960_1666_25fps_mipi[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x03fe,0x00},
...
static struct regval_list gc5603_init_regs_2160_1080_60fps_mipi[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x03fe,0x00},
...
static struct regval_list gc5603_init_regs_2160_1080_30fps_mipi_dol[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x03fe,0x00},
...
static struct tx_isp_sensor_win_setting gc5603_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= TISP_VI_FMT_SGRBG10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc5603_init_regs_2880_1620_15fps_mipi_dol,
	},
	{
		.width		= 2960,
		.height		= 1666,
		...
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc5603_init_regs_2960_1666_25fps_mipi,
	},
	{
		.width		= 2160,
		.height		= 1080,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc5603_init_regs_2160_1080_60fps_mipi,
	},
	{
		.width		= 2160,
		.height		= 1080,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc5603_init_regs_2160_1080_30fps_mipi_dol,
	},
};
...
static int gc5603_set_integration_time_short(struct tx_isp_subdev *sd, int value)
{
	...
	if(value <= 1) value = 1;
	ret = gc5603_write(sd, 0x0201, value & 0xff);
	ret += gc5603_write(sd, 0x0200, (value>>8) & 0xff);
	if (ret < 0) {
		ISP_ERROR("gc5603_write error  %d\n" ,__LINE__ );
		return ret;
	}
...
static int gc5603_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	if(sensor->info.default_boot == 1 || sensor->info.default_boot == 4){
		...
		sensor->video.attr->max_again_short = 390142;
	}else{
		sensor->video.fps = fps;
...
static int gc5603_set_hvflip(struct tx_isp_subdev *sd, int enable)
{
	...
	switch(enable){
		...
		case 1:
			...
			gc5603_write(sd, 0x0063, val1 | 0x01);
			break;
		case 2:
			gc5603_write(sd, 0x022c, val | 0x02); /*filp*/
			gc5603_write(sd, 0x0063, val1 | 0x02);
			break;
		case 3:
			gc5603_write(sd, 0x022c, val | 0x03); /*mirror & filp*/
			gc5603_write(sd, 0x0063, val1 | 0x03);
			break;
	}
		otp_val=0x60|val;
		...
		ret = gc5603_write(sd,0x0a54,0x0e);
		ret = gc5603_write(sd,0x0a65,0x10);
		ret = gc5603_write(sd,0x0a98,0x04);
		ret = gc5603_write(sd,0x05be,0x00);
		ret = gc5603_write(sd,0x05a9,0x01);
		ret = gc5603_write(sd,0x0023,0x00);
		ret = gc5603_write(sd,0x0022,0x00);
		ret = gc5603_write(sd,0x0025,0x00);
		ret = gc5603_write(sd,0x0024,0x00);
		ret = gc5603_write(sd,0x0028,0x0b);
		ret = gc5603_write(sd,0x0029,0x98);
		ret = gc5603_write(sd,0x002a,0x06);
		ret = gc5603_write(sd,0x002b,0x86);
		ret = gc5603_write(sd,0x0a83,0xe0);
		ret = gc5603_write(sd,0x0a72,0x02);
		ret = gc5603_write(sd,0x0a73,otp_val);
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		memcpy(&gc5603_attr.mipi, &gc5603_mipi_2880_1620_linear, sizeof(gc5603_mipi_2880_1620_linear));
		gc5603_attr.one_line_expr_in_us = 19;
		gc5603_attr.total_width = 2400;
		gc5603_attr.total_height = 2100;
		gc5603_attr.max_integration_time_native = 2100 - 8;
		gc5603_attr.integration_time_limit = 2100 - 8;
		gc5603_attr.max_integration_time = 2100 - 8;
		gc5603_attr.again = 0;
		gc5603_attr.integration_time = 0x6c6;
		break;
	case 1:
		gc5603_attr.wdr_cache = wdr_bufsize;
		wsize = &gc5603_win_sizes[1];
		memcpy(&gc5603_attr.mipi, &gc5603_mipi_2880_1620_dol, sizeof(gc5603_mipi_2880_1620_dol));
		gc5603_attr.wdr_cache = wdr_bufsize;
		gc5603_attr.one_line_expr_in_us = 10;
		gc5603_attr.min_integration_time = 2;
		gc5603_attr.min_integration_time_short = 2;
		gc5603_attr.max_again_short = 390142;
		gc5603_attr.total_width = 1800;
		gc5603_attr.total_height = 2334;
		gc5603_attr.max_integration_time_native = 2334 - 16 - 102;
		gc5603_attr.integration_time_limit = 2334 - 16 - 102;
		gc5603_attr.max_integration_time = 2334 - 16 - 102;
		gc5603_attr.max_integration_time_short = 102;
		gc5603_attr.data_type = TX_SENSOR_DATA_TYPE_WDR_DOL;
		printk("================>hdr@15fps is ok !!!\n");
		break;
	case 2:
		wsize = &gc5603_win_sizes[2];
		gc5603_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		memcpy(&gc5603_attr.mipi, &gc5603_mipi_2960_1666_linear, sizeof(gc5603_mipi_2960_1666_linear));
		gc5603_attr.one_line_expr_in_us = 19;
		gc5603_attr.total_width = 2400;
		gc5603_attr.total_height = 2100;
		gc5603_attr.max_integration_time_native = 2100 - 8;
		...
		break;
	case 3:
		wsize = &gc5603_win_sizes[3];
		gc5603_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		memcpy(&gc5603_attr.mipi, &gc5603_mipi_2160_1080_linear, sizeof(gc5603_mipi_2160_1080_linear));
		gc5603_attr.one_line_expr_in_us = 14;
		gc5603_attr.total_width = 900;
		gc5603_attr.total_height = 1167;
		gc5603_attr.max_integration_time_native = 1167 - 8;
		gc5603_attr.integration_time_limit = 1167 - 8;
		gc5603_attr.max_integration_time = 1167 - 8;
		gc5603_attr.again = 0;
		gc5603_attr.integration_time = 0x10;
		break;
	case 4:
		wsize = &gc5603_win_sizes[4];
		memcpy(&gc5603_attr.mipi, &gc5603_mipi_2160_1080_dol, sizeof(gc5603_mipi_2160_1080_dol));
		gc5603_attr.wdr_cache = wdr_bufsize;
		gc5603_attr.one_line_expr_in_us = 28;
		gc5603_attr.min_integration_time = 2;
		gc5603_attr.min_integration_time_short = 2;
		gc5603_attr.max_again_short = 390142;
		gc5603_attr.total_width = 900;
		gc5603_attr.total_height = 1167;
		gc5603_attr.max_integration_time_native = 1167 -16 -20;
		gc5603_attr.integration_time_limit = 1167 -16 -20;
		gc5603_attr.max_integration_time = 1167 -16 -20;
		gc5603_attr.max_integration_time_short = 20;
		gc5603_attr.data_type = TX_SENSOR_DATA_TYPE_WDR_DOL;
		printk("================>hdr@30fps is ok !!!\n");
		break;
	default:
...
static int gc5603_g_chip_ident(struct tx_isp_subdev *sd,struct tx_isp_chip_ident *chip)
{
	struct i2c_client *client = tx_isp_get_subdevdata(sd);
...
static int gc5603_set_wdr(struct tx_isp_subdev *sd, int wdr_en)
{
	int ret = 0;
	...
	ret += gc5603_write_array(sd, wsize->regs);
	gc5603_write(sd, 0x0200, 0x00);
	gc5603_write(sd, 0x0201, 0x32);
	gc5603_write(sd, 0x0202, 0x03);
	gc5603_write(sd, 0x0203, 0xe8);
	gc5603_write(sd, 0x0202, 0x00);
	gc5603_write(sd, 0x0203, 0x10);
	ret += gc5603_write_array(sd, gc5603_stream_on);

	return 0;
}

static int gc5603_set_wdr_stop(struct tx_isp_subdev *sd, int wdr_en)
{
	int ret = 0;
	struct tx_isp_sensor *sensor = tx_isp_get_subdev_hostdata(sd);
	struct tx_isp_sensor_register_info *info = &sensor->info;

	ret = gc5603_write(sd, 0x03fe,0xf0);
...
static int gc5603_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_WDR:
		if(arg)
			ret = gc5603_set_wdr(sd, init->enable);
		break;
	case TX_ISP_EVENT_SENSOR_WDR_STOP:
		if(arg)
			ret = gc5603_set_wdr_stop(sd, init->enable);
		break;
