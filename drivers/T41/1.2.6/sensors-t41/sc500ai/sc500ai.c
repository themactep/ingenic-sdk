 ...
 *   3          2560*1440       25        mipi_2lane           hdr
 *   4          2560*1440       25        mipi_2lane           linear
 */
...
struct tx_isp_mipi_bus sc500ai_mipi_1080P_linear={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 792,
	.lans = 2,
	.index = 0,
...
struct tx_isp_mipi_bus sc500ai_mipi_1440P_dol = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1080,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus sc500ai_mipi_1440P_linear={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 792,
	.lans = 2,
	.index = 0,
...
static struct regval_list sc500ai_init_regs_1920_1080_60fps_mipi[] = {
	{0x0103,0x01},
	{0x0100,0x00},
	{0x36e9,0x80},
	{0x36f9,0x80},
...
static struct regval_list sc500ai_init_regs_2560_1440_25fps_mipi_dol[] = {
	{0x0103,0x01},
	{0x0100,0x00},
	{0x36e9,0x80},
	{0x36f9,0x80},
...
static struct regval_list sc500ai_init_regs_2560_1440_25fps_mipi[] = {
	{0x0103,0x01},
	{0x0100,0x00},
	{0x36e9,0x80},
	{0x36f9,0x80},
...
static struct tx_isp_sensor_win_setting sc500ai_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc500ai_init_regs_1920_1080_60fps_mipi,
	},
	{
		.width		= 2560,
		.height		= 1440,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs		= sc500ai_init_regs_2560_1440_25fps_mipi_dol,
	},
	{
		.width		= 2560,
		.height		= 1440,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc500ai_init_regs_2560_1440_25fps_mipi,
	},
};
...
static int sc500ai_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	if (sensor->info.default_boot == 1 || sensor->info.default_boot == 3 )
	{
	...
	if (sensor->info.default_boot == 1 || sensor->info.default_boot == 3 ){
		sensor->video.attr->max_integration_time_native = vts/2 - short_time/2 - 9;
		sensor->video.attr->integration_time_limit = vts/2 - short_time/2 - 9;
		sensor->video.attr->max_integration_time = vts/2 - short_time/2 - 9;
		sensor->video.attr->max_integration_time_short = short_time/2 - 7;
	}else{
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		sc500ai_attr.max_integration_time_native = 2030;   /* 2036-6 */
		sc500ai_attr.integration_time_limit = 2030;
		sc500ai_attr.max_integration_time = 2030;
	...
	case 1:
		...
		break;
	case 2:
		wsize = &sc500ai_win_sizes[2];
		memcpy(&sc500ai_attr.mipi, &sc500ai_mipi_1080P_linear, sizeof(sc500ai_mipi_1080P_linear));
		sc500ai_attr.mipi.clk = 792,
		sc500ai_attr.min_integration_time = 1;
		sc500ai_attr.min_integration_time_native = 1,
		sc500ai_attr.total_width = 1200;
		sc500ai_attr.total_height = 1125;
		sc500ai_attr.max_integration_time_native = 1119;   /* 1125-6 */
		sc500ai_attr.integration_time_limit = 1119;
		sc500ai_attr.max_integration_time = 1119;
		sc500ai_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc500ai_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		printk("=================> 1080P linear is ok");
		break;
	case 3:
		sc500ai_attr.wdr_cache = wdr_bufsize;
		wsize = &sc500ai_win_sizes[3];
		memcpy(&sc500ai_attr.mipi, &sc500ai_mipi_1440P_dol, sizeof(sc500ai_mipi_1440P_dol));
		sc500ai_attr.mipi.clk = 1080,
		sc500ai_attr.min_integration_time = 1;
		sc500ai_attr.min_integration_time_short = 1;
		sc500ai_attr.min_integration_time_native = 1,
		sc500ai_attr.total_width = 1600;
		sc500ai_attr.total_height = 3000;
		sc500ai_attr.max_integration_time_native = 1402; /* vts/2 -rhs/2- 5 */
		sc500ai_attr.integration_time_limit = 1402;
		sc500ai_attr.max_integration_time = 1402;
		sc500ai_attr.max_integration_time_short = 89; /* rhs/2- 4 */
		sc500ai_attr.data_type = TX_SENSOR_DATA_TYPE_WDR_DOL;
		printk("=================> 1440P 25fps_hdr is ok");
		break;
	case 4:
		wsize = &sc500ai_win_sizes[4];
		memcpy(&sc500ai_attr.mipi, &sc500ai_mipi_1440P_linear, sizeof(sc500ai_mipi_1440P_linear));
		sc500ai_attr.mipi.clk = 792,
		sc500ai_attr.min_integration_time = 1;
		sc500ai_attr.min_integration_time_native = 1,
		sc500ai_attr.total_width = 1600;
		sc500ai_attr.total_height = 1980;
		sc500ai_attr.max_integration_time_native = 1974;   /* 1980 - 6 */
		sc500ai_attr.integration_time_limit = 1974;
		sc500ai_attr.max_integration_time = 1974;
		sc500ai_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc500ai_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		printk("=================> 1440P linear is ok");
		break;
	default:
...
static int sc500ai_set_wdr_stop(struct tx_isp_subdev *sd, int wdr_en)
{
	...
	if(wdr_en == 1){
		...
		}else if(info->default_boot == 3)
		{
			...
			sc500ai_attr.total_width = 1600;
			sc500ai_attr.total_height = 3000;
			sc500ai_attr.max_integration_time_native = 1402;
			sc500ai_attr.integration_time_limit = 1402;
			sc500ai_attr.max_integration_time = 1402;
			sc500ai_attr.max_integration_time_short = 89;
			printk("\n-------------------------switch  1440p wdr@25fps ok ----------------------\n");
		}
	}else if (wdr_en == 0){
		// info->default_boot = 4;
