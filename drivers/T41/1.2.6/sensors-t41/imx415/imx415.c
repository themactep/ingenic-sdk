 ...
 *   2          3840*2160       20        mipi_2lane           linear
...
#define IMX415_SUPPORT_SCLK (148500000)
...
struct tx_isp_mipi_bus imx415_mipi_allpixl_linear = {
        .mode = SENSOR_MIPI_SONY_MODE,
        .clk = 1485,
        .lans = 2,
        .settle_time_apative_en = 0,
        ...
        .mipi_sc.mipi_vcomp_en = 0,
        .mipi_sc.mipi_hcomp_en = 0,
        .mipi_sc.mipi_crop_start0x = 24,
        .mipi_sc.mipi_crop_start0y = 57,
        .mipi_sc.mipi_crop_start1x = 0,
        .mipi_sc.mipi_crop_start1y = 0,
        .mipi_sc.mipi_crop_start2x = 0,
        .mipi_sc.mipi_crop_start2y = 0,
...
struct tx_isp_mipi_bus imx415_mipi_allpixl_30fps_linear = {
        .mode = SENSOR_MIPI_SONY_MODE,
        .clk = 1485,
        .lans = 2,
        .settle_time_apative_en = 0,
...
static struct regval_list imx415_init_regs_3840_2160_20fps_mipi[] = {
        {0x3008,0x7F},  // BCWAIT_TIME[9:0]
        {0x300A,0x5B},  // CPWAIT_TIME[9:0]
        {0x3024,0x5C},  // VMAX[19:0]
        {0x3025,0x0A},  // 0xe31 = 3633   20fps:0xA5C = 2652
        {0x3028,0x78},  // HMAX[15:0]
        {0x3029,0x05},  // 0x528 = 1022   0x578 = 1400
        {0x3031,0x00},  // ADBIT[1:0]
        {0x3032,0x00},  // MDBIT
        {0x3033,0x08},  // SYS_MODE[3:0]
...
static struct regval_list imx415_init_regs_3840_2160_allpixl_30fps_mipi[] = {
		{0x3008,0x7F},  // BCWAIT_TIME[9:0]
		{0x300A,0x5B},  // CPWAIT_TIME[9:0]
		{0x3024,0x76},  // VMAX[19:0] 0x976 = 2422
		{0x3025,0x09},  //
		{0x3028,0xFE},  // HMAX[15:0] 0x3FE = 1022
		{0x3029,0x03},  //
		{0x3031,0x00},  // ADBIT[1:0]
		{0x3032,0x00},  // MDBIT
		{0x3033,0x08},  // SYS_MODE[3:0]
...
static struct tx_isp_sensor_win_setting imx415_win_sizes[] = {
        ...
        },
		{
                ...
                .mbus_code      = TISP_VI_FMT_SRGGB10_1X10,
                .colorspace     = TISP_COLORSPACE_SRGB,
                .regs           = imx415_init_regs_3840_2160_allpixl_30fps_mipi,
        },
};
...
static int imx415_set_wdr_stop(struct tx_isp_subdev *sd, int wdr_en)
{
        struct tx_isp_sensor *sensor = tx_isp_get_subdev_hostdata(sd);
        int ret = 0;

        ret = imx415_write(sd, 0x3000, 0x1);
        if(wdr_en == 1){
                memcpy((void*)(&(imx415_attr.mipi)),(void*)(&imx415_mipi_dol),sizeof(imx415_mipi_dol));
                data_type = TX_SENSOR_DATA_TYPE_WDR_DOL;
                wsize = &imx415_win_sizes[1];
                imx415_attr.wdr_cache = wdr_bufsize;
                imx415_attr.max_again = 404346;
                imx415_attr.max_again_short = 404346;
                imx415_attr.max_dgain = 0;
                imx415_attr.min_integration_time = 4;
                imx415_attr.min_integration_time_native = 4;
                imx415_attr.max_integration_time_native = 2181;
                imx415_attr.min_integration_time_short = 4;
                imx415_attr.max_integration_time_short = 232;
                imx415_attr.integration_time_limit = 2181;
                imx415_attr.total_width = 1022;
                imx415_attr.total_height = 2422;
                imx415_attr.max_integration_time = 2181;
                imx415_attr.integration_time_apply_delay = 2;
                imx415_attr.again_apply_delay = 2;
                imx415_attr.dgain_apply_delay = 0;
                ...
                memcpy((void*)(&(imx415_attr.mipi)),(void*)(&imx415_mipi_linear),sizeof(imx415_mipi_linear));
                data_type = TX_SENSOR_DATA_TYPE_LINEAR;
...
static int imx415_set_wdr(struct tx_isp_subdev *sd, int wdr_en)
{
        int ret = 0;
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
		...
		case 2:
                ...
                imx415_attr.min_integration_time = 4;
                imx415_attr.min_integration_time_native = 4;
                imx415_attr.max_integration_time_native = 2652 - 8;
                imx415_attr.integration_time_limit = 2652 - 8;
                imx415_attr.total_width = 1400;
                imx415_attr.total_height = 2652;
                imx415_attr.max_integration_time = 2652 - 8;
                imx415_attr.integration_time_apply_delay = 2;
                imx415_attr.again_apply_delay = 2;
                imx415_attr.dgain_apply_delay = 0;
                memcpy((void*)(&(imx415_attr.mipi)),(void*)(&imx415_mipi_allpixl_linear),sizeof(imx415_mipi_allpixl_linear));
                break;
		case 3:
                wsize = &imx415_win_sizes[3];
                data_type = TX_SENSOR_DATA_TYPE_LINEAR;
                imx415_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
                imx415_attr.max_again = 404346;
                imx415_attr.max_again_short = 404346;
                ...
                imx415_attr.min_integration_time = 4;
                imx415_attr.min_integration_time_native = 4;
                imx415_attr.max_integration_time_native = 2422 - 8;
                imx415_attr.integration_time_limit = 2422 - 8;
                imx415_attr.total_width = 1022;
                imx415_attr.total_height = 2422;
                imx415_attr.max_integration_time = 2422 - 8;
                imx415_attr.integration_time_apply_delay = 2;
                imx415_attr.again_apply_delay = 2;
                imx415_attr.dgain_apply_delay = 0;
                memcpy((void*)(&(imx415_attr.mipi)),(void*)(&imx415_mipi_allpixl_30fps_linear),sizeof(imx415_mipi_allpixl_30fps_linear));
                break;
        default:
...
static int imx415_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
        ...
        case TX_ISP_EVENT_SENSOR_WDR:
                if(arg)
                        ret = imx415_set_wdr(sd, init->enable);
                break;
        case TX_ISP_EVENT_SENSOR_WDR_STOP:
                if(arg)
                        ret = imx415_set_wdr_stop(sd, init->enable);
                break;
