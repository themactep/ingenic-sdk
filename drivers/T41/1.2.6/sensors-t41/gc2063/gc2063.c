 ...
 *   3          1920*1088       30        mipi_2lane             linear    AISP
 */
#define DEBUG
...
#define SENSOR_VERSION	"H20240326a"
...
struct tx_isp_mipi_bus gc2063_1920_1088_mipi={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 672,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static struct regval_list gc2063_init_regs_1920_1088_30fps_mipi[] = {
        {0xfe,0x80},
        {0xfe,0x80},
        {0xfe,0x80},
        {0xfe,0x00},
...
static struct tx_isp_sensor_win_setting gc2063_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= TISP_VI_FMT_SRGGB10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc2063_init_regs_1920_1088_30fps_mipi,
	},
};
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 3:
		...
		memcpy(&(gc2063_attr.mipi), &gc2063_1920_1088_mipi, sizeof(gc2063_1920_1088_mipi));
		gc2063_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		gc2063_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI,
		gc2063_attr.max_integration_time_native = 1500 -8;
		gc2063_attr.integration_time_limit = 1500 -8;
		gc2063_attr.total_width = 2048;
		gc2063_attr.total_height = 1500;
		gc2063_attr.max_integration_time = 1500 - 8;
		gc2063_attr.again =0;
		gc2063_attr.integration_time = 0x8e01;
		gc2063_attr.one_line_expr_in_us = 28;
		break;
