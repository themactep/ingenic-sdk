...
*   4          2160*2160        30     mipi_2lane             linear
*   5          2160*2160        15     mipi_2lane             HDR
*/
#define DEBUG
...
#define SENSOR_VERSION "H20250303a"

static int reset_gpio = GPIO_PC(27);//
static int pwdn_gpio = -1;
static int shvflip = 1;

int wdr_bufsize = 666600 * 2;
...
struct again_lut_20 gc8613_again_lut_20fps[] = {
...
struct again_lut_30yn gc8613_again_lut_30fps[] = {
	// 	   0614   0615  225   1467	 1468   b8	  b9   1447
	{ 0x0, 0x00, 0x00, 0x00, 0x0d, 0x0d, 0x01, 0x00, 0x77,  0},           // 1.000000
	{ 0x1, 0x90, 0x02, 0x00, 0x0e, 0x0e, 0x01, 0x0a, 0x77,  13726},      //      1.156250
	{ 0x2, 0x01, 0x00, 0x00, 0x0e, 0x0e, 0x01, 0x1a, 0x77,  32233},       //     1.406250
	{ 0x3, 0x91, 0x02, 0x00, 0x0f, 0x0f, 0x01, 0x29, 0x77,  46808},      //      1.640625
	{ 0x4, 0x02, 0x00, 0x00, 0x0f, 0x0f, 0x01, 0x3e, 0x77,  64046},       //     1.968750
	{ 0x5, 0x00, 0x00, 0x00, 0x0d, 0x0d, 0x02, 0x0d, 0x75,  75349},       //     2.218750
	{ 0x6, 0x90, 0x02, 0x00, 0x0d, 0x0d, 0x02, 0x24, 0x75,  88967},      //      2.562500
	{ 0x7, 0x01, 0x00, 0x00, 0x0e, 0x0e, 0x03, 0x08, 0x75,  107731},      //      3.125000
	{ 0x8, 0x91, 0x02, 0x00, 0x0e, 0x0e, 0x03, 0x2e, 0x75,  124574},     //       3.734375
	{ 0x9, 0x02, 0x00, 0x00, 0x0f, 0x0f, 0x04, 0x1b, 0x75,  140885},      //      4.437500
	{ 0xa, 0x92, 0x02, 0x00, 0x0f, 0x0f, 0x05, 0x14, 0x75,  158178},     //       5.328125
	{ 0xb, 0x03, 0x00, 0x00, 0x10, 0x10, 0x06, 0x17, 0x75,  174907},    //        6.359375
	{ 0xc, 0x93, 0x02, 0x00, 0x10, 0x10, 0x07, 0x29, 0x75,  192261},   //         7.640625
	{ 0xd, 0x00, 0x00, 0x01, 0x11, 0x11, 0x08, 0x13, 0x75,  200230},    //        8.312500
	{ 0xe, 0x90, 0x02, 0x01, 0x12, 0x12, 0x09, 0x38, 0x75,  216516},   //         9.875000
	{ 0xf, 0x01, 0x00, 0x01, 0x13, 0x13, 0x0c, 0x00, 0x75,  234943},    //        12.000000
	{ 0x10,0x91, 0x02, 0x01, 0x14, 0x14, 0x0e, 0x35, 0x75,  254951},  //          14.828125
	{ 0x11,0x02, 0x00, 0x01, 0x15, 0x15, 0x10, 0x18, 0x75,  264333},   //         16.375000
	{ 0x12,0x92, 0x02, 0x01, 0x16, 0x16, 0x13, 0x29, 0x75,  281526},  //          19.640625
	{ 0x13,0x03, 0x00, 0x01, 0x17, 0x17, 0x17, 0x1c, 0x75,  298237},   //         23.437500
	{ 0x14,0x93, 0x02, 0x01, 0x18, 0x18, 0x1b, 0x22, 0x75,  313457},  //          27.531250
	{ 0x15,0x04, 0x00, 0x01, 0x19, 0x19, 0x21, 0x04, 0x75,  330767},   //         33.062500
	{ 0x16,0x94, 0x02, 0x01, 0x1b, 0x1b, 0x27, 0x18, 0x75,  347287},  //          39.375000
	{ 0x17,0x05, 0x00, 0x01, 0x1d, 0x1d, 0x2f, 0x29, 0x75,  365304},   //         47.640625
	{ 0x18,0x95, 0x02, 0x01, 0x1e, 0x1e, 0x39, 0x0b, 0x75,  382780},  //          57.312500
	{ 0x19,0x06, 0x00, 0x01, 0x20, 0x20, 0x44, 0x0f, 0x75,  399272},   //         68.234375
};
...
struct again_lut_hdr gc8613_again_lut_hdr[] = {
	// 	   0614   0615  225   1467	1468  1447  b8   b9
	{ 0x0, 0x00, 0x00, 0x00, 0x10, 0x10, 0x77, 0x01, 0x00,  0},           // 1.000000
	{ 0x1, 0x90, 0x02, 0x00, 0x11, 0x11, 0x77, 0x01, 0x0a,  13726},      //      1.156250
	{ 0x2, 0x01, 0x00, 0x00, 0x11, 0x11, 0x77, 0x01, 0x1a,  32233},       //     1.406250
	{ 0x3, 0x91, 0x02, 0x00, 0x12, 0x12, 0x77, 0x01, 0x29,  46808},      //      1.640625
	{ 0x4, 0x02, 0x00, 0x00, 0x12, 0x12, 0x77, 0x01, 0x3e,  64046},       //     1.968750
	{ 0x5, 0x00, 0x00, 0x00, 0x10, 0x10, 0x75, 0x02, 0x0d,  75349},       //     2.218750
	{ 0x6, 0x90, 0x02, 0x00, 0x11, 0x11, 0x75, 0x02, 0x24,  88967},      //      2.562500
	{ 0x7, 0x01, 0x00, 0x00, 0x11, 0x11, 0x75, 0x03, 0x08,  107731},      //      3.125000
	{ 0x8, 0x91, 0x02, 0x00, 0x12, 0x12, 0x75, 0x03, 0x2e,  124574},     //       3.734375
	{ 0x9, 0x02, 0x00, 0x00, 0x12, 0x12, 0x75, 0x04, 0x1b,  140885},      //      4.437500
	{ 0xa, 0x92, 0x02, 0x00, 0x13, 0x13, 0x75, 0x05, 0x14,  158178},     //       5.328125
	{ 0xb, 0x03, 0x00, 0x00, 0x14, 0x14, 0x75, 0x06, 0x17,  174907},    //        6.359375
	{ 0xc, 0x93, 0x02, 0x00, 0x15, 0x15, 0x75, 0x07, 0x29,  192261},   //         7.640625
	{ 0xd, 0x00, 0x00, 0x01, 0x17, 0x17, 0x75, 0x08, 0x13,  200230},    //        8.312500
	{ 0xe, 0x90, 0x02, 0x01, 0x18, 0x18, 0x75, 0x09, 0x38,  216516},   //         9.875000
	{ 0xf, 0x01, 0x00, 0x01, 0x19, 0x19, 0x75, 0x0c, 0x00,  234943},    //        12.000000
	{ 0x10,0x91, 0x02, 0x01, 0x1a, 0x1a, 0x75, 0x0e, 0x35,  254951},  //          14.828125
	{ 0x11,0x02, 0x00, 0x01, 0x1b, 0x1b, 0x75, 0x10, 0x18,  264333},   //         16.375000
	{ 0x12,0x92, 0x02, 0x01, 0x1c, 0x1c, 0x75, 0x13, 0x29,  281526},  //          19.640625
	{ 0x13,0x03, 0x00, 0x01, 0x1e, 0x1e, 0x75, 0x17, 0x1c,  298237},   //         23.437500
	{ 0x14,0x93, 0x02, 0x01, 0x20, 0x20, 0x75, 0x1b, 0x22,  313457},  //          27.531250
	{ 0x15,0x04, 0x00, 0x01, 0x22, 0x22, 0x75, 0x21, 0x04,  330767},   //         33.062500
	{ 0x16,0x94, 0x02, 0x01, 0x24, 0x24, 0x75, 0x27, 0x18,  347287},  //          39.375000
	{ 0x17,0x05, 0x00, 0x01, 0x26, 0x26, 0x75, 0x2f, 0x29,  365304},   //         47.640625
	{ 0x18,0x95, 0x02, 0x01, 0x28, 0x28, 0x75, 0x39, 0x0b,  382780},  //          57.312500
	{ 0x19,0x06, 0x00, 0x01, 0x28, 0x28, 0x75, 0x44, 0x0f,  399272},   //         68.234375
};
...
unsigned int gc8613_alloc_integration_time_short(unsigned int it, unsigned char shift, unsigned int *sensor_it)
{
	unsigned int expo = it >> shift;
	unsigned int isp_it = it;
...
unsigned int gc8613_alloc_again_20(unsigned int isp_gain, unsigned char shift, unsigned int *sensor_again)
{
	struct again_lut_20 *lut = gc8613_again_lut_20fps;
	while (lut->gain <= gc8613_attr.max_again)
	{
		if (isp_gain == 0)
		{
...
unsigned int gc8613_alloc_again_30fps(unsigned int isp_gain, unsigned char shift, unsigned int *sensor_again)
{
	struct again_lut_30yn *lut = gc8613_again_lut_30fps;
	while (lut->gain <= gc8613_attr.max_again)
	{
		if (isp_gain == 0)
		{
...
unsigned int gc8613_alloc_again_hdr(unsigned int isp_gain, unsigned char shift, unsigned int *sensor_again)
{
	struct again_lut_hdr *lut = gc8613_again_lut_hdr;
	while (lut->gain <= gc8613_attr.max_again)
	{
		if (isp_gain == 0)
		{
...
struct tx_isp_mipi_bus gc8613_mipi_linear_20fps = {
...
struct tx_isp_mipi_bus gc8613_mipi_linear_30fps = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1440,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus gc8613_mipi_linear_hdr = {
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 1440,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_sensor_attribute gc8613_attr = {
	...
	.sensor_ctrl.alloc_integration_time = gc8613_alloc_integration_time,
	.sensor_ctrl.alloc_integration_time_short = gc8613_alloc_integration_time_short,
};
...
static struct regval_list gc8613_init_regs_3840_2160_20fps_mipi[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x0a38,0x01},
...
static struct regval_list gc8613_init_regs_2160_2160_30fps_mipi[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x0a38,0x01},
...
static struct regval_list gc8613_init_regs_2160_2160_15fps_hdr_mipi[] = {
	{0x03fe,0xf0},
	{0x03fe,0x00},
	{0x03fe,0x10},
	{0x0a38,0x01},
...
static struct tx_isp_sensor_win_setting gc8613_win_sizes[] = {
	...
	/* [3] 3840*2160 @ max 15fps*/
	{
		...
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc8613_init_regs_3840_2160_20fps_mipi,
	},
	/* [4] 2160*2160 @ max 30fps*/
	{
		.width		= 2160,
		.height		= 2160,
		.fps		= 30 << 16 | 1,
		.mbus_code	= TISP_VI_FMT_SRGGB10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc8613_init_regs_2160_2160_30fps_mipi,
	},
	/* [5] 2160*2160 @ max 15fps*/
	{
		.width		= 2160,
		.height		= 2160,
		.fps		= 15 << 16 | 1,
		.mbus_code	= TISP_VI_FMT_SRGGB10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= gc8613_init_regs_2160_2160_15fps_hdr_mipi,
	},
};
...
static int gc8613_set_expo(struct tx_isp_subdev *sd, int value)
{
	...
	//struct again_lut_15fps *val_lut_15 = gc8613_again_lut_15fps;
	struct again_lut_20 *val_lut_20 = gc8613_again_lut_20fps;
	struct again_lut_30yn *val_lut_30 = gc8613_again_lut_30fps;
	struct again_lut_hdr *val_lut_hdr = gc8613_again_lut_hdr;
	...
	case 3:
		...
		/*set sensor analog gain*/
		ret += gc8613_write(sd, 0x031d, 0x2d);
		ret += gc8613_write(sd, 0x0614, val_lut_20[again].reg614);
		ret += gc8613_write(sd, 0x0615, val_lut_20[again].reg615);
		ret += gc8613_write(sd, 0x031d, 0x28);
		ret += gc8613_write(sd, 0x0225, val_lut_20[again].reg225);
		ret += gc8613_write(sd, 0x1467, val_lut_20[again].reg1467);
		ret += gc8613_write(sd, 0x1468, val_lut_20[again].reg1468);
		ret += gc8613_write(sd, 0x026e, val_lut_20[again].reg026e);
		ret += gc8613_write(sd, 0x0270, val_lut_20[again].reg0270);
		ret += gc8613_write(sd, 0x1447, val_lut_20[again].reg1447);
		break;
	case 4:
		ret = gc8613_write(sd, 0x0203, expo & 0xff);
		ret += gc8613_write(sd, 0x0202, expo >> 8);
		/*set sensor analog gain*/
		ret += gc8613_write(sd, 0x031d, 0x2d);
		ret += gc8613_write(sd, 0x0614, val_lut_30[again].reg614);
		ret += gc8613_write(sd, 0x0615, val_lut_30[again].reg615);
		ret += gc8613_write(sd, 0x031d, 0x28);
		ret += gc8613_write(sd, 0x0225, val_lut_30[again].reg225);
		ret += gc8613_write(sd, 0x1467, val_lut_30[again].reg1467);
		ret += gc8613_write(sd, 0x1468, val_lut_30[again].reg1468);
		ret += gc8613_write(sd, 0x00b8, val_lut_30[again].regb8);
		ret += gc8613_write(sd, 0x00b9, val_lut_30[again].regb9);
		ret += gc8613_write(sd, 0x1447, val_lut_30[again].reg1447);
		break;
	case 5:
		ret = gc8613_write(sd, 0x0203, expo & 0xff);
		ret += gc8613_write(sd, 0x0202, expo >> 8);
		/*set sensor analog gain*/
		ret += gc8613_write(sd, 0x031d, 0x2d);
		ret += gc8613_write(sd, 0x0614, val_lut_hdr[again].reg614);
		ret += gc8613_write(sd, 0x0615, val_lut_hdr[again].reg615);
		ret += gc8613_write(sd, 0x031d, 0x28);
		ret += gc8613_write(sd, 0x0225, val_lut_hdr[again].reg225);
		ret += gc8613_write(sd, 0x1467, val_lut_hdr[again].reg1467);
		ret += gc8613_write(sd, 0x1468, val_lut_hdr[again].reg1468);
		ret += gc8613_write(sd, 0x1447, val_lut_hdr[again].reg1447);
		ret += gc8613_write(sd, 0x00b8, val_lut_hdr[again].regb8);
		ret += gc8613_write(sd, 0x00b9, val_lut_hdr[again].regb9);
		break;
	}
	//
	if (ret < 0)
...
static int gc8613_set_integration_time_short(struct tx_isp_subdev *sd, int value)
{
	...
	if(value <= 1) value = 1;
	ret = gc8613_write(sd, 0x0201, value & 0xff);
	ret += gc8613_write(sd, 0x0200, value >> 8);
	if (ret < 0)
		ISP_ERROR("gc8613_write error  %d\n" ,__LINE__ );
...
static int gc8613_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	if (sensor->info.default_boot == 5 ){
		sensor->video.attr->max_integration_time_native = (vts - 8) / 17 * 16;
		sensor->video.attr->integration_time_limit = (vts - 8) / 17 * 16;
		sensor->video.attr->max_integration_time = (vts - 8) / 17 * 16;
		sensor->video.attr->max_integration_time_short = (vts - 8) / 17;
	}else{
		sensor->video.attr->max_integration_time_native = vts - 8;
		sensor->video.attr->integration_time_limit = vts - 8;
		sensor->video.attr->max_integration_time = vts - 8;
...
static int gc8613_set_hvflip(struct tx_isp_subdev *sd, int enable)
{
	...
	{
	case 0:
		gc8613_write(sd, 0x022c, 0x00); /*normal*/
		gc8613_write(sd, 0x0063, 0x00);
		otp_val=0x60;
		break;
	case 1:
	...
	case 3:
		...
		gc8613_write(sd, 0x0063, 0x07);
		otp_val=0x63;
		break;
	}
		ret+=gc8613_write(sd,0x0a67,0x80);//otp autoload normal
		...
		ret+=gc8613_write(sd,0x0a73,otp_val);
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		gc8613_attr.max_again = 393216,
		gc8613_attr.sensor_ctrl.alloc_again = gc8613_alloc_again;
		break;
	case 1:
	...
	case 2:
		...
		memcpy(&gc8613_attr.mipi, &gc8613_mipi, sizeof(gc8613_mipi));
		gc8613_attr.mipi.clk = 1100;
		gc8613_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		gc8613_attr.one_line_expr_in_us = 29;
		gc8613_attr.total_width = 4693;
		gc8613_attr.total_height = 0x640;
		gc8613_attr.max_integration_time_native = 0x640 - 8;
		gc8613_attr.integration_time_limit = 0x640 - 8;
		gc8613_attr.max_integration_time = 0x640 - 8;
		gc8613_attr.again = 0;
		gc8613_attr.integration_time = 0x10;
		gc8613_attr.max_again = 399272,
		gc8613_attr.sensor_ctrl.alloc_again = gc8613_alloc_again;
		break;
	case 3:
		wsize = &gc8613_win_sizes[3];
		gc8613_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		memcpy(&gc8613_attr.mipi, &gc8613_mipi_linear_20fps, sizeof(gc8613_mipi_linear_20fps));
		gc8613_attr.one_line_expr_in_us = 18;
		gc8613_attr.total_width = 0x499;
		gc8613_attr.total_height = 0x8ca;
		gc8613_attr.max_integration_time_native = 0x8ca - 8;
		gc8613_attr.integration_time_limit = 0x8ca - 8;
		gc8613_attr.max_integration_time = 0x8ca - 8;
		gc8613_attr.again = 0;
		gc8613_attr.integration_time = 0x10;
		gc8613_attr.sensor_ctrl.alloc_again = gc8613_alloc_again_20;
		break;
	case 4:
		wsize = &gc8613_win_sizes[4];
		gc8613_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		memcpy(&gc8613_attr.mipi, &gc8613_mipi_linear_30fps, sizeof(gc8613_mipi_linear_30fps));
		gc8613_attr.one_line_expr_in_us = 18;
		gc8613_attr.total_width = 0x320;
		gc8613_attr.total_height = 0x8ca;
		gc8613_attr.max_integration_time_native = 0x8ca - 8;
		gc8613_attr.integration_time_limit = 0x8ca - 8;
		gc8613_attr.max_integration_time = 0x8ca - 8;
		gc8613_attr.max_again = 399272;
		gc8613_attr.integration_time = 0x10;
		gc8613_attr.sensor_ctrl.alloc_again = gc8613_alloc_again_30fps;
		break;
	case 5:
		wsize = &gc8613_win_sizes[5];
		gc8613_attr.data_type = TX_SENSOR_DATA_TYPE_WDR_DOL;
		gc8613_attr.wdr_cache = wdr_bufsize;
		memcpy(&gc8613_attr.mipi, &gc8613_mipi_linear_hdr, sizeof(gc8613_mipi_linear_hdr));
		gc8613_attr.one_line_expr_in_us = 18;
		gc8613_attr.total_width = 0x320;
		gc8613_attr.total_height = 0x8ca;
		gc8613_attr.min_integration_time = 1;
		gc8613_attr.min_integration_time_short = 1;
		gc8613_attr.max_integration_time_native = (0x8ca - 8) / 17 * 16;
		gc8613_attr.integration_time_limit = (0x8ca - 8) / 17 * 16;
		gc8613_attr.max_integration_time = (0x8ca - 8) / 17 * 16;
		gc8613_attr.max_integration_time_short = (0x8ca - 8) / 17;
		gc8613_attr.max_again = 399272;
		gc8613_attr.max_again_short = 399272;
		gc8613_attr.integration_time = 0x10;
		gc8613_attr.sensor_ctrl.alloc_again = gc8613_alloc_again_hdr;
		break;
	default:
...
static int gc8613_set_wdr(struct tx_isp_subdev *sd, int wdr_en)
{
	int ret = 0;
...
static int gc8613_set_wdr_stop(struct tx_isp_subdev *sd, int wdr_en)
{
	int ret = 0;
...
static int gc8613_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_WDR:
		if(arg)
			ret = gc8613_set_wdr(sd, init->enable);
		break;
	case TX_ISP_EVENT_SENSOR_WDR_STOP:
		if(arg)
			ret = gc8613_set_wdr_stop(sd, init->enable);
		break;
	default:
		break;
	}
