...
static int es8374_record_set_again(int channel, int again)
{
	int volume = 0;
	if (again < 0) again = 0;
	if (again > 0x1f) again = 0x1f;
...
static int es8374_record_set_dgain(int channel, int dgain)
{
	return 0;
}
...
static int es8374_playback_set_again(int channel, int again)
{
	int volume = 0;
	if (again < 0) again = 0;
	if (again > 0x1f) again = 0x1f;
...
static int es8374_playback_set_dgain(int channel, int dgain)
{
	return 0;
}
...
static void es8374_i2c_remove(struct i2c_client *client)
#else
