...
static int codec_enable_record(void)
{
    ...
    msleep(20);
    codec_reg_set(CODEC_CAACR, 0, 2, 0x7);   //micbias
    msleep(20);
...
{
    int val = -1;
    /*Step1: Configure the register CAACR[4] to 1, to enable the current source of audio*/
    codec_reg_set(CODEC_CAACR, 5, 5, 0x1);
    msleep(20);
    codec_reg_set(CODEC_CAACR, 4, 4, 0x1);
    msleep(20);
    ...
    //codec_reg_set(CODEC_CHR, 6, 6, 0x0);
	//msleep(20);
