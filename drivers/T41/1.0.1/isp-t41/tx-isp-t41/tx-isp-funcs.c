...
static int isp_sclk = 550000000;
module_param(isp_sclk, int, S_IRUGO);
MODULE_PARM_DESC(isp_sclk, "isp scaler clock freq");
...
char *sclk_name[3] = {"apll", "mpll", "vpll"};
