...
static struct regval_list sc3336_init_regs_2304_1296_30fps_mipi_2lane[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x301f,0x01},
...
static struct tx_isp_sensor_win_setting sc3336_win_sizes[] = {
	{
		...
		.regs 		= sc3336_init_regs_2304_1296_30fps_mipi_2lane,
	}
};
...
{
       int ret = 0;
       ret = sc3336_write(sd, 0x3e00, (unsigned char)((value >> 12) & 0x0f));
...
static int sc3336_set_analog_gain(struct tx_isp_subdev *sd, int value)
{
       ...
       ret += sc3336_write(sd, 0x3e09, (unsigned char)((value & 0xff00) >> 8));
       if (ret < 0)
               return ret;
...
static int sc3336_set_vflip(struct tx_isp_subdev *sd, int enable)
{
	...
	val = sc3336_read(sd, 0x3221, &val);
	switch(enable) {
	case 0:
		sc3336_write(sd, 0x3221, val & 0x99);
		break;
	case 1:
		sc3336_write(sd, 0x3221, val | 0x06);
		break;
	case 2:
		sc3336_write(sd, 0x3221, val | 0x60);
		break;
	case 3:
		sc3336_write(sd, 0x3221, val | 0x66);
		break;
	}
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		memcpy(&(sc3336_attr.mipi), &sc3336_mipi, sizeof(sc3336_mipi));
		sc3336_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc3336_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		sc3336_attr.max_integration_time_native = 1350 -8;
		sc3336_attr.integration_time_limit = 1350 -8;
		sc3336_attr.total_width = 2500;
		sc3336_attr.total_height = 1350;
		sc3336_attr.max_integration_time = 1350 -8;
		sc3336_attr.again =0;
		sc3336_attr.integration_time = 0x700;
		break;
	default:
