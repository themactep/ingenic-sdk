...
#define SC4210_SUPPORT_BINNING_SCLK (144000000)
#define SC4210_SUPPORT_25FPS_SCLK (122400000)
...
static struct regval_list sc4210_init_regs_1280_720_25fps_binning_mipi[] = {
        {0x0103, 0x01},
        {0x0100, 0x00},
        {0x36e9, 0x80},
        {0x36f9, 0x80},
...
static struct tx_isp_sensor_win_setting sc4210_win_sizes[] = {
        ...
        },
        {
                ...
                .mbus_code      = TISP_VI_FMT_SBGGR10_1X10,
                .colorspace       = TISP_COLORSPACE_SRGB,
                .regs                = sc4210_init_regs_1280_720_25fps_binning_mipi,
        },
};
...
static int sc4210_set_fps(struct tx_isp_subdev *sd, int fps)
{
        ...
        case 1:
                ...
                break;
        case 2:
                sclk = SC4210_SUPPORT_BINNING_SCLK;
                max_fps = 30;
                break;
        default:
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
        ...
        case 1:
                ...
                break;
        case 2:
                wsize = &sc4210_win_sizes[2];
                memcpy((void*)(&(sc4210_attr.mipi)),(void*)(&mipi_binning),sizeof(mipi_binning));
                sc4210_attr.min_integration_time = 1;
                sc4210_attr.min_integration_time_native = 1;
                sc4210_attr.max_integration_time_native = 1500 - 1;
                sc4210_attr.integration_time_limit = 1500 - 1;
                sc4210_attr.total_width = 1600;
                sc4210_attr.total_height = 1500;
                sc4210_attr.max_integration_time = 1500 - 1;
                break;
        default:
