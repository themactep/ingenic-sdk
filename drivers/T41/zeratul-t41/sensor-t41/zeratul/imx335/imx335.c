...
static struct regval_list imx335_init_regs_2560_1440_30fps_mipi[] = {
	{0x300C, 0x5B},
	{0x300D, 0x40},
	{0x3018, 0x04},
	{0x302C, 0x48},
...
static struct tx_isp_sensor_win_setting imx335_win_sizes[] = {
	{
		...
		.regs = imx335_init_regs_2560_1440_30fps_mipi,
	},
};
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		imx335_attr.total_height = 4500;
		imx335_attr.max_integration_time = 4500 - 10;
		imx335_attr.integration_time_limit = 4500 - 10;
		imx335_attr.max_integration_time_native = 4500 - 10;
		imx335_attr.again = 0;
...
{
	return imx335_win_sizes->width;
}

int get_sensor_height(void)
{
	return imx335_win_sizes->height;
}
