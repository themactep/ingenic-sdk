 ...
 *   0          2304*1296       30        mipi_2lane     linear        master       1.2V
 *   1          2304*1296       45        mipi_2lane     linear        master       1.5V
 */
#define DEBUG
...
struct tx_isp_mipi_bus sc3336p_mipi_45fps_master={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 743,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static struct regval_list sc3336p_init_regs_2304_1296_30fps_mipi_master[] = {
	...
	{0x3032,0xa0},
	{0x30b8,0x33},
	{0x320e,0x06},//30fps@vts = 0x528 = 1320    25fps@vts = 0x630 = 1584
	{0x320f,0x30},//
	{0x3253,0x10},
	{0x325f,0x20},
	{0x3301,0x04},
...
static struct regval_list sc3336p_init_regs_2304_1296_45fps_mipi_master[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x300a,0x24},
...
static struct tx_isp_sensor_win_setting sc3336p_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc3336p_init_regs_2304_1296_45fps_mipi_master,
	},
};
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 1:
		...
		memcpy(&(sc3336p_attr.mipi), &sc3336p_mipi_45fps_master, sizeof(sc3336p_mipi_45fps_master));
		sc3336p_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc3336p_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
