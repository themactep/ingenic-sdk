...
#define SENSOR_VERSION	"H20231011a"
...
struct tx_isp_mipi_bus sc3336p_mipi_master={
...
struct tx_isp_mipi_bus sc3336p_mipi_slave={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 495,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus sc3336p_mipi_40fps_master={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 743,
	.lans = 2,
	.settle_time_apative_en = 0,
...
struct tx_isp_mipi_bus sc3336p_mipi_40fps_slave={
	.mode = SENSOR_MIPI_OTHER_MODE,
	.clk = 743,
	.lans = 2,
	.settle_time_apative_en = 0,
...
static struct regval_list sc3336p_init_regs_2304_1296_30fps_mipi_master[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x300a,0x24},
	...
	{0x37f9,0x27},
	{0x0100,0x01},
	{SC3336P_REG_DELAY,0x01},
	{SC3336P_REG_END, 0x00},/* END MARKER */
};

static struct regval_list sc3336p_init_regs_2304_1296_30fps_mipi_slave[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x301f,0x0c},
...
static struct regval_list sc3336p_init_regs_2304_1296_40fps_mipi_master[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x300a,0x24},
...
static struct regval_list sc3336p_init_regs_2304_1296_40fps_mipi_slave[] = {
	{0x0103,0x01},
	{0x36e9,0x80},
	{0x37f9,0x80},
	{0x301f,0x10},
...
static struct tx_isp_sensor_win_setting sc3336p_win_sizes[] = {
	{
		...
		.regs 		= sc3336p_init_regs_2304_1296_30fps_mipi_master,
	},
	{
		.width		= 2304,
		.height		= 1296,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc3336p_init_regs_2304_1296_30fps_mipi_slave,
	},
	{
		.width		= 2304,
		.height		= 1296,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc3336p_init_regs_2304_1296_40fps_mipi_master,
	},
	{
		.width		= 2304,
		.height		= 1296,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc3336p_init_regs_2304_1296_40fps_mipi_slave,
	},
};
...
static int sc3336p_detect(struct tx_isp_subdev *sd, unsigned int *ident)
{
	...
	unsigned char v;
        ...
        ret = sc3336p_write(sd, 0x440d, 0x10);
        ret += sc3336p_write(sd, 0x4400, 0x11);
        private_msleep(4);
...
static int sc3336p_set_analog_gain(struct tx_isp_subdev *sd, int value)
{
       ...
       ret += sc3336p_write(sd, 0x3e09, (unsigned char)((value & 0xff00) >> 8));
       if (ret < 0)
               return ret;
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
	...
	case 0:
		...
		memcpy(&(sc3336p_attr.mipi), &sc3336p_mipi_master, sizeof(sc3336p_mipi_master));
		sc3336p_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc3336p_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		sc3336p_attr.max_integration_time_native = 1584 -8;
		sc3336p_attr.integration_time_limit = 1584 -8;
		sc3336p_attr.total_width = 2500;
		sc3336p_attr.total_height = 1584;
		sc3336p_attr.max_integration_time = 1584 -8;
		sc3336p_attr.again =0;
		sc3336p_attr.integration_time = 0x520;
		break;
	case 1:
		wsize = &sc3336p_win_sizes[1];
		memcpy(&(sc3336p_attr.mipi), &sc3336p_mipi_slave, sizeof(sc3336p_mipi_slave));
		sc3336p_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc3336p_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		sc3336p_attr.max_integration_time_native = 1584 -8;
		sc3336p_attr.integration_time_limit = 1584 -8;
		...
		break;
	case 2:
		wsize = &sc3336p_win_sizes[2];
		memcpy(&(sc3336p_attr.mipi), &sc3336p_mipi_40fps_master, sizeof(sc3336p_mipi_40fps_master));
		sc3336p_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc3336p_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		sc3336p_attr.max_integration_time_native = 1485 - 8;
		sc3336p_attr.integration_time_limit = 1485 - 8;
		sc3336p_attr.total_width = 2500;
		sc3336p_attr.total_height = 1485;
		sc3336p_attr.max_integration_time = 1485 - 8;
		sc3336p_attr.again =0;
		sc3336p_attr.integration_time = 0x520;
		break;
	case 3:
		wsize = &sc3336p_win_sizes[3];
		memcpy(&(sc3336p_attr.mipi), &sc3336p_mipi_40fps_slave, sizeof(sc3336p_mipi_40fps_slave));
		sc3336p_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
		sc3336p_attr.dbus_type = TX_SENSOR_DATA_INTERFACE_MIPI;
		sc3336p_attr.max_integration_time_native = 1485 - 8;
		sc3336p_attr.integration_time_limit = 1485 - 8;
	...
	default:
        ...
        sc3336p_attr.fsync_attr.mode = fsync_mode;
        if (fsync_mode == TX_ISP_SENSOR_FSYNC_MODE_MS_REALTIME_MISPLACE) {
                sc3336p_attr.total_height = (sc3336p_attr.total_height << 1);
                wsize->fps = ( (wsize->fps & 0xffff0000) | ((wsize->fps & 0xffff) << 1) );
        }
        sc3336p_attr.max_integration_time_native = sc3336p_attr.total_height - 8;
        sc3336p_attr.integration_time_limit = sc3336p_attr.total_height - 8;
        sc3336p_attr.max_integration_time = sc3336p_attr.total_height - 8;
...
static int sc3336p_fsync(struct tx_isp_subdev *sd, struct tx_isp_sensor_fsync *fsync)
{
        uint8_t ret;
	struct tx_isp_sensor *sensor = sd_to_sensor_device(sd);
        ...
        case 0:
                ...
                case 3:
                        if(sensor->info.default_boot == 0){
                            ret = sc3336p_write(sd, 0x320e, 0x0c);
                            ret = sc3336p_write(sd, 0x320f, 0x60);
                            ret = sc3336p_write(sd, 0x3230, 0x06);
                            ret = sc3336p_write(sd, 0x3231, 0x40);
                            printk("=========>> [%s %d] -> sboot0\n", __func__, __LINE__);
                        } else if(sensor->info.default_boot == 2){
                            ret = sc3336p_write(sd, 0x320e, 0x0b);
                            ret = sc3336p_write(sd, 0x320f, 0x9d);
                            ret = sc3336p_write(sd, 0x3230, 0x05);
                            ret = sc3336p_write(sd, 0x3231, 0xe0);
                            printk("=========>> [%s %d] -> sboot2\n", __func__, __LINE__);
                        }
                        break;
                }
...
static int sc3336p_sensor_ops_ioctl(struct tx_isp_subdev *sd, unsigned int cmd, void *arg)
{
	...
	case TX_ISP_EVENT_SENSOR_VFLIP:
		if(arg)
			ret = sc3336p_set_vflip(sd, sensor_val->value);
		break;
	default:
		break;
	}
