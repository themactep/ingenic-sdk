...
#define GC4023_REG_DELAY        0x0000
#define GC4023_SUPPORT_30FPS_SCLK (0x7e9 * 0x4b0 * 2 * 25)
#define GC4023_SUPPORT_20FPS_SCLK 108*1000*1000
...
struct tx_isp_mipi_bus gc4023_mipi_40fps_linear = {
        .mode = SENSOR_MIPI_OTHER_MODE,
        .clk = 1008,
        .lans = 2,
        .settle_time_apative_en = 0,
...
static struct regval_list gc4023_init_regs_2560_1440_20fps_mipi[] = {
	/*version 1.2*/
	/*mclk 27Mhz*/
	/*mipi 702Mbps/lane*/
	/*vts = 2250*/
...
static struct regval_list gc4023_init_regs_2560_1440_15fps_mipi[] = {
	/*version 1.2*/
	/*mclk 27Mhz*/
	/*mipi 702Mbps/lane*/
	/*vts = 3000*/
...
static struct regval_list gc4023_init_regs_1280_360_120fps_mipi[] = {
	//version 0.5
	//mclk 27Mhz
...
static struct regval_list gc4023_init_regs_1920_1080_40fps_mipi[] = {
        {0x03fe, 0xf0},
        {0x03fe, 0x00},
        {0x03fe, 0x10},
        {0x03fe, 0x00},
...
static struct tx_isp_sensor_win_setting gc4023_win_sizes[] = {
        ...
        },
        {
                ...
                .mbus_code      = TISP_VI_FMT_SRGGB10_1X10,
                .colorspace     = TISP_COLORSPACE_SRGB,
                .regs           = gc4023_init_regs_2560_1440_20fps_mipi,
        },
        {
                .width          = 2560,
                .height         = 1440,
                ...
                .mbus_code      = TISP_VI_FMT_SRGGB10_1X10,
                .colorspace     = TISP_COLORSPACE_SRGB,
                .regs           = gc4023_init_regs_2560_1440_15fps_mipi,
        },
        {
                .width          = 1280,
                .height         = 360,
                ...
                .mbus_code      = TISP_VI_FMT_SRGGB10_1X10,
                .colorspace     = TISP_COLORSPACE_SRGB,
                .regs           = gc4023_init_regs_1280_360_120fps_mipi,
        },
        {
                .width          = 2560,
                .height         = 1440,
                ...
                .mbus_code      = TISP_VI_FMT_SRGGB10_1X10,
                .colorspace     = TISP_COLORSPACE_SRGB,
                .regs           = gc4023_init_regs_1920_1080_40fps_mipi,
        },
};
...
static int gc4023_set_logic(struct tx_isp_subdev *sd, int value)
{
	...
	{
		ag_last=ht_gain;
                ret  = gc4023_write(sd, 0x02cd, val_lut[ag_last].reg2cd);
...
static int gc4023_set_fps(struct tx_isp_subdev *sd, int fps)
{
        ...
        case 1:
                ...
                break;
        case 2:
                wpclk = GC4023_SUPPORT_20FPS_SCLK;
...
static int sensor_attr_check(struct tx_isp_subdev *sd)
{
        ...
        case 2:
                ...
                gc4023_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
                memcpy(&gc4023_attr.mipi, &gc4023_mipi_20fps_linear, sizeof(gc4023_mipi_20fps_linear));
                gc4023_attr.one_line_expr_in_us = 33;
                gc4023_attr.total_width = 2400;
                gc4023_attr.total_height = 1500;
                gc4023_attr.max_integration_time_native = 1500 - 8;
                gc4023_attr.integration_time_limit = 1500 - 8;
                gc4023_attr.max_integration_time = 1500 - 8;
        ...
        case 3:
                ...
                gc4023_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
                memcpy(&gc4023_attr.mipi, &gc4023_mipi_15fps_linear, sizeof(gc4023_mipi_15fps_linear));
                gc4023_attr.one_line_expr_in_us = 44;
                gc4023_attr.total_width = 2400;
                gc4023_attr.total_height = 1500;
                gc4023_attr.max_integration_time_native = 1500 - 8;
                gc4023_attr.integration_time_limit = 1500 - 8;
        ...
        case 4:
                ...
                gc4023_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
                memcpy(&gc4023_attr.mipi, &gc4023_mipi_120fps_linear, sizeof(gc4023_mipi_120fps_linear));
                gc4023_attr.one_line_expr_in_us = 44;
                gc4023_attr.total_width = 2250;
                gc4023_attr.total_height = 400;
                gc4023_attr.max_integration_time_native = 1125 - 8;
                gc4023_attr.integration_time_limit = 1125 - 8;
        ...
        case 5:
                ...
                gc4023_attr.data_type = TX_SENSOR_DATA_TYPE_LINEAR;
                memcpy(&gc4023_attr.mipi, &gc4023_mipi_40fps_linear, sizeof(gc4023_mipi_40fps_linear));
                gc4023_attr.one_line_expr_in_us = 13;
                gc4023_attr.total_width = 3772;
                gc4023_attr.total_height = 1800;
                gc4023_attr.max_integration_time_native = 1800 - 8;
                gc4023_attr.integration_time_limit = 1800 - 8;
        ...
        gc4023_attr.fsync_attr.mode = fsync_mode;
        if (fsync_mode == TX_ISP_SENSOR_FSYNC_MODE_MS_REALTIME_MISPLACE) {
                gc4023_attr.total_height = gc4023_attr.total_height * 2;
                wsize->fps = ( (wsize->fps & 0xffff0000) | (wsize->fps & 0xffff) * 2 );
        }
        gc4023_attr.max_integration_time_native = gc4023_attr.total_height - 8;
        gc4023_attr.integration_time_limit = gc4023_attr.total_height - 8;
        gc4023_attr.max_integration_time = gc4023_attr.total_height - 8;
...
static int gc4023_fsync(struct tx_isp_subdev *sd, struct tx_isp_sensor_fsync *fsync)
{
        uint8_t val;
        uint16_t ret_val;
        ...
        case 0:
                ...
                case 2:
                        printk("=========>> [%s %d]\n", __func__, __LINE__);
                        gc4023_read(sd, 0x0341, &val);
                        gc4023_write(sd, 0x0341, val + 4);
                        gc4023_write(sd, 0x027f, 0x03);
                        gc4023_write(sd, 0x02f7, 0x01);
                        break;
                case 3:
                        printk("=========>> [%s %d]\n", __func__, __LINE__);
                        gc4023_read(sd, 0x0340, &val);
                        ret_val = val << 8;
                        gc4023_read(sd, 0x0341, &val);
                        ret_val |= val;
                        ret_val = (ret_val << 1) + 4;
                        gc4023_write(sd, 0x0340, ret_val >> 8);
                        gc4023_write(sd, 0x0341, ret_val & 0xff);
                        gc4023_write(sd, 0x027f, 0x03);
                        gc4023_write(sd, 0x02f7, 0x01);

                        /* step 13.9us */
                        gc4023_write(sd, 0x02f5, 0x06);
                        gc4023_write(sd, 0x02f6, 0xc6);
                        break;
                }
                break;
        }
