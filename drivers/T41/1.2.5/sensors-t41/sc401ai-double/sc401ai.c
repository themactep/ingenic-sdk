...
static struct regval_list sc401ai_init_regs_2560_1440_20fps_mipi_master[] = {
        {0x0103, 0x01},
        {0x0100, 0x00},
        {0x36e9, 0x80},
        {0x36f9, 0x80},
...
static struct regval_list sc401ai_init_regs_2560_1440_20fps_mipi_slave[] = {
        {0x0103, 0x01},
        {0x0100, 0x00},
        {0x36e9, 0x80},
        {0x36f9, 0x80},
...
static struct tx_isp_sensor_win_setting sc401ai_win_sizes[] = {
	...
	},
	{
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc401ai_init_regs_2560_1440_20fps_mipi_master,
	},
	{
		.width		= 2560,
		.height		= 1440,
		...
		.mbus_code	= TISP_VI_FMT_SBGGR10_1X10,
		.colorspace	= TISP_COLORSPACE_SRGB,
		.regs 		= sc401ai_init_regs_2560_1440_20fps_mipi_slave,
	}
};
