...
#define MOTOR_DRV_CW    0x1 //顺时针转
#define MOTOR_DRV_CCW   0x2 //逆时针转
#define MOTOR_DRV_BRAKE 0x3 //制动；停止；刹车

enum
{
    TMI8153_CDIV_1,   // 不分频
    TMI8153_CDIV_2,   // sysclk2 分频
    TMI8153_CDIV_4,   // sysclk4 分频
    TMI8153_CDIV_8,   // sysclk8 分频
    TMI8153_CDIV_16,  // sysclk16 分频
    TMI8153_CDIV_32,  // sysclk32 分频
    TMI8153_CDIV_64,  // sysclk64 分频
    TMI8153_CDIV_128, // sysclk128 分频
}clockchn_source;
...
enum
{
    TMI8153_STEPMD_64,  // 64 步 16 细分
    TMI8153_STEPMD_128,  // 128 步 32 细分
    TMI8153_STEPMD_256,  // 256 步 64 细分
};
