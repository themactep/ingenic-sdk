...
#define SC200AI_SUPPORT_PCLK_FPS_25 (74250*1000)
...
static int sc200ai_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	case TX_SENSOR_MAX_FPS_25:
		sclk = SC200AI_SUPPORT_PCLK_FPS_25;
...
static int sc200ai_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_MAX_FPS_25:
		...
		sc200ai_attr.max_integration_time_native = 0x546 - 4;
                sc200ai_attr.integration_time_limit = 0x546 - 4;
                sc200ai_attr.total_width = 2200;
                sc200ai_attr.total_height = 0x546;
                sc200ai_attr.max_integration_time = 0x546 - 4;
		break;
	case TX_SENSOR_MAX_FPS_60:
		wsize = &sc200ai_win_sizes[1];
		sc200ai_attr.max_integration_time_native = 1125 - 4;
		sc200ai_attr.integration_time_limit = 1125 - 4;
		sc200ai_attr.total_width = 2200;
		sc200ai_attr.total_height = 1125;
		sc200ai_attr.max_integration_time = 1125 - 4;
		break;
	default:
		ISP_ERROR("do not support max framerate %d in mipi mode\n",sensor_max_fps);
	}

	sc200ai_attr.max_again = 377102;
