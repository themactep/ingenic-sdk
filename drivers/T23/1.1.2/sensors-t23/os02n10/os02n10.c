...
static int os02n10_clk_set(struct tx_isp_subdev *sd, struct clk *sclka, int mclk)
{
...
static int os02n10_attr_check(struct tx_isp_subdev *sd)
{
	...
	if (IS_ERR(sensor->mclk)) {
        ...
        ret = os02n10_clk_set(sd, sclka, SENSOR_MCLK);
        if (ret) {
