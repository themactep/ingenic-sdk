...
#define SENSOR_VERSION	"H20200813a"
...
static struct regval_list ov5648_init_regs_1920_1080_30fps[] = {
	{0x0103, 0x01},
	{0x3001, 0x00},
	{0x3002, 0x00},
	{0x3011, 0x02},
...
static struct regval_list ov5648_init_regs_1280_720_60fps[] = {
#if 0
	/*1280*960@45fps NOT OK*/
	{0x0103, 0x01},
	{0x3001, 0x00},
	{0x3002, 0x00},
	{0x3011, 0x02},
	...
	{0x0100, 0x00},
#else
	/*MAX 1280*720@60fps, default 30fps*/
	{0x0103, 0x01},
	{0x3001, 0x00},
	{0x3002, 0x00},
	{0x3011, 0x02},
...
static struct tx_isp_sensor_win_setting ov5648_win_sizes[] = {
	...
	/* 1920*1080 @30fps*/
	{
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= ov5648_init_regs_1920_1080_30fps,
	},
	/* 1280*720 @60fps*/
	{
		.width		= 1280,
		...
		.mbus_code	= V4L2_MBUS_FMT_SBGGR10_1X10,
		.colorspace	= V4L2_COLORSPACE_SRGB,
		.regs 		= ov5648_init_regs_1280_720_60fps,
	}
};
struct tx_isp_sensor_win_setting *wsize = &ov5648_win_sizes[0];
...
static int ov5648_set_fps(struct tx_isp_subdev *sd, int fps)
{
	...
	if (0 != ret) {
		ISP_ERROR("err: ov5648_write err\n");
		return ret;
	}
			...
			const struct i2c_device_id *id)
{
	...
	case TX_SENSOR_RES_500:
		...
		break;
	case TX_SENSOR_RES_200:
		wsize = &ov5648_win_sizes[1];
		ov5648_attr.mipi.image_twidth = 1920;
		ov5648_attr.mipi.image_theight = 1080;
		ov5648_attr.max_integration_time_native = 0x460 - 4;
		ov5648_attr.integration_time_limit = 0x460 - 4;
		ov5648_attr.total_width = 0x9c4;
		ov5648_attr.total_height = 0x460;
		ov5648_attr.max_integration_time = 0x460 - 4;
		ov5648_attr.one_line_expr_in_us = 30;
		break;
	case TX_SENSOR_RES_100:
		wsize = &ov5648_win_sizes[2];
		ov5648_attr.mipi.image_twidth = 1280;
		ov5648_attr.mipi.image_theight = 720;
		ov5648_attr.max_integration_time_native = 0x5de - 4;
		ov5648_attr.integration_time_limit = 0x5de - 4;
		ov5648_attr.total_width = 0x748;
		ov5648_attr.total_height = 0x5de;
		ov5648_attr.max_integration_time = 0x5de - 4;
		ov5648_attr.one_line_expr_in_us = 22;
		break;
	default:
		ISP_ERROR("Now we do not support this framerate!!!\n");
	}
...
static __init int init_ov5648(void)
{
	...
	if(ret){
		ISP_ERROR("Failed to init ov5648 dirver.\n");
		return -1;
	}
